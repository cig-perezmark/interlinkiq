  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <?php
          $fetch_pay_table = $this->User_model->query("SELECT * FROM start_cutoff ORDER BY id DESC");
        ?>
        <select class="form-control" name="" id="pay_period">
          <?php foreach($fetch_pay_table as $row): ?>
            <option value="<?= $row['cutoff_date'] ?>"><?= $row['pay_period'] ?></option>
          <?php endforeach; ?>
        </select>
        <!-- Hidden input fields -->
...
function seePayslip() {
    var selectedDate = document.getElementById("pay_period").value;
    var userId = document.getElementById("userIdInput").value;
    var name = document.getElementById("nameInput").value;
    var url = "https://interlinkiq.com/payslip_details_view.php?paiddate=" + selectedDate + "&user_id=" + userId + "&name=" + name;
