<div class="mobile-menu-overlay"></div>
	...
	<div class="card-box mb-30">
					...
					<div class="pd-20 d-flex">
						<h4 class="text-blue h4">Accounts</h4>
					</div>
						...
						<table class="data-table table stripe hover nowrap">
							<thead>
								<tr>
									...
									<th class="table-plus datatable-nosort">Accounts</th>
									<th>Action</th>
								</tr>
							</thead>
							<tbody>
							        ...
							        <td>
										<div class="dropdown">
											...
											<div class="dropdown-menu dropdown-menu-right dropdown-menu-icon-list">
												<a class="dropdown-item" href="<?php echo site_url('Pages/accounting_invoice_month/');?>"><i class="dw dw-eye"></i> View</a>
											</div>
										</div>
									</td>
							    </tr>
