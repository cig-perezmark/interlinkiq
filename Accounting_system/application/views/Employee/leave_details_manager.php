                                ...
                                <td>
                                    <div class="dropdown">
                                        ...
                                        <div class="dropdown-menu dropdown-menu-right dropdown-menu-icon-list">
                                            <a id="update_leave" class="dropdown-item" end_date="<?=$row->end_date?>" start_date="<?= $row->start_date ?>" leave_type="<?= $row->leave_type ?>" leave_id="<?=$row->id?>" leave_count="<?=$row->leave_count ?>" data-toggle="modal" data-target="#bd-example-modal-lg10" href="#">Update</a>   
                                            <a class="dropdown-item" href="<?php echo site_url('Pages/Pay_details/');?>">Delete</a>
								...
								<div class="modal-dialog modal-lg modal-dialog-centered" >
									<div class="modal-content">
										...
										<div class="modal-footer">
											...
											<input type="submit" class="btn btn-primary" name="save_request_manager" value="Save Data"/>
										</div>
										</form> 
									</div>
								</div>
									...
									<div class="modal-content">
										...
										<div class="modal-body">
                                            ...
                                            <div class="row">
													...
													<div class="col-md-6">
														<label>Leave Count</label>
														<input type="number" class="form-control" id="leave_count" name="leave_count" placeholder="Enter Amount">
													</div>
												</div>
