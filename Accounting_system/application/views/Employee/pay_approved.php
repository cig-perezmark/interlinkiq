						...
						<table class="table stripe hover nowrap">
							<thead>
								<tr>
									...
									<th class="table-plus datatable-nosort">End Date</th>
									<th class="table-plus datatable-nosort">Pay Period Status</th>
									<th  class="table-plus datatable-nosort">Action</th>
								</tr>
							</thead>
							<tbody>
							    <?php
							        $get_date = $this->User_model->query("SELECT * FROM start_cutoff WHERE flag >= 2 ORDER BY id DESC");
							        if($get_date):
									...
									<td>
										<div class="dropdown">
											...
											<div class="dropdown-menu dropdown-menu-right dropdown-menu-icon-list">
												<a class="dropdown-item" href="<?php echo site_url('Pages/get_approve_pay_list/')?><?=$row['cutoff_date'] ?>"><i class="dw dw-eye"></i> View/set</a>
...
function done(id){
    ...
    if (confirm(text) == true) {  
     	var location = "<?php echo site_url("Pages/update_pay_period/3/"); ?>"+id;
