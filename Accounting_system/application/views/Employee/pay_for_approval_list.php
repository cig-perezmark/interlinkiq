									...
									<td>
										<div class="dropdown">
											...
											<div class="dropdown-menu dropdown-menu-right dropdown-menu-icon-list">
												<a class="dropdown-item" payid="<?= $row['payid'] ?>" full_name="<?=$employee_row['last_name']  ?><?= ", " ?><?= $employee_row['first_name'] ?>" data-toggle="modal" data-target="#show_modal"  id="view_pay_details"><i class="dw dw-edit2"></i> Edit</a>
