...
SELECT
    ...
    SUM(CASE 
        ...
        END) AS non_expired,
    SUM(CASE 
            WHEN main.compliance = 1 THEN 1
            ELSE 0
        END) AS compliant_count,
    SUM(CASE 
            WHEN main.compliance = 0 THEN 1
            ELSE 0
...
GROUP BY
    main.name, main.document_count, main.document_other_count, p.reviewed_by, p.audit_report_date, p.audit_report_end_date, p.audit_certificate_date, p.audit_certificate_end_date, p.audit_action_date, p.audit_action_end_date, p.reviewed_date, p.reviewed_due, a.audit_report_count, a.annual_review_count;";
