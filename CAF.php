...
<html lang="en" data-bs-theme="light">
  <head>
    ...
    <title>Cherrystone Aqua-Farms - Login</title>
    ...
    <style>
      ...
      .sign-in-container {
        background: url('uploads/login/bg/CAF.png');
        background-size: cover;
        background-repeat: no-repeat;
        background-position: center;
      }
  ...
  <body class="d-flex flex-column align-items-center row-direction-column py-4x bg-body-tertiaryx bg-dark login-container">
    ...
    <div class="container text-center">
      <div class="row justify-content-center">
        <div class="col-lg-6">
          <img class="sign-logo" src="uploads/login/icon/CAF.png" />
        </div>
      </div>
    </div>
