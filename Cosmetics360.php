...
<html lang="en" data-bs-theme="light">
  <head>
    ...
    <style>
      ...
      .sign-in-container {
        background: url('uploads/login/bg/Cosmetics.png');
        background-size: cover;
        background-repeat: no-repeat;
        background-position: center;
      }
      ...
      <div class="row justify-content-center">
        <div class="col-lg-4 p-5 sign-in-container">
          <form method="POST" class="form formSignIn w-100">
            ...
            <div class="mt-5 pt-5">
              ...
              <button class="btn btn-primary w-100 py-2" type="submit" style="background: #EB7E55; border-color: #EB7E55;">
                Login
        ...
        <div class="col-lg-4 p-5 sign-up-container">
          <form method="POST" class="form formSignUp">
            ...
            <button class="btn btn-primary w-100 py-2" type="submit" style="background: #FF966F; border-color: #FF966F;">SIGN UP</button>
          </form>
        </div>
      </div>
    </div>
