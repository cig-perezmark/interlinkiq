...
<script src="assets/pages/scripts/components-date-time-pickers.min.js" type="text/javascript"></script>
        ...
        <div class="row">
                                ...
                                <div class="actions">
                                    <div class="btn-group">
                                        ...
                                        <ul class="dropdown-menu pull-right">
                                            ...
                                            <li>
                                                <a data-toggle="modal" class="" href="<?php echo $FreeAccess == false ? '#modalMultiUpload':'#modalService'; ?>" >Upload Multiple Contacts</a>
                                            </li>
                                            <li>
                                    ...
                                    <div class="col-md-2 border d-none" id="filter-side">
                                        ...
                                        <div class="filter-flex">
                                            ...
                                            <form id="searchStateForm">
                                                <label>State</label>
                                                <div class="input-group" style="margin-bottom:1rem">
                                                    <input type="text" class="form-control" id="searchStateValue" placeholder="Search state">
                                                    <span class="input-group-btn">
                                                        <button type="submit" class="btn green" type="button"><i class="fa fa-search"></i></button>
                                                    </span>
                                                </div>
                                            ...
                                            <div class="input-group d-none" style="margin-bottom:1rem">
                    ...
                    <div class="tab-pane" id="report">
                        <div class="row widget-row">
                            ...
                            <div class="col-md-7">
                                <div class="widget-thumb widget-bg-color-white text-uppercase margin-bottom-20">
                                    <!--<h4 class="widget-thumb-heading"></h4>-->
                                    <h3 class="d-flex justify-content-center">Uploaded Chart</h3>
                                    <div class="widget-thumb-wrap">
                                ...
                                <div class="widget-thumb widget-bg-color-white text-uppercase margin-bottom-20">
                                    <div class="widget-thumb-wrap">
                                        <h3 class="d-flex justify-content-center">Campaign Chart</h3>
                                        <div id="chartdiv2" style="width: 100%; height: 500px;"></div>
                                    </div>
                                </div>
                                
                                <div class="widget-thumb widget-bg-color-white text-uppercase margin-bottom-20">
                                    <h3 class="d-flex justify-content-center">Daily Campaign Chart</h3>
                                    <div class="widget-thumb-wrap">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                       ...
                                                       <?php
                                                       // for display country
                                                        $querycountry = "SELECT id, name  FROM countries order by name ASC";
                                            ...
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input class="form-control" type="text" id="duns" name="duns">
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        <label class="control-label">FDA Facility Registration no.</label>
                                                       <input class="form-control" id="fda_reg_no" name="fda_reg_no">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
            ...
            <div class="modal fade" id="massUploadResult" tabindex="-1" role="basic" aria-hidden="true">
                <div class="modal-dialog modal-lg">
                    <div class="modal-content">
                        ...
                        <div class="modal-footer">
                            <button type="button" data-dismiss="modal" aria-hidden="true" class="btn btn-secondary">Close</button>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <!--                    <ul class="nav nav-tabs">-->
            <!--                        <li class="active">-->
            <!--                            <a href="#campaigns-section" data-toggle="tab"> Campaigns </a>-->
            <!--                        </li>-->
            <!--                        <li>-->
            <!--                            <a href="#notes-section" data-toggle="tab"> Notes </a>-->
            <!--                        </li>-->
            <!--                        <li>-->
            <!--                            <a href="#task-section" data-toggle="tab"> Task </a>-->
            <!--                        </li>-->
            <!--                    </ul>-->
            <!--                    <div class="tab-content">-->
            <!--                        <div class="tab-pane active" id="campaigns-section">-->
            ...
            <!--                                                <span class="mt-action-author">Full Name</span><br>-->
            <!--                                                <a class="mt-action-desc view-content" data-id="" id="" data-toggle="modal" href="#view-content">Activities</a>-->
            <!--                                            </div>-->
            <!--                                        </div>-->
            <!--                                        <div class="mt-action-datetime ">-->
            <!--                                            <span class="mt-action-date"><i class="bi bi-calendar">Date</i></span>-->
            ...
            <!--                            <div class="mt-action-img">-->
            <!--                                <img src="../uploads/avatar/643815 - 112BpQGu8GL._AC_SY350_QL15_.jpg" height="50" width="50"> </div>-->
            <!--                                <div class="mt-action-body">-->
            <!--                                    <div class="mt-action-row">-->
            <!--                                        <div class="mt-action-info ">-->
            <!--                                            <div class="mt-action-icon ">-->
            ...
            <!--                                            </div>-->
            <!--                                            <div class="mt-action-details ">-->
            <!--                                                <span class="mt-action-author"></span><br>-->
            <!--                                                <a class="mt-action-desc view-content" data-id="" id="" data-toggle="modal" href="#view-content"></a>-->
            <!--                                            </div>-->
            <!--                                        </div>-->
            <!--                                        <div class="mt-action-datetime ">-->
            <!--                                            <span class="mt-action-date"><i class="bi bi-calendar"></i></span>-->
            <!--                                            <span class="mt-action-dot bg-green"></span>-->
            <!--                                            <span class="mt=action-time"><i class="bi bi-clock"></i></span>-->
            <!--                                        </div>-->
            <!--                                    </div>-->
            <!--                                </div>-->
            <!--                            </div>-->
            ...
            <div class="modal fade" id="activity-history" tabindex="-1" role="dialog" aria-hidden="true">
                <div class="modal-dialog modal-lg">
                    <div class="modal-content">
                        <div class="modal-header">
                        ...
                        <div class="modal-body">
                            <div class="widget-thumb widget-bg-color-white margin-bottom-20 tabbable-line">
                                <ul class="nav nav-tabs" id="history-options">
                                    <li class="active">
                                        <a href="#campaigns-section" class="campaign-tab" data-id="" data-action="campaigns-section" data-toggle="tab">Campaigns</a>
                                    </li>
                                    <li>
                                        <a href="#notes-section" class="notes-tab" data-id="" data-action="notes-section" data-toggle="tab">Notes</a>
                                    </li>
                                    <li>
                                        <a href="#task-section" class="task-tab" data-id="" data-action="task-section" data-toggle="tab">Task</a>
                                    </li>
                                </ul>
                                <div class="tab-content">
                                    <!-- Campaigns Section -->
                                    <div class="tab-pane active" id="campaigns-section" style="margin-top: 25px;">
                                        <div class="mt-actions">
                                            <div id="site_activities_loadings">
                                                <span id="spinner-texts" style="display:18px" class="">Fetching data </span> <img src="../assets/global/img/loading.gif" alt="loading" /> 
                                            </div>
                                        </div>
                                    </div>
                                    <!-- Notes Section -->
                                    <div class="tab-pane" id="notes-section" style="margin-top: 25px;">
                                        <div class="mt-actions">
                                            <div id="site_activities_loadings">
                                                <span id="spinner-texts" style="display:18px" class="">Fetching data </span> <img src="../assets/global/img/loading.gif" alt="loading" /> 
                                            </div>
                                    ...
                                    <!-- Task Section -->
                                    <div class="tab-pane" id="task-section" data-id="" style="margin-top: 25px;">
                                        <div class="mt-actions">
                                            <div id="site_activities_loadings">
                                                <span id="spinner-texts" style="display:18px" class="">Fetching data </span> <img src="../assets/global/img/loading.gif" alt="loading" /> 
                                            </div>
        ...
        <script src="crm/crm_script.js"></script>
