...
<style type="text/css">
                            ...
                            <div class="filter-flex">
                                ...
                                <div class="bd-highlight">
                                    <label class="mt-checkbox"> Costumer 
                                        <input type="checkbox" class="filter_value" data-value="account_status" value="Costumer"/>
                                        <span></span>
                                    </label>
                                </div>
        ...
        <div class="modal fade" id="modalNew" tabindex="-1" role="basic" aria-hidden="true">
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    <form method="post" action="crm/controller_functions.php" enctype="multipart/form-data" class="modalForm modalSave">
    ...
    // });
        ...
        //         $.ajax({    
        //             type: "GET",
        //             url: "crm/fetch-colab.php?modalView="+id,
        //             dataType: "html",
        //             success: function(data){
