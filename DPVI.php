...
<html lang="en" data-bs-theme="light">
  <head>
    ...
    <title>Danford Pharmaceuticals Ventures Inc. - Login</title>
    ...
    <style>
      ...
      .sign-in-container {
        background: url('uploads/login/bg/dpvi.png');
        background-size: cover;
        background-repeat: no-repeat;
        background-position: center;
      }
  ...
  <body class="d-flex flex-column align-items-center row-direction-column py-4x bg-body-tertiaryx bg-dark login-container">
    ...
    <div class="container text-center">
      <div class="row justify-content-center">
        <div class="col-lg-6">
          <img class="sign-logo" src="uploads/login/icon/dpvi.png" />
        </div>
      </div>
    </div>
      ...
      <div class="row justify-content-center">
        <div class="col-lg-4 p-5 sign-in-container d-flex align-items-center">
          <form method="POST" class="form formSignIn w-100">
            ...
            <button class="btn btn-primary w-100 py-2" type="submit" style="background: #f8d31c; border-color: #f8d31c; color: #000;">
              Login
        ...
        <div class="col-lg-4 p-5 sign-up-container">
          <form method="POST" class="form formSignUp">
            ...
            <button class="btn btn-primary w-100 py-2" type="submit" style="background: #f8d31c; border-color: #f8d31c; color: #000;">SIGN UP</button>
          </form>
        </div>
      </div>
    </div>
