...
<html lang="en" data-bs-theme="light">
  <head>
    ...
    <title>Food Industry Consulting - Login</title>
    ...
    <style>
      ...
      .sign-in-container {
        background: url('uploads/login/bg/FIC.png');
        background-size: cover;
        background-repeat: no-repeat;
        background-position: center;
      }
      ...
      <div class="row justify-content-center">
        <div class="col-lg-4 p-5 sign-in-container">
          <form method="POST" class="form formSignIn w-100">
            ...
            <div class="mt-5 pt-5">
              ...
              <button class="btn btn-primary w-100 py-2" type="submit" style="background: #FF636D; border-color: #FF636D;">
                Login
        ...
        <div class="col-lg-4 p-5 sign-up-container">
          <form method="POST" class="form formSignUp">
            ...
            <button class="btn btn-primary w-100 py-2" type="submit" style="background: #F08188; border-color: #F08188;">SIGN UP</button>
          </form>
        </div>
      </div>
    </div>
