...
<html lang="en" data-bs-theme="light">
  <head>
    ...
    <title>Fare Science - Login</title>
    ...
    <style>
      ...
      .sign-in-container {
        background: url('uploads/login/bg/Fare Science.jpg');
        background-size: cover;
        background-repeat: no-repeat;
        background-position: center;
      }
  ...
  <body class="d-flex flex-column align-items-center row-direction-column py-4x bg-body-tertiaryx bg-dark login-container">
    ...
    <div class="container text-center">
      <div class="row justify-content-center">
        <div class="col-lg-6">
          <img class="w-100 sign-logo" src="uploads/login/icon/Fare Science.png" />
        </div>
      </div>
    </div>
      ...
      <div class="row justify-content-center">
        <div class="col-lg-4 p-5 sign-in-container d-flex align-items-center">
          <form method="POST" class="form formSignIn w-100">
            ...
            <button class="btn btn-primary w-100 py-2" type="submit" style="background: #486BBC; border-color: #486BBC;">
              Login
        ...
        <div class="col-lg-4 p-5 sign-up-container">
          <form method="POST" class="form formSignUp">
            ...
            <button class="btn btn-primary w-100 py-2" type="submit" style="background: #577DBB; border-color: #577DBB;">SIGN UP</button>
          </form>
        </div>
      </div>
    </div>
