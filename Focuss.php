...
<html lang="en" data-bs-theme="light">
  <head>
    ...
    <style>
      ...
      .sign-in-container {
        background: url('uploads/login/bg/Focuss.jpg');
        background-size: cover;
        background-repeat: no-repeat;
        background-position: center;
      }
      ...
      <div class="row justify-content-center">
        ...
        <div class="col-lg-4 p-5 sign-up-container">
          <form method="POST" class="form formSignUp">
            ...
            <button class="btn btn-primary w-100 py-2" type="submit" style="background: #4FB94E; border-color: #4FB94E;">SIGN UP</button>
          </form>
        </div>
      </div>
    </div>
