...
<html lang="en">
    ...
    <head>
        <base href="">
        <meta charset="utf-8" />
        <title>Food Safety 360 Login Page</title>
    ...
    <body class=" login">
        <!-- BEGIN LOGO -->
        <div class="logo">
            <a href="/"><img src="companyDetailsFolder/252423%20-%20FoodSafety%20360%20V1%20with%20register%20logo.png" alt="" style="height: 70px; filter: brightness(0) invert(1);" /></a>
        </div>
        <!-- END LOGO -->
        <!-- BEGIN LOGIN -->
        <div class="content" style="margin-top: 0;">
            ...
            <form method="post" class="formSignIn">
                ...
                <input class="form-control" type="hidden" name="client" value="2" />
                ...
                <div class="form-actions">
                    <button type="submit" class="btn btn-success ladda-button" id="btnSignIn_FS360" data-style="zoom-out"><span class="ladda-label">Login</span></button>
                    <a href="javascript:;" id="btnForget" class="forget-password">Forgot Password?</a>
                </div>
                <div class="create-account">
                    <p>
                        <a href="javascript:;" id="btnJoin" class="uppercase">Create an account</a>
                    </p>
                </div>
            </form>
            ...
            <form method="post" class="register-form formSignUp display-hide">
                ...
                <div class="form-actions">
                    ...
                    <button type="submit" class="btn btn-success pull-right ladda-button" id="btnSignUp_FS360" data-style="zoom-out"><span class="ladda-label">Submit</span></button>
                </div>
            </form>
            ...
            <form method="post" class="forget-form formReset display-hide">
                ...
                <div class="form-actions">
                    ...
                    <button type="button" class="btn btn-success pull-right pull-right ladda-button" id="btnReset_FS360" data-style="zoom-out"><span class="ladda-label">SUBMIT</span></button>
                </div>
            </form>
            ...
            <form method="post" class="forget-form formResetPassword display-hide">
                ...
                <div class="form-actions">
                    <button type="button" id="back-btn" class="btn green btn-outline btnBack">Back</button>
                    <button type="button" class="btn btn-success pull-right pull-right ladda-button" id="btnResetPassword_FS360" data-style="zoom-out"><span class="ladda-label">SUBMIT</span></button>
                </div>
            </form>
        ...
        <script type="text/javascript">
            ...
            $('#btnSignIn_FS360').click(function(e){
                e.preventDefault();

                formObj = $(this).parents().parents();
                if (!formObj.validate().form()) return false;

                var data = $('.formSignIn').serialize()+'&btnSignIn_FS360=btnSignIn_FS360';
                ...
                $.ajax({
                    ...
                    success:function(response) {
                        if (response.exist == true) {
                            ...
                            else if (prev_link.indexOf('market-view') > -1) { window.location.href = prev_link; }
            ...
            $('#btnSignUp_FS360').click(function(e){
                e.preventDefault();

                formObj = $(this).parents().parents();
                if (!formObj.validate().form()) return false;

                var data = $('.formSignUp').serialize()+'&btnSignUp_FS360=btnSignUp_FS360';
            ...
            $('#btnReset_FS360').click(function(e){
                e.preventDefault();

                formObj = $(this).parents().parents();
                if (!formObj.validate().form()) return false;

                var data = $('.formReset').serialize()+'&btnReset_FS360=btnReset_FS360';
            ...
            $('#btnResetPassword_FS360').click(function(e){
                e.preventDefault();

                formObj = $(this).parents().parents();
                if (!formObj.validate().form()) return false;

                var data = $('.formResetPassword').serialize()+'&btnResetPassword_FS360=btnResetPassword_FS360';
