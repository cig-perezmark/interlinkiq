...
function ListOfSubTask_Open(id) {
    var action = "loadingSubTask_open";
    $.ajax({
        url: 'ForNewFunctions/modules/process.php',
        type: 'POST',
        data: {
        ...
        success: function(response) {
            $('#task_list_open').html(response);
        }
    });
}
function ListOfSubTask_Close(id) {
    var action = "loadingSubTask_close";
    $.ajax({
        url: 'ForNewFunctions/modules/process.php',
        type: 'POST',
        data: {
    ...
    $(document).on('click', '#cardData', function(e) {
        ...
        $.ajax({
            ...
            success: function(response) {
                ...
                ListOfComment(id);
                ListOfSubTask(id);
                ListOfSubTask_Open(id);
                ListOfSubTask_Close(id);
        ...
        $.ajax({
            ...
            success: function(response) {
                if (response.success) {
                    ...
                    ListOfSubTask_Open(history_id);
                    ListOfSubTask_Close(history_id);
    ...
    $(".modalGetHistoryb").on('submit', (function(e) {
        ...
        $.ajax({
            ...
            success: function(response) {
                ...
                ListOfSubTask_Open(parent_id);
                ListOfSubTask_Close(parent_id);
            ...
            if (result.isConfirmed) {
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        ...
                        ListOfSubTask(view);
                        ListOfSubTask_Open(view);
                        ListOfSubTask_Close(view);
                    },
                    error: function(xhr, status, error) {
                        console.log(error);
                    }
