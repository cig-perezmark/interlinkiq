                                                                           ...
                                                                           if (!empty($profilePicture)) {
                                                                            ...
                                                                            <a href="#">
                                                                               <span class="photo" >
                                                                                  ...
                                                                                  <span class="hidden task-title-sp">
                                                                            ...
                                                                            $response .= '
                                                                                <div>
                                                                                 <span tooltip="' . $row1['first_name'] . '&nbsp;' . $row1['last_name'] . '" class="photo">
                                                                                     ...
                                                                                     <span class="hidden task-title-sp" style="font-size:10px;color:#838FA1;">
                                                                                        ' . $row1['first_name'] . '&nbsp;' . $row1['last_name'] . '
                                                                                    </span>';
                                                                                           }
                                                                           $response.='</div>
...
function saveEditHistory($conn){
    ...
    mysqli_stmt_bind_param($stmt, 'ssisssii', $filename, $description, $Action_taken, $h_accounts, $Estimated_Time, $Action_date, $Assign_to_history, $History_id);
                                                                ...
                                                                <div class="desc">
                                                                    ...
                                                                    <span class="ui calendar" id="example10" data-id="'.$viewSubTaskid.'">
                                                                       <i class="fa fa-calendar"></i>&nbsp;
                                                                        ' . date("Y-m-d", strtotime($row1['CAI_Action_due_date'])) . '
                                                                      </span>
                                                                </div>
                                                            </div>
                                                            <div class="cont-col2">
                                      ...
                                      if($current_client != 1 ){
                                                  $response .='
                                                    <div class="col1">
                                                       ...
                                                       $response .='
                                                        <select disabled style="border: 1px solid #c2cad800;">
                                        ...
                                        <i>
                                                  ...
                                                  $response.='<div class="portlet  tasks-widget ">
                                                    ...
                                                    <div class="portlet-body" style="overflow:visible;">
                                                        <div class="task-content">
                                                            <ul class="feeds list-items" id="task_list_child">
                                            ...
                                            <hr>
                                                ...
                                                <div class="portlet-body">
                                                    <div class="task-content">
                                                    <ul class="task-list" id="SubtaskDocument">
                                                    </ul>
                                                    </div>
                                                 </div>
                                                </div>
                                               <div id="section-1">
                                                    ...
                                                    <div class="portlet-body" id="chats">
                                                        <div class="scroller" style="overflow-y: auto;height: 100px;" data-always-visible="1" data-rail-visible1="1">
                                                                <ul class="chats" id="listOfChatsSubtask">
                                                                </ul>
                                                        </div>
                                                 </div>
                                              </div>
                                                                           ...
                                                                           $profilePicture = !empty($current_userAvatar) ? $base_url.'uploads/avatar/'.$current_userAvatar : '';
                                                                            ...
                                                                            if (!empty($profilePicture)) {
                                                                                $body .= '
                                                                                    ...
                                                                                    $body .= '
                                                                                    <span style="font-size:11px;font-weight:400;line-height:16px;color:#1e1f21;font-family:-apple-system,BlinkMacSystemFont,&quot;Segoe UI&quot;,Roboto,&quot;Helvetica Neue&quot;,Helvetica,Arial,sans-serif">' . $initials . '</span>
    ...
    while ($row = $result->fetch_assoc()) {
        ...
        $response .= ' <div class="card-header">
                                           <p class="todo-task-modal-title todo-inline">
                                                   <button data-id="'.$view_id.'" id="changeStatusHistory" style="color:white;" class="btn btn-circle btn-outline '.$colorStatus.'">
                                                    <i class="fa fa-check-circle-o"></i>&nbsp;
                                                        ' . $history_stats . '</button>
                                                    <span class="label label-sm"></span>
                                                   <a class="pull-right" id="cloaserightpanel">
                                               <i style="font-size:20px;" class="icon-login"></i>
                                               </a>
                                           </p>
                                      </div>
                                      <hr>
                                                            ...
                                                            <div class="cont-col1">
                                                                <div class="desc">
                                                                    ...
                                                                    <span class="ui calendar" id="example9" data-id="'.$view_id.'">
                                                                       <i class="fa fa-calendar"></i>&nbsp;
                                                                        ' . date("Y-m-d", strtotime($row['Action_date'])) . '
                                                                      </span>
                                                                </div>
                                                            </div>
                                                            <div class="cont-col2">
                                       ...
                                       <p id="editableTextDescription'.$view_id.'" ondblclick="makeEditableDescription('.$view_id.')" class="editableDescription todo-task-modal-bg">
                                        <i>
                                          ...
                                          <div class="portlet-body">
                                            <div class="task-content">
                                               <div data-always-visible="1" data-rail-visible1="1">
                                                    <ul class="task-list" id="taskDocument"> 
                                                    </ul>
                                                  </div>
                                                </div>
                                           </div>
...
function SaveHistoryAndParent($conn)
{
  ...
  if ($_POST['Assign_to_history'] == 0) {
    ...
    if (!empty($files)) {
        ...
        $sql = "INSERT INTO tbl_MyProject_Services_History (user_id, MyPro_PK, files, filename, description, Estimated_Time, Action_taken, Action_date, Assign_to_history, Services_History_Status, rand_id, h_accounts, tmsh_column_status)
        ...
        $sql .= ", 1, '$rand_id', '$h_accounts', '$h_progress')";
