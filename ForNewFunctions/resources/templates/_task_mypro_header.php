...
<html lang="en">
    ...
    <head>
        ...
        <!-- BEGIN THEME LAYOUT STYLES -->
         <link href="ForNewFunctions/assets/layouts/layout2/css/layout.min.css" rel="stylesheet" type="text/css" />
        ...
        <script src="https://js.chargebee.com/v2/chargebee.js" data-cb-site="consultareinc" ></script>
        <link href="https://cdnjs.cloudflare.com/ajax/libs/select2/4.0.6-rc.0/css/select2.min.css" rel="stylesheet" />
        <link href="https://raw.githack.com/ttskch/select2-bootstrap4-theme/master/dist/select2-bootstrap4.css" rel="stylesheet">
        <!--chat bot-->
        
        <link rel="stylesheet" href="https://cdn.datatables.net/buttons/2.0.1/css/buttons.dataTables.min.css">
        <link rel="stylesheet" href="ForNewFunctions/resources/css/mypro_clone.css">
        ...
        <!-- Include WaitMe CSS for loading animations (you can adjust the paths if needed) -->
        <!--<link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/waitMe/1.18.1/waitMe.min.css">-->
        <!--end chat bot-->
        <style type="text/css">
            <?php
                if (isset($_COOKIE['switchAccount'])) {
                    ...
                    <div class="top-menu">
                        ...
                        <ul class="nav navbar-nav pull-right">
                            ...
                            <li class="dropdown dropdown-extended dropdown-notification" id="header_notification_bar">
                                <?php if($user_id == 35 || $user_id == 42 || $user_id == 163 || $user_id == 38 || $user_id == 88): ?>
                                        ...
                                        <ul class="dropdown-menu-list scroller" style="height: 250px;" data-handle-color="#637283">
                                            ...
                                            <li>
                                             ...
                                             <?php 
                                                ...
                                                {?>
                                                <li>
                                                    <a href="enterprise_record" style="text-decoration:none; padding: 0; margin-top: 10px;">
                            ...
                            <li class="dropdown dropdown-user">
                                ...
                                <ul class="dropdown-menu dropdown-menu-default">
                                   ...
                                   <?php } ?>
                                    ...
                                    <li class="divider"> </li>
                                    <?php if ($current_userID == 34 || $current_userID == 163) { ?>
                                        <li><a href="sidebar"><i class="icon-login"></i> Sidebar Setting</a></li>
                                    <?php } ?>
                                    <li>
                                    ...
                                    <?php endif; ?>
                                    <?php if ($user_id == 34) { ?>
                                        <li><a href="pto_request.php" ><i class="icon-calendar"></i> PTO For Approval</a></li>
                                    <?php } ?>
            ...
            <div class="page-sidebar-wrapper">
                ...
                <div class="page-sidebar navbar-collapse collapse">
                    ...
                    <ul class="page-sidebar-menu  page-header-fixed page-sidebar-menu-hover-submenux page-sidebar-menu-compact" data-keep-expanded="false" data-auto-scroll="true" data-slide-speed="200">
                        ...
                        <?php } ?>
                        <?php if($switch_user_id == 1 || $switch_user_id == 163): ?>
                            <li class="nav-item <?php echo $site === "internal" ? "active " : ""; ?>">
                        ...
                        <?php if($switch_user_id == 253 || $switch_user_id == 34 || $switch_user_id == 1){ ?>
                            <li class="nav-item ">
                                <a href="javascript:;" class="nav-link nav-toggle">
                                    <i class="icon-bulb"></i>
                                    <span class="title">Internal Audit</span>
                                ...
                                <ul class="sub-menu">
                                    <?php 
                                        if($current_userEmployeeID == 0){
                                            $check_form_owned = mysqli_query($conn,"SELECT * FROM tbl_forms_owned WHERE user_id = '" . $user_id . "' AND enterprise_id = '" . $user_id . "'"); 
                                        }
                                        else{
                                        ...
                                        if($num_rows > 0 ){
                                            ...
                                            foreach($array_counter as $value){
                                                $query = "SELECT * FROM tbl_afia_forms_list WHERE PK_id = '$value' AND sub_name != '' ";
                                                $result = mysqli_query($e_connection, $query);
                                                while($row = mysqli_fetch_array($result))
                                                {?> 
                                                <li class="nav-item">
                                                    <a onclick="myfunction(<?= $switch_user_id; ?>)" href="/e-forms/Welcome/index/<?= $switch_user_id ?>/<?= $user_id ?>/<?= $row['afl_form_code'] ?>/view_records" target="_blank" class="nav-link ">
                                                        <span class="title"><?= $row['sub_name'] ?></span>
                                                    </a>
                                                </li>
                                                <?php }
                                            }
                                ...
                                <form method="post" enctype="multipart/form-data" class="modalForm">
                                    <div class="modal-header">
                                        ...
                                        <h4 class="modal-title">Request PTO
                                            (Remaining Leave:
                                                <?php 
                                                    // $checker = mysqli_query($conn,"SELECT *, tbl_hr_employee.ID as employee_id FROM tbl_user INNER JOIN tbl_hr_employee ON tbl_hr_employee.ID = tbl_user.employee_id WHERE tbl_user.ID = '".$user_id."'");
                                                    // if($checker){
                                                    //     $check_result = mysqli_fetch_array($checker);
                                                    //     $sql = "SELECT * FROM others_employee_details WHERE employee_id = '".$check_result['employee_id']."'" ; 
                                                        ...
                                                        if (!empty($switch_employee_id)) {
                                                            ...
                                                            if (in_array($current_userEmployeeID, $switch_employee_id_arr)) {
                                                                ...
                                                                if ( mysqli_num_rows($selectEnterprise) > 0 ) {
                                                                    ...
                                                                    echo '<div class="mt-action">
                                                                        <div class="mt-action-img"><img src="companyDetailsFolder/'.$switch_logo.'" style="width: 39px; height: 39px; object-fit: cover; object-position: center;"></div>
                                                                        <div class="mt-action-body">
                                                                            <div class="mt-action-row">
                                                                                <div class="mt-action-info ">
                                                                                    <div class="mt-action-details ">
