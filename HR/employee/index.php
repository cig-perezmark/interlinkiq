                            ...
                            <div class="dashboard-stat2 ">
                                <div class="display">
                                    <div class="number">
                                        ...
                                        <small>Current Inactive Employee</small>
                                    </div>
                                    <div class="icon">
                                    <i class="icon-pie-chart"></i>
                                    </div>
                                    ...
                                    <div class="actions">
                                        <div class="btn-group">
                                            ...
                                            <ul class="dropdown-menu pull-right">
                                                <li>
                                                    <a data-toggle="modal" href="#basic" > Add New Employee</a>
                                                </li>
                                                <li class="divider"> </li>
                                                <li>
                                        ...
                                        <table class="table table-bordered table-hover">
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th> Email </th>
                                                    <th> Date Hired </th>
                                                    <th> Employee File/s</th>
                                                    <th> Files for Follow-up</th>
                                                    <th> Status </th>
                                                    <th></th>
                                                </tr>
                                            </thead>
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td> Brandon Jake </td>
                                                    <td> Sullano </td>
                                                    <td> brandon@consultareinc.com </td>
                                                    <td> 03/20/2022</td>
                                                    <td> 8</td>
                                                    <td> 2</td>
                                                    <td>
                                                        <span class="label label-sm label-warning"> (3days )Suspended </span>
                                                    </td>
                                                    <td style="text-align:center;">
                                                        <a class="btn dark btn-sm btn-outline sbold uppercase" data-toggle="modal" href="#large">
                                                            <i class="fa fa-share"></i> View </a>
                                                ...
                                                <tr>
                                                    ...
                                                    <td> Lyneth </td>
                                                    <td> Sullano </td>
                                                    <td> Lyneth@consultareinc.com  </td>
                                                    <td> 03/20/2022</td>
                                                    <td> 9</td>
                                                    <td> 6</td>
                                                    <td>
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-md-8">
                                                                <div class="input-icon">
                                                                    ...
                                                                    <input type="date" class="form-control" placeholder="Left icon"> </div>
                                                            </div>
                                                        </div>
                                                        <div class="form-group">
                                                            <label>Job Description:</label>
                                                            <select multiple class="form-control">
                                                                <option>Job Description 1</option>
                                                                <option>Job Description 2</option>
                                                                <option>Job Description 3</option>
                                                                <option>Job Description 4</option>
                                                                <option>Job Description 5</option>
                                                            </select>
                                                        </div>
                                                        <div class="form-group">
                 ...
                 <div class="modal fade bs-modal-lg" id="large" tabindex="-1" role="dialog" aria-hidden="true">
                                        <div class="modal-dialog modal-lg">
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                    <button type="button" class="close" data-dismiss="modal" aria-hidden="true"></button>
                                                    <h4 class="modal-title">Employee #1 More Details</h4>
                                                </div>
                                                <div class="modal-body"> 
                                                                ...
                                                                <div class="form-body">
                                                                    ...
                                                                    <div class="form-group">
                                                                        ...
                                                                        <div class="col-md-8">
                                                                            <div class="input-group">
                                                                                ...
                                                                                <input value="arnel@consultareinc.com" type="email" class="form-control" placeholder="Email Address"> </div>
                                                                        </div>
                                                                    </div>
                                                                    ...
                                                                    <div class="form-group">
                                                                        ...
                                                                        <div class="col-md-8">
                                                                            <div class="input-icon">
                                                                                <i class="fa fa-bell-o"></i>
                                                                                <input value="Arnel" type="text" class="form-control" placeholder="Left icon"> </div>
                                                                        </div>
                                                                    </div>
                                                                    <div class="form-group">
                                                                        <label class="col-md-3 control-label">Last Name</label>
                                                                        <div class="col-md-8">
                                                                            <div class="input-icon">
                                                                                <i class="fa fa-bell-o"></i>
                                                                                <input value="Ryan" type="text" class="form-control" placeholder="Left icon"> </div>
                                                                        </div>
                                                                    </div>
                                                                    <div class="form-group">
                                                                        <label class="col-md-3 control-label">Date Hired</label>
                                                                        <div class="col-md-8">
                                                                            <div class="input-icon">
                                                                                ...
                                                                                <input value="2022-03-20" type="date" class="form-control" placeholder="Left icon"> </div>
                                                                        </div>
                                                                    </div>
                                                                    ...
                                                                    <label class="col-md-3 control-label"></label>
                                                                       <div class="col-md-8">
                                                                        <label>Job Description:</label>
                                                                            ...
                                                                            <select multiple class="form-control">
                                                                                <option selected >Job Description 1</option>
                                                                                <option>Job Description 2</option>
                                                                                <option>Job Description 3</option>
                                                                                <option>Job Description 4</option>
                                                                                <option>Job Description 5</option>
                                                                    ...
                                                                    <label class="col-md-3 control-label"></label>
                                                                        ...
                                                                        <label>Reporting To:</label>
                                                                            <select class="form-control">
                                                                                <option>Manager 1</option>
                                                                                <option selected >Manager 2</option>
                                                                                <option>Manager 2</option>
                                                                                <option>Manager 2</option>
                                                                                <option>Manager 2</option>
                                                                            </select>
                                                                            ...
                                                                            <table class="table table-bordered table-hover">
                                                                                ...
                                                                                <tbody>
                                                                                    ...
                                                                                    <tr>
                                                                                        ...
                                                                                        <td>Document Here</td>
                                                                                        <td>
                                                                                            <span class="label label-sm label-info">For Approval</span>
                                                                                        </td>
                                                                                    ...
                                                                                    <tr>
                                                                                        ...
                                                                                        <td>Document Here</td>
                                                                                        <td>
                                                                                            <span class="label label-sm label-danger">Not Started</span>
                                                                                        </td>
