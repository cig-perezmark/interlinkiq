                ...
                <div class="panel panel" >
                    <div class="panel-heading" style="background-color:#F5F5F5;color:black;" >
                           <div class="row">
                                    	...
                                    	<table  style="font-size:13px;">
                                    	    <tbody>
                                    	        <tr onclick="view_more('.$data1['History_id'].')" id="parents_'.$data1['History_id'].'">
                                					...
                                					<th class="child_1">Assign to: '.$data1['first_name'].'</th>
                                					<th class="child_1">'.$data1['Action_Items_name'].'</th>
                                					<th class="child_1" width="6%">Duedate: '.date("Y-m-d", strtotime($data1['Action_date'])).'</th>
                                ...
                                <div class="col-md-1">
                                    <a style="font-weight:800;font-size:14px;" href="#modalGetHistory" data-toggle="modal" class="btn green btn-xs btn-outline" onclick="btnNew_History('.$data1['History_id'].')">Add</a>
                                    <a style="font-weight:800;font-size:14px;" href="#modalGet_parent" data-toggle="modal" class="btn red btn-xs btn-outline" onclick="onclick_parent('.$data1['History_id'].')">Edit</a>
                                </div>
                           </div>
                    </div>
       ...
       //layer 2
		...
		$response .= '
			<tr id="sub_two_'.$data2['CAI_id'].'">
				...
				<td class="child_2">Due: '.date("Y-m-d", strtotime($data2['CAI_Action_due_date'])).'</td>
                    ...
                    while($row_comment = mysqli_fetch_array($result_comment)){ 
                        ...
                        <i class="icon-speech" style="font-size:18px;color:#fff;margin-left:12px;"></i>
                            <span class="badge" style="background-color:'; if($row_comment['count'] == 0){$response .= '#DC3535';}else{$response .= 'blue';}  $response .= ';margin-left:-7px;margin-top:-10px;position:absolute;z-index:1;">
                ...
                <td class="child_2">';
                    $response .= '<a style="font-weight:800;color:#fff;" href="#modalGetHistory_Child2" data-toggle="modal" class="btn blue btn-xs" onclick="btnNew_History_Child2('.$data2['CAI_id'].')">Add</a>';
		...
		$response .= '
			<tr id="sub_three_main'.$data3['CAI_id'].'">
                ...
                <td class="child_2">';
                    $response .= '<a style="font-weight:800;color:#fff;" href="#modalGetHistory_Child3" data-toggle="modal" class="btn blue btn-xs" onclick="btnNew_History_Child3('.$data3['CAI_id'].')">Add</a>';
		...
		$response .= '
			<tr id="sub_four_'.$data4['CAI_id'].'">
                ...
                <td class="child_2">';
                    $response .= '<a style="font-weight:800;color:#fff;" href="#modalGetHistory_Child4" data-toggle="modal" class="btn blue btn-xs" onclick="btnNew_History_Child4('.$data4['CAI_id'].')">Add</a>';
		...
		$response .= '
			<tr id="sub_five_'.$data5['CAI_id'].'">
                ...
                <td class="child_2">';
                    $response .= '<a style="font-weight:800;color:#fff;" href="#modalGetHistory_Child5" data-toggle="modal" class="btn blue btn-xs" onclick="btnNew_History_Child5('.$data5['CAI_id'].')">Add</a>';
