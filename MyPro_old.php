                                             ...
                                             <div class="row">
                                                <div class="form-group">
                                                    ...
                                                    <?php
                                                        ...
                                                        else if($switch_user_id == 247){
                                                            echo '<option value="SFI" >SFI</option>'; 
                                                        }
                                                        else if($switch_user_id == 266){
                                                            echo '<option value="RFP" >RFP</option>'; 
                                                        }
                                                        else if($switch_user_id == 27){
                                                            echo '<option value="BGL" >BeGreenLegal</option>'; 
                                                        }
                                                    ?>
                                                    </select>
                                                    </div>
        ...
        <script type="text/javascript">
            ...
            $(document).ready(function(){
               ...
               var calendar = $('#calendar_data').fullCalendar({
                    ...
                    events:'MyPro_Folders/fetch_calendar.php',
                    editable:true,
                    ...
                    eventClick:  function(event) {
                        ...
                        // $.ajax({
                        //     type: "GET",
                        //     url: "MyPro_Folders/fetch_data_calendar.php?postId="+id,
                        //     dataType: "html",
                        //     success: function(data){
