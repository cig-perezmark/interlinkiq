...
<html lang="en" data-bs-theme="light">
  <head>
    ...
    <style>
      ...
      .sign-in-container {
        background: url('uploads/login/bg/Swiss Food.jpg');
        background-size: cover;
        background-repeat: no-repeat;
        background-position: center;
      }
      ...
      <div class="row justify-content-center">
        <div class="col-lg-4 p-5 sign-in-container d-flex align-items-center">
          <form method="POST" class="form formSignIn w-100">
            ...
            <button class="btn btn-primary w-100 py-2" type="submit" style="background: #FE686A; border-color: #FE686A;">
              Login
        ...
        <div class="col-lg-4 p-5 sign-up-container">
          <form method="POST" class="form formSignUp">
            ...
            <button class="btn btn-primary w-100 py-2" type="submit" style="background: #BD5451; border-color: #BD5451;">SIGN UP</button>
          </form>
        </div>
      </div>
    </div>
