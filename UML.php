...
<html lang="en" data-bs-theme="light">
  <head>
    ...
    <title>United Minerals LLC. - Login</title>
    ...
    <style>
      ...
      .sign-in-container {
        background: url('uploads/login/bg/UML.png');
        background-size: cover;
        background-repeat: no-repeat;
        background-position: center;
      }
  ...
  <body class="d-flex flex-column align-items-center row-direction-column py-4x bg-body-tertiaryx bg-dark login-container">
    ...
    <div class="container text-center">
      <div class="row justify-content-center">
        <div class="col-lg-6">
          <h1 style="font-weight: 700; margin: 30px 0;">United Minerals LLC</h1>
        </div>
      </div>
    </div>
      ...
      <div class="row justify-content-center">
        <div class="col-lg-4 p-5 sign-in-container d-flex align-items-center">
          <form method="POST" class="form formSignIn w-100">
            ...
            <button class="btn btn-primary w-100 py-2" type="submit" style="background: #5ad100; border-color: #5ad100; color: #fff;">
              Login
        ...
        <div class="col-lg-4 p-5 sign-up-container">
          <form method="POST" class="form formSignUp">
            ...
            <button class="btn btn-primary w-100 py-2" type="submit" style="background: #00b0f4; border-color: #00b0f4; color: #fff;">SIGN UP</button>
          </form>
        </div>
      </div>
    </div>
