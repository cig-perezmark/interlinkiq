...
<html lang="en" data-bs-theme="light">
  <head>
    ...
    <title>Vendor Match - Login</title>
    ...
    <style>
      ...
      .sign-in-container {
        background: url('uploads/login/bg/vm.png');
        background-size: cover;
        background-repeat: no-repeat;
        background-position: center;
      }
  ...
  <body class="d-flex flex-column align-items-center row-direction-column py-4x bg-body-tertiaryx bg-dark login-container">
    ...
    <div class="container text-center">
      <div class="row justify-content-center">
        <div class="col-lg-6">
          <img class="sign-logo" src="uploads/login/icon/vm.png" />
        </div>
      </div>
    </div>
      ...
      <div class="row justify-content-center">
        <div class="col-lg-4 p-5 sign-in-container d-flex align-items-center">
          <form method="POST" class="form formSignIn w-100">
            <h1 class="text-defaultz">Welcome Back</h1>

            <h3 class="text-defaultz">Login</h3>
            ...
            <button class="btn btn-primary w-100 py-2" type="submit" style="background: #0074a9; border-color: #0074a9;">
              Login
            ...
            <a href="#" class="text-defaultz">Forgot Password?</a>
          </form>
        </div>
          ...
          <form method="POST" class="form formSignUp">
            ...
            <div class="input-group mb-3">
              <div class="form-check form-check-inline">
                <input class="form-check-input" type="radio" name="vendor_type" value="1">
                <label class="form-check-label">I am Buyer</label>
              </div>
              <div class="form-check form-check-inline">
                <input class="form-check-input" type="radio" name="vendor_type" value="2">
                <label class="form-check-label">I am Vendor</label>
              </div>
            </div>

            <button class="btn btn-primary w-100 py-2" type="submit" style="background: #00344c; border-color: #00344c;">SIGN UP</button>
          </form>
        </div>
      </div>
    </div>
    ...
    <script>
      ...
      $(".formSignUp").on('submit',(function(e) {
        ...
        var formData = new FormData(this);
        formData.append('btn_SignUpVM',true);
        formData.append('client',19);
