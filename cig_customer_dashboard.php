<?php 
    ...
    function createNav($text, $link) {
        ...
        return $dashboardView == $link ? '<span style="text-decoration:underline;font-weight:600;">'.$text.'</span>' : '<a href="?'.$link.'">'.$text.'</a>';
    }
    ...
    function accountUsage1($account_id) {
        global $conn;
        $total_usage = 0;
    ...
    function accountUsage3($account_id) {
        global $conn;
        $total_usage = 0;
    ...
    function accountUsageMonth1($account_id) {
        global $conn;
        $total_usage_arr = array();
    ...
    switch($dashboardView) {
        case 'it': {
            include_once "cig_customer_dashboard/it_projects.php";
        } break;
        case 'free': {
            include_once "cig_customer_dashboard/free_access.php";
        } break;
        case 'demo': {
            include_once "cig_customer_dashboard/demo_account.php";
        } break;
        case 'paid': {
            include_once "cig_customer_dashboard/subscriber.php";
        } break;
        default: {
            ...
            $scripts = '
                ...
                <script src="cig_customer_dashboard/js/dashboard.js" type="text/javascript"></script>
            ';

            include_once "cig_customer_dashboard/index.php";
        } break;
    }
?>
        <?php 
