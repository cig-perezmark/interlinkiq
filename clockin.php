...
<style type="text/css">
    ...
    border-top: 1px solid transparent;
                                        ...
                                        <div class="col-md-12">
                                            ...
                                            <?php
                                                ...
                                                if ($current_userEmployerID == 34) {
                                                    ...
                                                    if ($checktimein && $row = mysqli_fetch_assoc($checktimein)) {
                                                    ...
                                                    if ($checktimeout && $row2 = mysqli_fetch_assoc($checktimeout)) {
                                                    ...
                                                    if ($is_in_yesterday && $res2 = mysqli_fetch_assoc($is_in_yesterday)) {
                                                    ...
                                                    if ($is_out_yesterday && $res = mysqli_fetch_assoc($is_out_yesterday)) {
                                                ...
                                                <button data-toggle="modal" href="#set-schedule-modal" class="btn btn-circle btn-success" style="margin-bottom:10px;width:200px:height:50px;font-size:20px;">
                                                    <i class="fa fa-clock-o" aria-hidden="true"></i> Set Schedule
                                                </button></br>
                                                        
                                                <?php
                                                    if($timeSchedule < 0):
                                                        echo 1;
                                                    elseif (empty($is_timeout_yesterday) && !empty($is_timein_yesterday)): ?>
                                                    ...
                                                    <?php elseif ($midnightCSTTimestamp >= $currentTimestamp):
                                                        if (!empty($timeInDateTime) && empty($timeOutDateTime)): ?>
                                                            <button id="btn-stop" class="btn btn-circle btn-danger center-item-control" style="margin-bottom:50px;width:200px:height:50px;font-size:20px;">
                                                                <i class="fa fa-clock-o" aria-hidden="true"></i> Stop Working
                                                            </button>
                                                        ...
                                                        <?php else: ?>
                                                            <button disabled class="btn btn-circle btn-default" style="margin-bottom:10px;width:200px:height:50px;font-size:20px;">
                                                                <i class="fa fa-clock-o" aria-hidden="true"></i> Start Working
                                                            </button>
                                                        <?php endif ?>
                                                    <?php else: ?>
                                                        <button id="btn-start" class="btn btn-circle btn-success" style="margin-bottom:10px;width:200px:height:50px;font-size:20px;">
                                                            <i class="fa fa-clock-o" aria-hidden="true"></i> Start Working
                                                        </button><br>
                                                        <input id="timein_current_user_id" type="hidden" value="<?= $current_userEmployeeID ?>">
                                                        <input id="current_userfullname" type="hidden" value="<?= $current_userFName . ' ' . $current_userLName; ?>">
                                                ...
                                                <div class="portlet light projects-widget">
                                                    <div class="portlet-title">
                                                        <div class="caption caption-md">
                                                            <span class="caption-subject font-blue-madison bold uppercase"><i class="icon-clock"></i> &nbsp;Time Tracking</span><br>
                                                        </div>
                                                    </div>
                                                    <div class="portlet-body">
                                                                ...
                                                                <?php
                                                                    $query = "SELECT t.date, t.IN, t.OUT
                                                                        FROM ( 
                                                                            ...
                                                                            FROM tbl_timein 
                                                                            WHERE (tbl_timein.time_in_datetime >= DATE_SUB(CURRENT_DATE(), INTERVAL 1 MONTH) OR DATE(tbl_timein.time_in_datetime) = CURRENT_DATE()) AND user_id = ?
                                                                            GROUP BY DATE(time_in_datetime)
                                                                            ORDER BY DATE(time_in_datetime) DESC
                                                                        ) AS t";
                                                                
                                                                    $stmt = mysqli_prepare($conn, $query);
                                                                    mysqli_stmt_bind_param($stmt, "i", $current_userEmployeeID);
                                                                    mysqli_stmt_execute($stmt);
                                                                    $resultQuery = mysqli_stmt_get_result($stmt);
                                                                    
                                                                    $rows = mysqli_fetch_all($resultQuery, MYSQLI_ASSOC);
                                                                ?>
                                                                    ...
                                                                    <thead>
                                                                        <tr role="row">
                                                                            <?php foreach ($rows as $row): ?>
                                                                                <th class="text-bold text-center bg-light" tabindex="0" aria-controls="timein_summary_table" rowspan="1" colspan="2"><?= $row['date'] ?></th>
                                                                            <?php endforeach; ?>
                                                                        </tr>
                                                                    </thead>
                                                                    <tbody>
                                                                        <tr role="row" class="odd">
                                                                            <?php foreach ($rows as $row): ?>
                                                                                <td class="text-center"><span class="text-success">IN</span><br>
                                                                                    <?php if (!empty($row['IN'])): ?>
                                                                                        <span class="bold"><?= date('h:i A', strtotime($row['IN'])) ?></span>
                                                                                    <?php else: ?>
                                                                                        -
                                                                                    <?php endif ?>
                                                                                </td>
                                                                                <td class="text-center"><span class="text-danger">OUT</span><br>
                                                                                    <?php if (!empty($row['OUT'])): ?>
                                                                                        <span class="bold"><?= date('h:i A', strtotime($row['OUT'])) ?></span>
                                                                                    <?php else: ?>
                                                                                        -
                                                                                    <?php endif ?>
                                                                                </td>
                    ...
                    <div class="modal fade bs-modal-lg" id="set-schedule-modal" tabindex="-1" role="dialog" aria-hidden="true">
                        <div class="modal-dialog">
                            <div class="modal-content">
                                <form  class="form-horizontal" id="set-schedule">
                                    ...
                                    <div class="modal-body">
                                        <div class="col-md-12">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="input-group" style="width: 100%!important">
                                                  <input type="checkbox" checked class="make-switch" data-on-text="&nbsp;Enable&nbsp;&nbsp;" data-off-text="&nbsp;Disabled&nbsp;">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="modal-footer" style="border-top: transparent!important">
                                        <input type="button" class="btn default" data-dismiss="modal" value="Close" />
                                        <button type="submit" class="btn green ladda-button" name="btnUpdate_Attached" id="set-schedule-btn" data-style="zoom-out"><span class="ladda-label">Set</span></button>
                                    </div>
                                </form>
                            </div>
                        </div>
