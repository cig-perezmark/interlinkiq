<?php 
    $title = "Dashboard";
    $site = "clone_dashboard";

     $breadcrumbs = '';
    $sub_breadcrumbs = 'Sales Dashboard';
     include "header.php"; 
     if ($sub_breadcrumbs) {
                        ...
                        <div class="row">
                            <div class="col-md-12">   
                                <table class="table table-bordered">
                                    ...
                                    <?php
                                    $i = 1;
                                    $query = "SELECT *,tbl_library.ID  as lib FROM tbl_library 
                                    left join tbl_user on tbl_library.user_id = tbl_user.ID where tbl_library.ID != 0 and parent_id = 0 and deleted = 0 and name != '' and name != ' ' and first_name != '' and last_name != '' ORDER BY name ASC";
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td>
                                            	<a href="javascript:;" class="btnClone btn blue btn-outline " onclick="btnClone(<?php echo $row['lib']; ?>)">CLONE</a>
                                            	<a class="btn blue btn-outline btnViewCon hide" data-toggle="modal" href="#modalGetContact" data-id="<?php echo $row["lib"]; ?>" style="float:right;margin-right:20px;">
                                                    CLONE
                                                </a>
                                            </td>
                                        </tr>
                ...
                <div class="modal-content">
                     <form action="sales-function/clone-function.php" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="modal-footer">
                            <input type="submit" name="btnClone" value="Clone" class="btn btn-info">       
                         </div>
                    </form>
                </div>
      </div>
