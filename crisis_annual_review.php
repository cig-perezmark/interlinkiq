<?php 
    $title = "Crisis Incident Annual Review";
                            ...
                            <div class="portlet light portlet-fit ">
                                <div class="portlet-title">
                                    <div class="caption">
                                        ...
                                        <span class="caption-subject font-dark bold uppercase">CRISIS MANAGEMENT PLAN - Annual Review</span>
                                    </div>
                                ...
                                <div class="portlet-body">
                                    <div class="portlet-title tabbable-line">
                                        <ul class="nav nav-tabs">
                                            <li class="active">
                                                <a href="#plan" data-toggle="tab">Crisis Management Plan</a>
                                            </li>
                                            <li>
