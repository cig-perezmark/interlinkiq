...
<style type="text/css">
    ...
    #modalChecklistSetting ul li .btn-checklist {
        ...
        top: 7px;
                                        ...
                                        if ($current_userInvited == 0 OR $current_userEmployeeID > 0) {
                                            ...
                                            <ul class="nav nav-tabs">
                                                ...
                                                if ($switch_user_id == 34) {
                                                    echo '<li>
                                                        <a href="#tab_actions_notif" data-toggle="tab">Notification</a>
                                                    </li>
                                                    <li>
                                                        <a href="#tab_actions_service" data-toggle="tab">Service Log</a>
                                                    </li>';
                                                }
                                            echo '</ul>';
                                        }
                                    ...
                                    <?php
                                        ...
                                        if ($current_userInvited == 0 OR $current_userEmployeeID > 0) {
                                            echo '<div class="tab-content">
                                                <div class="tab-pane active" id="tab_actions_sent">
                                                    <table class="table table-bordered table-hover" id="tableData_1">
                                                        ...
                                                        <tbody>';
                                                            ...
                                                            $tr_billing = '';
                                                            $tr_billing_arr = array();
                                                            $s_type_services_arr = array(
                                                                0 => '',
                                                                1 => 'Subscription',
                                                                2 => 'Project-based',
                                                                3 => 'Project-based'
                                                            );
                                                            $s_frequency_collection_arr = array(
                                                                0 => '',
                                                                1 => 'Monthly',
                                                                2 => 'Annually'
                                                            );
                                                            $s_payment_method_arr = array(
                                                                0 => '',
                                                                1 => 'Chargebee',
                                                                2 => 'PayPal',
                                                                3 => 'Bank Wire',
                                                            ...
                                                            $result = mysqli_query( $conn,"
                                                                WITH RECURSIVE cte (s_ID, s_name, s_reviewed_due, s_status, s_material, s_service, s_address, s_category, s_contact, s_document, s_description_services, s_type_services, s_type_services_other, s_frequency_collection, s_payment_amount, s_payment_method, s_payment_method_other, s_payment_date, s_payment_ref_number, s_comment, d_ID, d_type, d_name, d_file, d_file_due, d_status, d_count, checked_percentage) AS
                                                                (
                                                                    SELECT
                                                                    s1.ID AS s_ID,
                                                                    s1.name AS s_name,
                                                                    ...
                                                                    s1.description_services AS s_description_services,
                                                                    s1.type_services AS s_type_services,
                                                                    s1.type_services_other AS s_type_services_other,
                                                                    s1.frequency_collection AS s_frequency_collection,
                                                                    s1.payment_amount AS s_payment_amount,
                                                                    s1.payment_method AS s_payment_method,
                                                                    s1.payment_method_other AS s_payment_method_other,
                                                                    s1.payment_date AS s_payment_date,
                                                                    s1.payment_ref_number AS s_payment_ref_number,
                                                                    s1.comment AS s_comment,
                                                                    d1.ID AS d_ID,
                                                                    d1.type AS d_type,
                                                                    d1.name AS d_name,
                                                                    d1.file AS d_file,
                                                                    ...
                                                                    s2.description_services AS s_description_services,
                                                                    s2.type_services AS s_type_services,
                                                                    s2.type_services_other AS s_type_services_other,
                                                                    s2.frequency_collection AS s_frequency_collection,
                                                                    s2.payment_amount AS s_payment_amount,
                                                                    s2.payment_method AS s_payment_method,
                                                                    s2.payment_method_other AS s_payment_method_other,
                                                                    s2.payment_date AS s_payment_date,
                                                                    s2.payment_ref_number AS s_payment_ref_number,
                                                                    s2.comment AS s_comment,
                                                                    d2.ID AS d_ID,
                                                                    d2.type AS d_type,
                                                                    d2.name AS d_name,
                                                                    d2.file AS d_file,
                                                                ...
                                                                s_address, 
                                                                s_category,
                                                                s_description_services, s_type_services, s_type_services_other, s_frequency_collection, s_payment_amount, s_payment_method, s_payment_method_other, s_payment_date, s_payment_ref_number, s_comment,
                                                                c_name,
                                                                d_compliance,
                                                                d_counting,
                                                                d_percentage,
                                                            ...
                                                            if ( mysqli_num_rows($result) > 0 ) {
                                                                ...
                                                                while($row = mysqli_fetch_array($result)) {
                                                                    ...
                                                                    if (!in_array($s_ID, $tr_billing_arr)) {
                                                                        array_push($tr_billing_arr ,$s_ID);

                                                                        $s_description_services = htmlentities($row["s_description_services"] ?? '');
                                                                        $s_frequency_collection = $row["s_frequency_collection"];

                                                                        $s_payment_method = $row["s_payment_method"];
                                                                        if ($s_payment_method == 4) {
                                                                            $s_payment_method_v = htmlentities($row["s_payment_method_other"] ?? '');
                                                                        } else {
                                                                            $s_payment_method_v = $s_payment_method_arr[$s_payment_method];
                                                                        }

                                                                        $tr_billing .= '<tr>
                                                                            <td>'.htmlentities($s_name ?? '').'</td>
                                                                            <td>'.htmlentities($row["s_comment"] ?? '').'</td>
                                                                            <td>'.$s_description_services.'</td>
                                                                            <td>'.$s_frequency_collection_arr[$s_frequency_collection].'</td>
                                                                            <td>$ '.htmlentities($row["s_payment_amount"] ?? '').'</td>
                                                                            <td>'.htmlentities($row["s_payment_date"] ?? '').'</td>
                                                                            <td>'.$s_payment_method_v.'</td>
                                                                            <td>'.htmlentities($row["s_payment_ref_number"] ?? '').'</td>
                                                                        </tr>';
                                                                    }
                                                                }
                                                            }
                                                ...
                                                <div class="tab-pane" id="tab_actions_notif">
                                                    <table class="table table-bordered table-hover">
                                                        <thead>
                                                            <tr>
                                                                ...
                                                                <th rowspan="2" style="width: 135px;">Frequency of Collection</th>
                                                                <th colspan="4" class="text-center">Payment</th>
                                                            </tr>
                                                            <tr>
                                                                <th style="width: 100px;" class="text-center">Amount</th>
                                                                <th style="width: 100px;" class="text-center">Date</th>
                                                                <th style="width: 100px;" class="text-center">Method</th>
                                                                <th style="width: 100px;" class="text-center">Reference Number</th>
                                                            </tr>
                                                        </thead>
                                                        <tbody>'.$tr_billing.'</tbody>
                                                    </table>
                                                </div>
                                                <div class="tab-pane" id="tab_actions_service">
                                                    <ul class="nav nav-tabs">
                                                        <li class="active">
                                                            <a href="#service_1" data-toggle="tab" aria-expanded="true" style="">Client</a>
                                                        </li>
                                                        <li class="">
                                                            <a href="#service_2" data-toggle="tab" aria-expanded="false" style="">Action</a>
                                                        </li>
                                                    </ul>
                                                    <div class="tab-content">
                                                        <div class="tab-pane active" id="service_1">
                                                            <a href="#modalClient" class="btn btn-success" data-toggle="modal" onclick="btnClient(0, 2)">Add New <i class="fa fa-fw fa-plus"></i></a>
                                                            <div class="table-scrollable">
                                                                <table class="table table-bordered table-hover" id="tableData_client">
                                                                    <thead>
                                                                        <tr class="bg-primary">
                                                                            <th>Name</th>
                                                                    ...
                                                                    <tbody>';
                                                                        ...
                                                                        $selectClient = mysqli_query( $conn,"
                                                                            ...
                                                                            FROM tbl_supplier_client AS c

                                                                            LEFT JOIN (
                                                                                SELECT
                                                                                *
                                                                                FROM tbl_supplier_action
                                                                                WHERE deleted = 0
                                                                                AND type = 2
                                                                            ) AS a
                                                                            ON a.user_id = c.user_id
                                                                            AND FIND_IN_SET(a.ID, REPLACE(c.type, ' ', ''))

                                                                            WHERE c.deleted = 0
                                                                            AND c.user_id = $switch_user_id

                                                                            ORDER BY c.name, a.name
                                                                        " );
                                                                        if ( mysqli_num_rows($selectClient) > 0 ) {
                                                                            while($rowClient = mysqli_fetch_array($selectClient)) {
                                                                                $c_ID = $rowClient["c_ID"];
                                                                                $c_name = htmlentities($rowClient["c_name"] ?? '');
                                                                                $a_ID = $rowClient["a_ID"];
                                                                                $a_name = htmlentities($rowClient["a_name"] ?? '');
                                                                                $a_active = $rowClient["a_active"];

                                                                                echo '<tr class="c_'.$c_ID.'">
                                                                                    <td>'.$c_name.'</td>
                                                                                    <td>'.$a_name.'</td>
                                                                                    <td class="text-center"><input type="checkbox" name="" value="'.$a_active.'" '; echo $a_active == 1 ? 'checked':''; echo ' onchange="checkAction(this, '.$a_ID.')"></td>
                                                                                    <td class="text-center"><a href="#modalClient" class="btn btn-outline dark btn-xs" data-toggle="modal" onclick="btnClient('.$c_ID.', 2)"><i class="fa fa-fw fa-pencil"></i></a><a href="javascript:;" class="btn btn-danger btn-xs" onclick="btnDeleteClient(this, '.$c_ID.')"><i class="fa fa-fw fa-trash"></i></a></td>
                                                                                </tr>';
                                                                            }
                                                                        }
                                                        ...
                                                        <div class="tab-pane" id="service_2">
                                                            <a href="#modalAction" class="btn btn-success" data-toggle="modal" onclick="btnAction(0, 1)">Add New <i class="fa fa-fw fa-plus"></i></a>
                                                            <div class="table-scrollable">
                                                                <table class="table table-bordered table-hover" id="tableData_action">
                                                                    <thead>
                                                                        <tr class="bg-primary">
                                                                            <th>Name</th>
                                                                            <th class="text-center" style="width: 120px;">Active</th>
                                                                    ...
                                                                    <tbody>';
                                                                        ...
                                                                        $selectAction = mysqli_query( $conn,"SELECT * FROM tbl_supplier_action WHERE deleted = 0 AND type = 1 AND user_id = $switch_user_id ORDER BY name" );
                                                                        if ( mysqli_num_rows($selectAction) > 0 ) {
                                                                            while($rowAction = mysqli_fetch_array($selectAction)) {
                                                                                $a_ID = $rowAction["ID"];
                                                                                $a_name = htmlentities($rowAction["name"] ?? '');

                                                                                echo '<tr class="a_'.$a_ID.'">
                                                                                    <td>'.$a_name.'</td>
                                                                                    <td class="text-center"><input type="checkbox" name="" value="'.$rowAction["active"].'" '; echo $rowAction["active"] == 1 ? 'checked':''; echo ' onchange="checkAction(this, '.$a_ID.')"></td>
                                                                                    <td class="text-center"><a href="#modalAction" class="btn btn-outline dark btn-xs" data-toggle="modal" onclick="btnAction('.$a_ID.', 1)"><i class="fa fa-fw fa-pencil"></i></a><a href="javascript:;" class="btn btn-danger btn-xs" onclick="btnDeleteAction(this, '.$a_ID.')"><i class="fa fa-fw fa-trash"></i></a></td>
                                                                                </tr>';
                                                                            }
                                                                        }
                                        ...
                                        <div class="tabbable tabbable-tabdrop">
                                            <ul class="nav nav-tabs">
                                                ...
                                                <li class="tabProducts">
                                                    <a href="#tabProducts_1" data-toggle="tab">Material Requirements</a>
                                                </li>
                                            ...
                                            <div class="tab-content margin-top-20">
                                                ...
                                                <div class="tab-pane" id="tabProducts_1">
                                                    ...
                                                    ?>
                                                    <a href="#modalNewMaterial" data-toggle="modal" class="btn green" onclick="btnNew_Material(<?php echo $switch_user_id; ?>, 1, 'modalNewMaterial', 1, 0)">Add New Material</a>
                                                    <div class="table-scrollable">
                    ...
                    <div class="modal fade" data-keyboard="false" id="modalClient" tabindex="-1" role="dialog" aria-hidden="true">
                        <div class="modal-dialog">
                            <div class="modal-content">
                                <form method="post" enctype="multipart/form-data" class="modalForm modalClient">
                                    <div class="modal-header">
                                        <button type="button" class="close" data-dismiss="modal" aria-hidden="true"></button>
                                    ...
                                    <div class="modal-body"></div>
                                    <div class="modal-footer">
                                        <button type="submit" class="btn btn-success ladda-button" name="btnSave_Client" id="btnSave_Client" data-style="zoom-out"><span class="ladda-label">Save & Close</span></button>
                                    </div>
                                </form>
                            </div>
                        </div>
                    </div>
                    <div class="modal fade" data-keyboard="false" id="modalServices" tabindex="-1" role="dialog" aria-hidden="true">
                        <div class="modal-dialog">
                            <div class="modal-content">
                                <form method="post" enctype="multipart/form-data" class="modalForm modalServices">
                                    <div class="modal-header">
                                        <button type="button" class="close" data-dismiss="modal" aria-hidden="true"></button>
                                        <h4 class="modal-title">Types of Services Details</h4>
                                    </div>
                                    <div class="modal-body"></div>
                                    <div class="modal-footer">
                                        <input type="button" class="btn dark btn-outline" data-dismiss="modal" value="Close">
                    ...
                    <div class="modal fade" data-keyboard="false" id="modalAction" tabindex="-1" role="dialog" aria-hidden="true">
                        <div class="modal-dialog">
                            <div class="modal-content">
                                <form method="post" enctype="multipart/form-data" class="modalForm modalAction">
                                    <div class="modal-header">
                                        <button type="button" class="close" data-dismiss="modal" aria-hidden="true"></button>
        ...
        <script type="text/javascript">
            ...
            function changedService(e) {
                if (e.value == 3) {
                    $('#type_services_other').removeClass('hide');
                } else {
                    $('#type_services_other').addClass('hide');
                }
            }
            function changedPayment(e) {
                if (e.value == 4) {
                    $('#payment_method_other').removeClass('hide');
                } else {
                    $('#payment_method_other').addClass('hide');
                }
            }
            ...
            // Service Log Section
            function btnDeleteClient(e, id) {
                if (confirm("Your item will be deleted!")) {
                    $.ajax({
                        type: "GET",
                        url: "function.php?btnDelete_Client="+id,
                        dataType: "html",
                        success: function(response){
            ...
            function btnClient(id, t) {
                $.ajax({
                    type: "GET",
                    url: "function.php?modalView_Client="+id+"&t="+t,
                    dataType: "html",
                    success: function(data){
            ...
            function btnType(id, t) {
                $.ajax({
                    type: "GET",
                    url: "function.php?modalView_Type="+id+"&t="+t,
                    dataType: "html",
                    success: function(data){
                        $("#modalServices .modal-body").html(data);
                    }
                });
            }
            $(".modalClient").submit(function(e){
                e.preventDefault();
                ...
                // var l = Ladda.create(document.querySelector('#btnSave_Type'));
                ...
                $.ajax({
                    ...
                    success:function(response) {
                        if ($.trim(response)) {
                            ...
                            var obj = jQuery.parseJSON(response);
                            if (button == "btnSave_Type") {
                                if (obj.new == 0) {
                                    $('#tableData_services tbody').append(obj.data);
                                } else {
                                    $('#tableData_services tbody .a_'+obj.ID).replaceWith(obj.data);
                                }

                                $('#modalClient .modal-body .input-group input').val('');
                                $('#modalClient .modal-body .input-group input').focus();
                            } else {
                                if (obj.new == 0) {
                                    $('#tableData_client tbody').append(obj.data);
                                } else {
                                    // Remove duplicates of the same ID, keep only the first occurrence
                                    $('#tableData_client tbody .c_' + obj.ID).not(':first').remove();

                                    // Replace the remaining one
                                    $('#tableData_client tbody .c_' + obj.ID).replaceWith(obj.data);
                                }
                                
                                $('#modalClient .modal-body .client').val('');
                                $('#tableData_services tbody').html('');
            ...
            $(".modalServices").submit(function(e){
                e.preventDefault();
                ...
                var formData = new FormData(this);
                formData.append('btnSave_Type',true);
            ...
            function btnAction(id, t) {
                $.ajax({
                    type: "GET",
                    url: "function.php?modalView_Action="+id+"&t="+t,
                    dataType: "html",
                    success: function(data){
            ...
            function btnDeleteAction(e, id) {
                if (confirm("Your item will be deleted!")) {
                    $.ajax({
                        type: "GET",
                        url: "function.php?btnDelete_Action="+id,
                        dataType: "html",
                        success: function(response){
                            $(e).parent().parent().remove();
                            alert('This item has been deleted');
            ...
            function checkAction(e, id) {
                $.ajax({
                    type: "GET",
                    url: "function.php?modalCheck_Action="+id+"&v="+e.checked,
                    dataType: "html",                  
                    success: function(data){
                        // alert(data);
                    }
            ...
            $(".modalAction").submit(function(e){
                ...
                var formData = new FormData(this);
                formData.append('btnSave_Action',true);

                var l = Ladda.create(document.querySelector('#btnSave_Action'));
                l.start();
                ...
                $.ajax({
                    ...
                    success:function(response) {
                        if ($.trim(response)) {
                            ...
                            var obj = jQuery.parseJSON(response);
                            if (obj.new == 0) {
                                $('#tableData_action tbody').append(obj.data);
                            } else {
                                $('#tableData_action tbody .a_'+obj.ID).replaceWith(obj.data);
                            }
                            $('#modalAction .modal-body .input-group input').val('');
                            $('#modalAction .modal-body .input-group input').focus();
                        } else {
                            msg = "Error!"
                        }
                        l.stop();
