                     ...
                     <div class="portlet-body">
                            <table class="table table-bordered table-hover" id="tableData2">
                                ...
                                <tbody>
                                    <?php
                                        $t=1;
                                        $query = "SELECT * FROM tbl_Customer_Relationship 
                    left join tbl_Customer_Relationship_FSE on crm_id = crm_ids where Account_Directory = 1 and account_about !='' and account_product !='' order by crm_id ASC";
                                        $result = mysqli_query($conn, $query);
                                                                    
                                        while($row = mysqli_fetch_array($result)){?>
                                        <tr>
                                                <td style=""><a target="_blank" href="https://interlinkiq.com/login.php"><?php echo $row['account_name']; ?></a></td>
                                               <td>
                                                   <?php  
                                                    $string = strip_tags($row['account_about']); 
                                               ...
                                               <td>
                                                   <?php
                                                       $stringProduct = strip_tags($row['account_product']); 
                                               ...
                                               <td><?php echo $row['account_service']; ?></td>
                                               <!--<td>-->
