...
?>
                    ...
                    <div class="portlet-body">
                        ...
                        <div class="tabbable tabbable-tabdrop">
                            <ul class="nav nav-tabs">
                                <li class="active">
                                    <a href="#tab1" data-toggle="tab">Form</a>
                                </li>
                                <li>
                                    <a href="#tab2" data-toggle="tab">Records</a>
                                </li>
                                <li>
                                    <a href="#tab3" data-toggle="tab">Procedure Reference</a>
                                </li>
                                </li>
                            </ul>
                            <div class="tab-content">
                                    ...
                                    <form action="controller.php" method="POST" enctype="multipart/form-data">
                                        <div class="row" style="margin-top:15px">
                                            <div class="col-md-6">
                                                ...
                                                <input type="text" value="<?= $_COOKIE['first_name'].' '. $_COOKIE['last_name'] ?>" name="sampled_by" class="form-control">
                                            </div>
                                            <div class="col-md-6">
                                                <label class="caption-subject font-dark bold uppercase">Sampled Date/Time</label>
                                                <input type="datetime-local" name="sampled_date" class="form-control">
                                            </div>
                                        </div>
                                        <div class="row" style="margin-top:15px">
                                            <div class="col-md-6">
                                                ...
                                                <div id="data_container">
                                                    <?php
                                                        ...
                                                        if(!empty($_GET['equip_id'])){
                                                            $select_registered = "SELECT * FROM new_emp_equipment_frequency WHERE equipment_id = {$_GET['equip_id']}";
                                                            ...
                                                            if ($registered_result) {
                                                                    foreach ($registered_result as $equipmentId) {
                                                                        ...
                                                                        $select_equipment = "SELECT * FROM equipment_reg WHERE equip_id = {$equipmentId['equipment_id']}";
                                                                            ...
                                                                            <div class="row">
                                                                                <div class="col-md-12">
                                                                                    <div class="item-list" style="margin-top:15px">
                                                                                        <div class="item">
                                                                                            <span class="item-text"><?= $equipment_row['equipment']?></span>
                                                                                        </div>
                                                                                    ...
                                                                                    <div class="row">
                                                                                        <?php
                                                                                            $select_params = "SELECT * FROM new_emp_equipment_settings INNER JOIN new_emp_parameters ON new_emp_parameters.id = new_emp_equipment_settings.parameter_id WHERE new_emp_equipment_settings.equip_id = {$equipmentId['equipment_id']}";
                                                                                        ...
                                                                                        <div class="col-md-3">
                                                                                            ...
                                                                                            <div class="d-flex">
                                                                                                <input type="hidden" name="parameter_id[]" value="<?= $param_row['id'] ?>">
                                                                                                ...
                                                                                                <input type="text" name="result[]" class="form-control result-input input-field" data-min="<?= $minimum_value ?>" data-max="<?= $maximum_value ?>" placeholder="Enter result">
                                                                                                <input type="text" name="oum[]" class="form-control long-text" value="<?= $param_row['oum']?>"  readonly>
                                                                                                <input type="text" class="form-control" id="test_result" style="width:100px" readonly>
                                                                                            </div>
                                                                                        </div>
                                                                                        <?php endforeach; ?>
                                                                                    </div>
                                        ...
                                        <div class="row" style="margin-top:15px">
                                            <div class="col-md-6">
                                                <label>Remarks</label>
                                                <textarea id="remarks" class="form-control" name="remarks" style="height:70px"></textarea>
                                            </div>
                                            <div class="col-md-6">
                                                <label style="margin-top:5px">Reference for Result &nbsp;&nbsp;<span class="add-file">+</span></label>
                                                <div id="file-attachments" style="width:50%">
                                                    <input style="margin-top:10px" type="file" class="form-control" name="file_attachment[]">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row" style="margin-top:15px">
                                            <div class="col-md-6">
                                                ...
                                                <input name="received_by" type="text" name="received_by" class="form-control">
                                            </div>
                                            <div class="col-md-6">
                                                <label class="caption-subject font-dark bold uppercase">Received Date/Time</label>
                                                <input name="received_date" type="datetime-local" name="recevied_date" class="form-control">
                                            </div>
                                        </div>
                                        <div class="row" style="margin-top:15px">
                                            <div class="col-md-12">
                                                <button class="btn btn-primary" type="submit" name="save_emp_record">Submit</button>
                                                <hr>
                                            </div>
                                        </div>
                                    </form>
                                ...
                                <div class="tab-pane" id="tab2">
                                    <table id="inspectionTable" class="table table-bordered">
                                        ...
                                        <tbody>
                                            <?php
                                                $sql = "SELECT * FROM new_emp_records WHERE equip_id = {$_GET['equip_id']} GROUP BY sampled_by";
                                                $result = mysqli_query($emp_connection,$sql);
                                                
                                                $sql_pmp = "SELECT * FROM equipment_reg WHERE equip_id  = {$_GET['equip_id']}";
                                                $result_pmp = mysqli_query($pmp_connection,$sql_pmp);
                                                $row_pmp = mysqli_fetch_assoc($result_pmp);
                                                
                                                foreach($result as $row):
                                            ?>
                                            <tr>
                                                <td><?= $row_pmp['equipment'] ?></td>
                                                <td><?= $row['sampled_by'] ?></td>
                                                <td><?= $row['sampled_date'] ?></td>
                                                <td><?= $row['received_by'] ?></td>
                                                <td><?= $row['received_date'] ?></td>
                                                <td><?= $row['result'] ?></td>
                                                <td><?= $row['remarks'] ?></td>
                                                <td><a href="emp_filter_details_view.php?equip_id=<?= $row['equip_id'] ?>&id=<?= $row['id'] ?>" class="btn btn-primary">View</a></td>
                                            </tr>
                                            <?php
                                                endforeach;
                                            ?>
                                ...
                                <div class="tab-pane" id="tab3">
                                    <table id="inspectionTable" class="table table-bordered">
                                        ...
                                        <tbody>
                                            <?php
                                                $sql = "SELECT * FROM new_emp_files WHERE equipment_id = {$_GET['equip_id']}";
                                                $result = mysqli_query($emp_connection,$sql);
                                                foreach($result as $row):
                                            ...
                                            ?>
                                            <tr>
                                                <td><a href="<?= $file_path ?>" target="_blank"><?= $file_name ?></a></td>
                                            </tr>
                                            <?php endforeach; ?>
                                        </tbody>
                                    </table>
    ...
    // });
        ...
        $(document).ready(function() {
            $('.result-input').on('input', function () {
                ...
                var resultElement = input.closest('.d-flex').find('#test_result'); 
                
                if (!isNaN(min) && value < min) {
                    input.css('color', 'red');
                    resultElement.val('Fail');
                ...
                else if (!isNaN(max) && !isNaN(min) && value >= min && value <= max) {
                    input.css('color', ''); // Remove red color
                    resultElement.val('Pass');
    ...
    $(document).ready(function(){
        // Auto-adjust text box width on page load
            $('.long-text').each(function () {
                adjustTextBoxWidth(this);
            });

            function adjustTextBoxWidth(textbox) {
                // Set the width based on the content's length
                var contentLength = $(textbox).val().length;
                $(textbox).width(contentLength * 8); // You may need to adjust the multiplier based on your font and styles
            }
