<?php 
    ...
    // $select_collab_exist = "SELECT * FROM new_emp_collab WHERE employee_id = {$_COOKIE['ID']}";
                ...
                <div class="portlet-body">
                    ...
                    <div class="portlet-title tabbable-line" style="display:flex;justify-content:flex-end">
                        <div>
                            ...
                            <a class="btn btn-secondary" href="emp_bgl_filter.php">List of Inspection</a>
                        </div>
                    ...
                    <div class="portlet-body" id="containter_data">
                        ...
                        <div id="forms" class="tab-pane active" style="display:flex;flex-wrap:wrap">
                            <?php 
                                $sql = "SELECT * FROM area_list WHERE deleted = 0 AND area_list.enterprise_owner = $switch_user_id";
...
function uploadImage(input, id) {
    ...
    formData.append('action', 'update_emp_image');
...
// Replace 'other_page.html' with the URL you want to redirect to/
window.location.href = 'emp_bgl_settings.php?area_name='+zone_id;
}
...
$(document).ready(function() {
    ...
    function saveZone() {
        ...
        formData.append('action', 'save_new_zones_bgl');
