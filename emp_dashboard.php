...
<script src="https://cdn.canvasjs.com/canvasjs.min.js"></script>
                    <div class="row">
                        <div class="col-md-12" style="margin-bottom:20px;display:flex;justify-content:flex-end">
                            <div>
                                <a href="emp_zone" target="_blank" class="btn btn-primary">List of Areas</a>
                                <a class="btn btn-circle btn-icon-only btn-default" href="https://interlinkiq.com/emp_filter.php" target="_blank"><i class="icon-calendar"></i></a>
                            </div>
                        </div>
                    </div>
                    <div class="row">
                    ...
                    <div class="row" style="margin-top:20px" id="row_content">
                        <?php
                        $select_registered = "SELECT * FROM equipment_reg WHERE location = '$first_area_name' AND enterprise_owner = $switch_user_id AND deleted != 1";
