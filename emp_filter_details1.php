                            ...
                            <div class="tab-content">
                                                        ...
                                                        if(!empty($_GET['equip_id'])){
                                                            ...
                                                            if ($registered_result) {
                                                                    foreach ($registered_result as $equipmentId) {
                                                                        ...
                                                                        $select_equipment = "SELECT * FROM equipment_parts WHERE equipment_parts_id = {$equipmentId['equipment_id']}";
                                                                                    ...
                                                                                    <div class="row">
                                                                                        ...
                                                                                        <div class="col-md-3">
                                                                                            ...
                                                                                            <div class="d-flex">
                                                                                                ...
                                                                                                <input type="text" name="oum[]" class="form-control" value="<?= $param_row['oum']?>" style="width:120px" readonly>
                                                                                                <input type="text" class="form-control" id="test_result" readonly>
                                                                                            </div>
                                                                                        </div>
                                                                                        <?php endforeach; ?>
                                                                                    </div>
                                ...
                                <div class="tab-pane" id="tab2">
                                    <table id="inspectionTable" class="table table-bordered">
                                        ...
                                        <tbody>
                                            <?php
                                                $sql = "SELECT * FROM new_emp_records WHERE equip_id = {$_GET['equip_id']}";
                                                $result = mysqli_query($emp_connection,$sql);
                                                
                                                $sql_pmp = "SELECT * FROM equipment_parts WHERE equipment_parts_id  = {$_GET['equip_id']}";
