                                        ...
                                        <div class="portlet light  tasks-widget">
                                            <div class="portlet-title">
                                                <div class="caption caption-md">
                                                    ...
                                                    <span class="caption-subject font-blue-madison bold uppercase">Today's Action Items -</span><a href="https://interlinkiq.com/emp_filter.php" target="_blank">  <span class="task-title"> Inspection Schedules</span></a>
                                                </div>
                                                <div class="inputs">
                                            ...
                                            <?php
                                                $select_settings = "SELECT * FROM new_emp_equipment_frequency WHERE new_emp_equipment_frequency.equipment_id = 48";
                                                        ...
                                                        <ul class="task-list">
                                                            <li>
                                                                ...
                                                                <div class="task-title">
                                                                  <a href="#">  <span class="task-title-sp"> Setup Settings</span></a>
                                                                </div>
                                                            ...
                                                            <li>
                                                                ...
                                                                <div class="task-title">
                                                                  <a href="#"> <span class="task-title-sp"> Add Micro oraganism </span></a>
                                                                </div>
                                                                <div class="task-config">
                                                                    <div class="task-config-btn btn-group">
                                                                        <a class="btn btn-sm default" href="javascript:;" data-toggle="dropdown" data-hover="dropdown" data-close-others="true">
                                                            ...
                                                            <li>
                                                                <div class="task-checkbox">
                                                                    <input type="checkbox" class="liChild" value="" /> </div>
                                                                <div class="task-title">
                                                                   <a href="#"><span class="task-title-sp">Inspect Convayor Shield</span></a>
                                                                </div>
                                                                <div class="task-config">
                                                                    <div class="task-config-btn btn-group">
                                                                        <a class="btn btn-sm default" href="javascript:;" data-toggle="dropdown" data-hover="dropdown" data-close-others="true">
                                                            ...
                                                            <li>
                                                                ...
                                                                <div class="task-title">
                                                                    <a href="https://interlinkiq.com/emp_filter_details1.php?equip_id=48" target="_blank"><span class="task-title-sp">Door Exhaust Fan</span></a>
                                                                </div>
                                                                <div class="task-config">
                                                                    <div class="task-config-btn btn-group">
                                                                        <a class="btn btn-sm default" href="javascript:;" data-toggle="dropdown" data-hover="dropdown" data-close-others="true">
                            ...
                            <div class="row" style="margin-top:75px">
                                <div class="col-md-4">
                                    ...
                                    <select id="filter_zone" class="form-control">
                                        <?php
                                            $sql_zone = "SELECT * FROM new_emp_zones";
                                            $result_zone = mysqli_query($emp_connection, $sql_zone);
                                            foreach ($result_zone as $row_zone):
                                        ?>
                                            <option value="<?= $row_zone['id'] ?>"><?= $row_zone['zone_name'] ?></option>
                                        <?php endforeach; ?>
                                    </select>
                                </div>
                            </div>
