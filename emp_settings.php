                ...
                <div class="portlet-body">
                    ...
                    <div class="portlet-title tabbable-line" style="display:flex;justify-content:space-between">
                        <ul class="nav nav-tabs">
                            <!--Emjay starts here-->
                            <li>
                                <a href="#forms" data-toggle="tab">Settings - <button class="btn btn-primary" data-toggle="modal" data-target="#add_micro">Add Parameter</button> - <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#add_equipment">Add Equipment</button></a>
                            </li>
                        ...
                        <div class="row" style="margin-top:25px" id="micro_div">
                            <div class="col-md-12" style="padding:10px">
                                ...
                                <div id="data_container">
                                    <?php
                                        $select_registered = "SELECT * FROM equipment_reg WHERE location = '{$_GET['area_name']}' AND enterprise_owner = $switch_user_id AND deleted != 1";
                                                            ...
                                                            ?>
                                                                ...
                                                                <div class="row">
                                                                    <div class="col-md-6" style="margin-top:25px;border:solid 1px #999;padding:10px;min-height:300px ">
                                                                        ...
                                                                        <?php 
                                                                            $select_files = "SELECT * FROM new_emp_files WHERE equipment_id = {$registered_result_row['equip_id']}";
                                                                        ...
                                                                        <div class="md-checkbox-inline" style="padding: 15px; display: flow">
                                                                          ...
                                                                          <?php
                                                                          $i = 0;
                                                                          $check_sql = "SELECT * FROM new_emp_parameters WHERE owner_id = $switch_user_id ";
                                                                          $check_result = mysqli_query($emp_connection, $check_sql);
                                                                          
                                                                            $select_oum = "SELECT * FROM `new_emp_uom` WHERE owner_id = $switch_user_id";
...
function save_equipment() {
        ...
        formData.append('action', 'save_new_equipment_bgl');
