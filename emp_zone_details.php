                                                                     ...
                                                                     $equipment_row = mysqli_fetch_assoc($equipment_result);
                                                                        ...
                                                                        <div class="row">
                                                                            <div class="col-md-12">
                                                                                ...
                                                                                <div class="row">
                                                                                    <?php
                                                                                        $select_params = "SELECT * FROM new_emp_default INNER JOIN new_emp_parameters ON new_emp_parameters.id = new_emp_default.parameter_id WHERE new_emp_default.equipment_id = $equipmentId";
                                                                                        $param_results = mysqli_query($emp_connection,$select_params);
                                                                                        foreach($param_results as $param_row):
                                                                                            // Sample usage
                                                                                            $minimum_value = $param_row['minimum_value'];
                                                                                            $maximum_value = $param_row['maximum_value'];
                                                                                    ...
                                                                                    <div class="col-md-3">
                                                                                        ...
                                                                                        <div class="d-flex">
                                                                                            ...
                                                                                            <input type="text" class="form-control" value="<?= $param_row['oum']?>" style="width:120px" readonly>
                                                                                        </div>
                                                                                    </div>
                                                                                    <?php endforeach; ?>
                                                                                </div>
