    ...
    .mt-repeater .mt-repeater-item {
        ...
        padding-bottom: unset;
                    ...
                    <div class="row">
                                    ...
                                    <div class="tab-content">
                                        <select id='filterText' style='display:inline-block' onchange='filterText()'>
                                            ...
                                            <optgroup>
                                                ...
                                                <?php 
                                                    echo $_COOKIE['client'] == 1 ? '<option value=\'Part-Time\'>Part-Time</option><option value=\'Salaried\'>Salaried</option><option value=\'Seasonal\'>Seasonal</option>':'<option value=\'Part-Timer\'>Part-Timer</option>';
                                                ?>
                                                ...
                                                <table class="table table-bordered table-hover" id="tableData">
                                                    ...
                                                    <tbody>
                                                        <?php
                                                            ...
                                                            $result = mysqli_query( $conn,"SELECT * FROM tbl_hr_employee WHERE deleted = 0 AND ID <> 1240 AND ID <> 1241 AND ID <> 1399 AND suspended = 0 AND status = 1 AND user_id = $switch_user_id AND facility_switch = $facility_switch_user_id ORDER BY last_name " );
                                                            if ( mysqli_num_rows($result) > 0 ) {
                                                                ...
                                                                while($row = mysqli_fetch_array($result)) {
                                                                    ...
                                                                    echo  '
                                                                     <a href="#viewDetails" class="btn btn-outline dark btn-sm details-btn" data-id="'. $row["ID"].'" data-toggle="modal">Details</a>
                                                                    </td>
                                                                    </tr>';
                                                                }
                                                            } else {
                                        ...
                                        <div class="tab-pane" id="tab_actions_inactive">
                                            <div class="table-scrollable">
                                                <table class="table table-bordered table-hover" id="tableDataInactive">
                                                    ...
                                                    <tbody>
                                                        <?php
                                                            $result = mysqli_query( $conn,"SELECT * FROM tbl_hr_employee WHERE deleted = 0 AND status = 0 AND user_id = $switch_user_id AND facility_switch = $facility_switch_user_id ORDER BY last_name " );
                                                            if ( mysqli_num_rows($result) > 0 ) {
                                                                $table_counter = 1;
                                                                while($row = mysqli_fetch_array($result)) {
                                                                    $email = htmlentities($row["email"] ?? '');
                                        ...
                                        <div class="tab-pane" id="tab_actions_suspended">
                                            <div class="table-scrollable">
                                                <table class="table table-bordered table-hover" id="tableDataSuspended">
                                                    ...
                                                    <tbody>
                                                        <?php
                                                            $result = mysqli_query( $conn,"SELECT * FROM tbl_hr_employee WHERE deleted = 0 AND suspended = 1 AND user_id = $switch_user_id AND facility_switch = $facility_switch_user_id ORDER BY last_name " );
                                                            if ( mysqli_num_rows($result) > 0 ) {
                                                                $table_counter = 1;
                                                                while($row = mysqli_fetch_array($result)) {
                                                                    $email = htmlentities($row["email"] ?? '');
                                                        ...
                                                        <?php
                                                            echo '<tr>
                                                                ...
                                                                <td class="text-center">';
                                                                    ...
                                                                    $selectFTA = mysqli_query( $conn,"SELECT COUNT(ID) AS TOTAL_FTA FROM tbl_hr_employee WHERE deleted = 0 AND type_id = 1 AND status = 1 AND suspended = 0 AND user_id = $switch_user_id AND facility_switch = $facility_switch_user_id" );
                                                                ...
                                                                <td class="text-center">';
                                                                    ...
                                                                    $selectFTI = mysqli_query( $conn,"SELECT COUNT(ID) AS TOTAL_FTI FROM tbl_hr_employee WHERE deleted = 0 AND type_id = 1 AND status = 0 AND suspended = 0 AND user_id = $switch_user_id AND facility_switch = $facility_switch_user_id" );
                                                                ...
                                                                <td class="text-center">';
                                                                    ...
                                                                    $selectFTS = mysqli_query( $conn,"SELECT COUNT(ID) AS TOTAL_FTS FROM tbl_hr_employee WHERE deleted = 0 AND type_id = 1 AND suspended = 1 AND user_id = $switch_user_id AND facility_switch = $facility_switch_user_id" );
                                                            ...
                                                            <tr>';
                                                                echo $_COOKIE['client'] == 1 ? '<td>Part-Time</td>':'<td>Part-Timer</td>';
                                                                echo '<td class="text-center">';

                                                                    $selectPTA = mysqli_query( $conn,"SELECT COUNT(ID) AS TOTAL_PTA FROM tbl_hr_employee WHERE deleted = 0 AND type_id = 2 AND status = 1 AND suspended = 0 AND user_id = $switch_user_id AND facility_switch = $facility_switch_user_id" );
                                                                ...
                                                                <td class="text-center">';
                                                                    ...
                                                                    $selectPTI = mysqli_query( $conn,"SELECT COUNT(ID) AS TOTAL_PTI FROM tbl_hr_employee WHERE deleted = 0 AND type_id = 2 AND status = 0 AND suspended = 0 AND user_id = $switch_user_id AND facility_switch = $facility_switch_user_id" );
                                                                ...
                                                                <td class="text-center">';
                                                                    ...
                                                                    $selectPTS = mysqli_query( $conn,"SELECT COUNT(ID) AS TOTAL_PTS FROM tbl_hr_employee WHERE deleted = 0 AND type_id = 2 AND suspended = 1 AND user_id = $switch_user_id AND facility_switch = $facility_switch_user_id" );
                                                            ...
                                                            if ($current_client == 0) {
                                                                echo '<tr>
                                                                    ...
                                                                    <td class="text-center">';
                                                                            ...
                                                                            $selectOJTA = mysqli_query( $conn,"SELECT COUNT(ID) AS TOTAL_OJTA FROM tbl_hr_employee WHERE deleted = 0 AND type_id = 3 AND status = 1 AND suspended = 0 AND user_id = $switch_user_id AND facility_switch = $facility_switch_user_id" );
                                                                    ...
                                                                    <td class="text-center">';
                                                                            ...
                                                                            $selectOJTI = mysqli_query( $conn,"SELECT COUNT(ID) AS TOTAL_OJTI FROM tbl_hr_employee WHERE deleted = 0 AND type_id = 3 AND status = 0 AND suspended = 0 AND user_id = $switch_user_id AND facility_switch = $facility_switch_user_id" );
                                                                    ...
                                                                    <td class="text-center">';
                                                                            ...
                                                                            $selectOJTS = mysqli_query( $conn,"SELECT COUNT(ID) AS TOTAL_OJTS FROM tbl_hr_employee WHERE deleted = 0 AND type_id = 3 AND suspended = 1 AND user_id = $switch_user_id AND facility_switch = $facility_switch_user_id" );
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td class="text-center">';
                                                                            ...
                                                                            $selectFA = mysqli_query( $conn,"SELECT COUNT(ID) AS TOTAL_FA FROM tbl_hr_employee WHERE deleted = 0 AND type_id = 4 AND status = 1 AND suspended = 0 AND user_id = $switch_user_id AND facility_switch = $facility_switch_user_id" );
                                                                    ...
                                                                    <td class="text-center">';
                                                                            ...
                                                                            $selectFI = mysqli_query( $conn,"SELECT COUNT(ID) AS TOTAL_FI FROM tbl_hr_employee WHERE deleted = 0 AND type_id = 4 AND status = 0 AND suspended = 0 AND user_id = $switch_user_id AND facility_switch = $facility_switch_user_id" );
                                                                    ...
                                                                    <td class="text-center">';
                                                                            ...
                                                                            $selectFS = mysqli_query( $conn,"SELECT COUNT(ID) AS TOTAL_FS FROM tbl_hr_employee WHERE deleted = 0 AND type_id = 4 AND suspended = 1 AND user_id = $switch_user_id AND facility_switch = $facility_switch_user_id" );
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td class="text-center">';
                                                                            ...
                                                                            $selectIA = mysqli_query( $conn,"SELECT COUNT(ID) AS TOTAL_IA FROM tbl_hr_employee WHERE deleted = 0 AND type_id = 5 AND status = 1 AND suspended = 0 AND user_id = $switch_user_id AND facility_switch = $facility_switch_user_id" );
                                                                    ...
                                                                    <td class="text-center">';
                                                                            ...
                                                                            $selectII = mysqli_query( $conn,"SELECT COUNT(ID) AS TOTAL_II FROM tbl_hr_employee WHERE deleted = 0 AND type_id = 5 AND status = 0 AND suspended = 0 AND user_id = $switch_user_id AND facility_switch = $facility_switch_user_id" );
                                                                    ...
                                                                    <td class="text-center">';
                                                                            ...
                                                                            $selectIS = mysqli_query( $conn,"SELECT COUNT(ID) AS TOTAL_IS FROM tbl_hr_employee WHERE deleted = 0 AND type_id = 5 AND suspended = 1 AND user_id = $switch_user_id AND facility_switch = $facility_switch_user_id" );
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td class="text-center">';
                                                                            ...
                                                                            $selectIA = mysqli_query( $conn,"SELECT COUNT(ID) AS TOTAL_IA FROM tbl_hr_employee WHERE deleted = 0 AND type_id = 6 AND status = 1 AND suspended = 0 AND user_id = $switch_user_id AND facility_switch = $facility_switch_user_id" );
                                                                            $rowIA = mysqli_fetch_array($selectIA);
                                                                            echo htmlentities($rowIA["TOTAL_IA"] ?? '');
                                                                    ...
                                                                    <td class="text-center">';
                                                                            ...
                                                                            $selectII = mysqli_query( $conn,"SELECT COUNT(ID) AS TOTAL_II FROM tbl_hr_employee WHERE deleted = 0 AND type_id = 6 AND status = 0 AND suspended = 0 AND user_id = $switch_user_id AND facility_switch = $facility_switch_user_id" );
                                                                            $rowII = mysqli_fetch_array($selectII);
                                                                            echo htmlentities($rowII["TOTAL_II"] ?? '');
                                                                    ...
                                                                    <td class="text-center">';
                                                                            ...
                                                                            $selectIS = mysqli_query( $conn,"SELECT COUNT(ID) AS TOTAL_IS FROM tbl_hr_employee WHERE deleted = 0 AND type_id = 6 AND suspended = 1 AND user_id = $switch_user_id AND facility_switch = $facility_switch_user_id" );
                                                                            $rowIS = mysqli_fetch_array($selectIS);
                                                                            echo htmlentities($rowIS["TOTAL_IS"] ?? '');
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td class="text-center">';
                                                                            ...
                                                                            $selectIA = mysqli_query( $conn,"SELECT COUNT(ID) AS TOTAL_IA FROM tbl_hr_employee WHERE deleted = 0 AND type_id = 7 AND status = 1 AND suspended = 0 AND user_id = $switch_user_id AND facility_switch = $facility_switch_user_id" );
                                                                            $rowIA = mysqli_fetch_array($selectIA);
                                                                            echo htmlentities($rowIA["TOTAL_IA"] ?? '');
                                                                    ...
                                                                    <td class="text-center">';
                                                                            ...
                                                                            $selectII = mysqli_query( $conn,"SELECT COUNT(ID) AS TOTAL_II FROM tbl_hr_employee WHERE deleted = 0 AND type_id = 7 AND status = 0 AND suspended = 0 AND user_id = $switch_user_id AND facility_switch = $facility_switch_user_id" );
                                                                            $rowII = mysqli_fetch_array($selectII);
                                                                            echo htmlentities($rowII["TOTAL_II"] ?? '');
                                                                    ...
                                                                    <td class="text-center">';
                                                                            ...
                                                                            $selectIS = mysqli_query( $conn,"SELECT COUNT(ID) AS TOTAL_IS FROM tbl_hr_employee WHERE deleted = 0 AND type_id = 7 AND suspended = 1 AND user_id = $switch_user_id AND facility_switch = $facility_switch_user_id" );
                                                                            $rowIS = mysqli_fetch_array($selectIS);
                                                                            echo htmlentities($rowIS["TOTAL_IS"] ?? '');
                                                                ...
                                                                echo '<tr>
                                                                    ...
                                                                    <td class="text-center">';
                                                                            ...
                                                                            $selectOJTA = mysqli_query( $conn,"SELECT COUNT(ID) AS TOTAL_OJTA FROM tbl_hr_employee WHERE deleted = 0 AND type_id = 8 AND status = 1 AND suspended = 0 AND user_id = $switch_user_id AND facility_switch = $facility_switch_user_id" );
                                                                            $rowOJTA = mysqli_fetch_array($selectOJTA);
                                                                            echo htmlentities($rowOJTA["TOTAL_OJTA"] ?? '');
                                                                    ...
                                                                    <td class="text-center">';
                                                                            ...
                                                                            $selectOJTI = mysqli_query( $conn,"SELECT COUNT(ID) AS TOTAL_OJTI FROM tbl_hr_employee WHERE deleted = 0 AND type_id = 8 AND status = 0 AND suspended = 0 AND user_id = $switch_user_id AND facility_switch = $facility_switch_user_id" );
                                                                            $rowOJTI = mysqli_fetch_array($selectOJTI);
                                                                            echo htmlentities($rowOJTI["TOTAL_OJTI"] ?? '');
                                                                    ...
                                                                    <td class="text-center">';
                                                                            ...
                                                                            $selectOJTS = mysqli_query( $conn,"SELECT COUNT(ID) AS TOTAL_OJTS FROM tbl_hr_employee WHERE deleted = 0 AND type_id = 8 AND suspended = 1 AND user_id = $switch_user_id AND facility_switch = $facility_switch_user_id" );
                                                                            $rowOJTS = mysqli_fetch_array($selectOJTS);
                                                                            echo htmlentities($rowOJTS["TOTAL_OJTS"] ?? '');
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td class="text-center">';
                                                                            ...
                                                                            $selectFA = mysqli_query( $conn,"SELECT COUNT(ID) AS TOTAL_FA FROM tbl_hr_employee WHERE deleted = 0 AND type_id = 9 AND status = 1 AND suspended = 0 AND user_id = $switch_user_id AND facility_switch = $facility_switch_user_id" );
                                                                            $rowFA = mysqli_fetch_array($selectFA);
                                                                            echo htmlentities($rowFA["TOTAL_FA"] ?? '');
                                                                    ...
                                                                    <td class="text-center">';
                                                                            ...
                                                                            $selectFI = mysqli_query( $conn,"SELECT COUNT(ID) AS TOTAL_FI FROM tbl_hr_employee WHERE deleted = 0 AND type_id = 9 AND status = 0 AND suspended = 0 AND user_id = $switch_user_id AND facility_switch = $facility_switch_user_id" );
                                                                            $rowFI = mysqli_fetch_array($selectFI);
                                                                            echo htmlentities($rowFI["TOTAL_FI"] ?? '');
                                                                    ...
                                                                    <td class="text-center">';
                                                                            ...
                                                                            $selectFS = mysqli_query( $conn,"SELECT COUNT(ID) AS TOTAL_FS FROM tbl_hr_employee WHERE deleted = 0 AND type_id = 9 AND suspended = 1 AND user_id = $switch_user_id AND facility_switch = $facility_switch_user_id" );
                                                                            $rowFS = mysqli_fetch_array($selectFS);
                                                                            echo htmlentities($rowFS["TOTAL_FS"] ?? '');
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td class="text-center">';
                                                                            ...
                                                                            $selectIA = mysqli_query( $conn,"SELECT COUNT(ID) AS TOTAL_IA FROM tbl_hr_employee WHERE deleted = 0 AND type_id = 10 AND status = 1 AND suspended = 0 AND user_id = $switch_user_id AND facility_switch = $facility_switch_user_id" );
                                                                            $rowIA = mysqli_fetch_array($selectIA);
                                                                            echo htmlentities($rowIA["TOTAL_IA"] ?? '');
                                                                    ...
                                                                    <td class="text-center">';
                                                                            ...
                                                                            $selectII = mysqli_query( $conn,"SELECT COUNT(ID) AS TOTAL_II FROM tbl_hr_employee WHERE deleted = 0 AND type_id = 10 AND status = 0 AND suspended = 0 AND user_id = $switch_user_id AND facility_switch = $facility_switch_user_id" );
                                                                            $rowII = mysqli_fetch_array($selectII);
                                                                            echo htmlentities($rowII["TOTAL_II"] ?? '');
                                                                    ...
                                                                    <td class="text-center">';
                                                                            ...
                                                                            $selectIS = mysqli_query( $conn,"SELECT COUNT(ID) AS TOTAL_IS FROM tbl_hr_employee WHERE deleted = 0 AND type_id = 10 AND suspended = 1 AND user_id = $switch_user_id AND facility_switch = $facility_switch_user_id" );
                                                                            $rowIS = mysqli_fetch_array($selectIS);
                                                                            echo htmlentities($rowIS["TOTAL_IS"] ?? '');
                        ...
                        <!-- Modal -->
                        <div class="modal fade" id="viewDetails" tabindex="-1" role="basic" aria-hidden="true">
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    <div class="modal-body" style="background: #f5f6fa; color: #93a3b5">
                                        <div id="loading-indicator" style="display: flex; justify-content: center; align-items: center;">
                                            <div id="region_statistics_loading">
                                                <img src="../assets/global/img/loading.gif" alt="loading" />
                                            </div>
                                        </div>
                                        <div class="invoice-content-2" id="va-details">
                                            <div class="row invoice-head">
                                                <div class="col-md-12 col-xs-12" style="margin-bottom: 2rem;">
                                                    <div class="company-address bg-white" style="padding: 15px">
                                                        <span class="bold font-green-sharp uppercase">Basic Information</span>
                                                        <br><br> <span class="bold font-green-sharp icon-user"></span> &nbsp; Marvin Villasencio
                                                        <br>
                                                        <span class="bold font-green-sharp icon-call-end"></span> &nbsp; 1800 123 456
                                                        <br>
                                                        <span class="bold font-green-sharp icon-envelope"></span> &nbsp; marvin@consultareinc.com
                                                        <br>
                                                        <span class="bold font-green-sharp icon-pointer"></span> &nbsp; Don Benedicto St. Gun-ob Lapu-lapu City
                                                        Cebu Phillipines 6015
                                                    </div>
                                                </div>
                                        
                                                <div class="col-md-12 col-xs-12" style="margin-bottom: 2rem;">
                                                    <div class="company-address bg-white" style="padding: 15px">
                                                        <span class="bold font-green-sharp uppercase">Bank Details</span>
                                                        <br><br>
                                                        <span class="bold font-green-sharp icon-notebook"></span> &nbsp; LandBank of the Phillipines
                                                        <br>
                                                        <span class="bold font-green-sharp icon-user"></span> &nbsp; Marvin Villasencio
                                                        <br>
                                                        <span class="bold font-green-sharp icon-wallet"></span> &nbsp; 1356212386
                                                ...
                                                <div class="col-md-12 col-xs-12">
                                                    <div class="company-address bg-white" style="padding: 15px">
                                                        <span class="bold font-green-sharp uppercase">Emergency Contact</span>
                                                        <br><br><span class="bold font-green-sharp icon-user"></span> &nbsp; Mary Joy Lucero
                                                        <br>
                                                        <span class="bold font-green-sharp icon-pointer"></span> &nbsp; Don Benedicto St. Gun-ob Lapu-lapu City
                                                        Cebu Phillipines 6015
                                                        <br>
                                                        <span class="bold font-green-sharp  icon-call-end"></span> &nbsp; 09165662335
                                                        <br>
                                                        <span class="bold font-green-sharp icon-envelope"></span> &nbsp; archive.ejoy@gmail.com
                                                        <br>
                                                        <span class="bold font-green-sharp icon-users"></span> &nbsp; Partner
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <form method="post" class="form-horizontal modalForm surverFormModal">
                                        ...
                                        <div class="modal-body"> 
                                            ...
                                            <div class="form-group">
                                                <?php
                                                    $selectEmployee = mysqli_query( $conn,"SELECT ID, first_name, last_name FROM tbl_hr_employee WHERE deleted = 0 AND status = 1 AND user_id = $switch_user_id ORDER BY first_name ASC");
        ...
        <script type="text/javascript" src="alt-process/script/bank.js"></script>
        
        <!-- Marvin script starts here-->
        <!-- Marvin script ends here-->
