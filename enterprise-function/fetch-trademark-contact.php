<?php 
    ...
    if( isset($_GET['modalViewApp']) ) {
		...
		$selectData = mysqli_query( $conn,"SELECT * FROM tblEnterpiseDetails_Trademark WHERE ID = $ID" );
		if ( mysqli_num_rows($selectData) > 0 ) {
            ...
            <div class="row">
                <div class="form-group">
                    ...
                    <div class="col-md-12">
                        <input class="form-control" type="text" name="trademark_name" value="'. $row['trademark_name'] .'" required />
                    </div>
                </div>
            </div>
            <br>
            <div class="row">
                <div class="form-group">
                    ...
                    <div class="col-md-12">
                        <input class="form-control" type="text" name="trade_name" value="'. $row['trade_name'] .'"  required />
                    </div>
                </div>
            </div>
            <br>
