...
<?php 
 ...
 //Fetch data from database  company detail
$sql=mysqli_query($conn,"select * from tblEnterpiseDetails");
if (isset($_GET['id']) && isset($_GET['Headquarters'])) {  
      $id=$_GET['id'];  
      $Headquarters=$_GET['Headquarters'];  
      mysqli_query($conn,"update tblAuditDetails set Headquarters='$Headquarters' where enterp_id='$id'");  
      header("location:enterprise-information.php");  
      die();  
} 
                                        ...
                                        <div class="col-md-12" style="margin-top:-10px;">
                                            <div class="row">
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-4">
                                                       <form action="admin_2/enterprise-information-function.php" method="POST" enctype="multipart/form-data">
                                                             <div class="brandAv" style="background-image:url('admin_2/companyDetailsFolder/<?php echo $row['BrandLogos']; ?>">
                                        ...
                                        <div id="purpose">
                                                     ...
                                                     <table class="table table-bordered">
                                                         ...
                                                         <tbody>
                                                             <tr>
                                                                 ...
                                                                 <td><a href="admin_2/enterprise-details-download.php?pathSole=<?php echo $row['enterp_id']; ?>"><?php echo $row['SolePropreitorship_File']; ?></a></td>
                                                                <form action="admin_2/enterprise-information-function.php" method="POST" enctype="multipart/form-data">
                                                                     <td>
                                                             ...
                                                             <tr>
                                                                 ...
                                                                 <?php if($row['GeneralPartnership'] !=''): ?>
                                                                  <td><a href="admin_2/enterprise-details-download.php?pathGP=<?php echo $row['enterp_id']; ?>"><?php echo $row['GeneralPartnership_File']; ?></a></td>
                                                                <form action="admin_2/enterprise-information-function.php" method="POST" enctype="multipart/form-data">
                                                                     <td>
                                                                          <input type="hidden" name="ids" class="form-control" value="<?php echo $row['enterp_id']; ?>">
                                                              ...
                                                              <tr>
                                                                 ...
                                                                 <?php if($row['Corporation'] !=''): ?>
                                                                  <td><a href="admin_2/enterprise-details-download.php?pathCorp=<?php echo $row['enterp_id']; ?>"><?php echo $row['Corporation_File']; ?></a></td>
                                                                <form action="admin_2/enterprise-information-function.php" method="POST" enctype="multipart/form-data">
                                                                     <td>
                                                                          <input type="hidden" name="ids" class="form-control" value="<?php echo $row['enterp_id']; ?>">
                                                              ...
                                                              <tr> 
                                                                 ...
                                                                 <?php if($row['LimitedLiabilityCompany'] !=''): ?>
                                                                  <td><a href="admin_2/enterprise-details-download.php?pathLLC=<?php echo $row['enterp_id']; ?>"><?php echo $row['LimitedLiabilityCompany_File']; ?></a></td>
                                                                <form action="admin_2/enterprise-information-function.php" method="POST" enctype="multipart/form-data">
                                                                     <td>
                                                                          <input type="hidden" name="ids" class="form-control" value="<?php echo $row['enterp_id']; ?>">
                                                             ...
                                                             <tr>
                                                                 ...
                                                                 <?php if($row['LimitedPartnership'] !=''): ?>
                                                                  <td><a href="admin_2/enterprise-details-download.php?pathLP=<?php echo $row['enterp_id']; ?>"><?php echo $row['LimitedPartnership_File']; ?></a></td>
                                                                <form action="admin_2/enterprise-information-function.php" method="POST" enctype="multipart/form-data">
                                                                     <td>
                                                                          <input type="hidden" name="ids" class="form-control" value="<?php echo $row['enterp_id']; ?>">
                                                              ...
                                                              <tr>
                                                                <td>
                                                                 ...
                                                                 <?php if($row['LimitedLiabilityPartnership'] !=''): ?>
                                                                  <td><a href="admin_2/enterprise-details-download.php?pathLPP=<?php echo $row['enterp_id']; ?>"><?php echo $row['LimitedLiabilityPartnership_File']; ?></a></td>
                                                                <form action="admin_2/enterprise-information-function.php" method="POST" enctype="multipart/form-data">
                                                                     <td>
                                                                          <input type="hidden" name="ids" class="form-control" value="<?php echo $row['enterp_id']; ?>">
                                                              ...
                                                              <tr>
                                                                 ...
                                                                 <?php if($row['othersBusinessStructure'] !=''): ?>
                                                                  <td><a href="admin_2/enterprise-details-download.php?pathOBS=<?php echo $row['enterp_id']; ?>"><?php echo $row['otherbStructurefile']; ?></a></td>
                                                                <form action="admin_2/enterprise-information-function.php" method="POST" enctype="multipart/form-data">
                                                                     <td>
                                                                          <input type="hidden" name="ids" class="form-control" value="<?php echo $row['enterp_id']; ?>">
                                           ...
                                           <div id="trademark"></div>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-5">
                                                    <div class="form-group">
                                                        <label class="control-label"><strong>Supporting file:</strong> <a href="admin_2/enterprise-details-download.php?pathTN=<?php echo $row['enterp_id']; ?>"><?php echo $row['TrademarkNameFile']; ?></a></label>
                                                        <input type="hidden" name="ids" class="form-control" value="<?php echo $row['enterp_id']; ?>">
                                                     ...
                                                     <table class="table table-bordered">
                                                         ...
                                                         <tbody>
                                                             <tr>
                                                                ...
                                                                <?php if($row['GFSI'] !=''){ ?>
                                                                <td>
                                                                    <a href="admin_2/enterprise-details-download.php?pathCSP=<?php echo $row['enterp_id']; ?>"><?php echo $row['GFSIFILE']; ?></a>
                                                                </td>
                                                                <form action="admin_2/enterprise-information-function.php" method="POST" enctype="multipart/form-data">
                                                                     <td>
                                                                         <input type="hidden" name="ids" class="form-control" value="<?php echo $row['enterp_id']; ?>">
                                                             ...
                                                             <tr>
                                                                 ...
                                                                 <?php if($row['SQF'] !=''){ ?>
                                                                <td>
                                                                    <a href="admin_2/enterprise-details-download.php?pathSQF=<?php echo $row['enterp_id']; ?>"><?php echo $row['SQFFILE']; ?></a>
                                                                </td>
                                                                <form action="admin_2/enterprise-information-function.php" method="POST" enctype="multipart/form-data">
                                                                     <td>
                                                                         <input type="hidden" name="ids" class="form-control" value="<?php echo $row['enterp_id']; ?>">
                                                              ...
                                                              <tr>
                                                                 ...
                                                                 <?php if($row['BRC'] !=''){ ?>
                                                                    <td>
                                                                        <a href="admin_2/enterprise-details-download.php?pathBRC=<?php echo $row['enterp_id']; ?>"><?php echo $row['BRCFILE']; ?></a>
                                                                    </td>
                                                                    <form action="admin_2/enterprise-information-function.php" method="POST" enctype="multipart/form-data">
                                                                         <td>
                                                                             <input type="hidden" name="ids" class="form-control" value="<?php echo $row['enterp_id']; ?>">
                                                              ...
                                                              <tr>
                                                                ...
                                                                <?php if($row['FSSC22000'] !=''){ ?>
                                                                    <td>
                                                                        <a href="admin_2/enterprise-details-download.php?pathFSSC=<?php echo $row['enterp_id']; ?>"><?php echo $row['FSSC22000FILE']; ?></a>
                                                                    </td>
                                                                    <form action="admin_2/enterprise-information-function.php" method="POST" enctype="multipart/form-data">
                                                                         <td>
                                                                             <input type="hidden" name="ids" class="form-control" value="<?php echo $row['enterp_id']; ?>">
                                                            ...
                                                            <?php } ?>
                                                             ...
                                                             <tr>
                                                                ...
                                                                <?php if($row['ISO'] !=''){ ?>
                                                                    <td>
                                                                        <a href="admin_2/enterprise-details-download.php?pathISO=<?php echo $row['enterp_id']; ?>"><?php echo $row['ISOFILE']; ?></a>
                                                                    </td>
                                                                    <form action="admin_2/enterprise-information-function.php" method="POST" enctype="multipart/form-data">
                                                                         <td>
                                                                             <input type="hidden" name="ids" class="form-control" value="<?php echo $row['enterp_id']; ?>">
                                                            ...
                                                            <?php } ?>
                                                              ...
                                                              <tr>
                                                                 ...
                                                                 <?php if($row['PrimusGFS'] !=''){ ?>
                                                                    <td>
                                                                        <a href="admin_2/enterprise-details-download.php?pathHACCP=<?php echo $row['enterp_id']; ?>"><?php echo $row['PrimusGFSFILE']; ?></a>
                                                                    </td>
                                                                    <form action="admin_2/enterprise-information-function.php" method="POST" enctype="multipart/form-data">
                                                                         <td>
                                                                             <input type="hidden" name="ids" class="form-control" value="<?php echo $row['enterp_id']; ?>">
                                                              ...
                                                              <tr>
                                                                 ...
                                                                 <?php if($row['HACCP'] !=''){ ?>
                                                                    <td>
                                                                        <a href="admin_2/enterprise-details-download.php?pathHACCP=<?php echo $row['enterp_id']; ?>"><?php echo $row['HACCPFILE']; ?></a>
                                                                    </td>
                                                                    <form action="admin_2/enterprise-information-function.php" method="POST" enctype="multipart/form-data">
                                                                         <td>
                                                                             <input type="hidden" name="ids" class="form-control" value="<?php echo $row['enterp_id']; ?>">
                                                              ...
                                                              <tr>
                                                                 <td>
                                                                  ...
                                                                  <?php if($row['GMP'] !=''){ ?>
                                                                    <td>
                                                                        <a href="admin_2/enterprise-details-download.php?pathGMP=<?php echo $row['enterp_id']; ?>"><?php echo $row['GMPFILE']; ?></a>
                                                                    </td>
                                                                    <form action="admin_2/enterprise-information-function.php" method="POST" enctype="multipart/form-data">
                                                                         <td>
                                                                             <input type="hidden" name="ids" class="form-control" value="<?php echo $row['enterp_id']; ?>">
                                                              ...
                                                              <tr>
                                                                 ...
                                                                 <?php if($row['CertificationOthers'] !=''){ ?>
                                                                    <td>
                                                                        <a href="admin_2/enterprise-details-download.php?pathcOther=<?php echo $row['enterp_id']; ?>"><?php echo $row['OthersFILE']; ?></a>
                                                                    </td>
                                                                    <form action="admin_2/enterprise-information-function.php" method="POST" enctype="multipart/form-data">
                                                                         <td>
                                                                             <input type="hidden" name="ids" class="form-control" value="<?php echo $row['enterp_id']; ?>">
                                            ...
                                            <div id="FacilityAccreditation"></div>
                                                     ...
                                                     <table class="table table-bordered">
                                                         ...
                                                         <tbody>
                                                             <tr>
                                                                 ...
                                                                 <?php if($row['Organic'] !=''){ ?>
                                                                    <td>
                                                                        <a href="admin_2/enterprise-details-download.php?pathOrganic=<?php echo $row['enterp_id']; ?>"><?php echo $row['OrganicFile']; ?></a>
                                                                    </td>
                                                                    <form action="admin_2/enterprise-information-function.php" method="POST" enctype="multipart/form-data">
                                                                         <td>
                                                                             <input type="hidden" name="ids" class="form-control" value="<?php echo $row['enterp_id']; ?>">
                                                             ...
                                                             <tr>
                                                                 ...
                                                                 <?php if($row['Halal'] !=''){ ?>
                                                                    <td>
                                                                        <a href="admin_2/enterprise-details-download.php?pathHalal=<?php echo $row['enterp_id']; ?>"><?php echo $row['HalalFile']; ?></a>
                                                                    </td>
                                                                    <form action="admin_2/enterprise-information-function.php" method="POST" enctype="multipart/form-data">
                                                                         <td>
                                                                             <input type="hidden" name="ids" class="form-control" value="<?php echo $row['enterp_id']; ?>">
                                                              ...
                                                              <tr>
                                                                 ...
                                                                 <?php if($row['Kosher'] !=''){ ?>
                                                                    <td>
                                                                        <a href="admin_2/enterprise-details-download.php?pathKosher=<?php echo $row['enterp_id']; ?>"><?php echo $row['KosherFile']; ?></a>
                                                                    </td>
                                                                    <form action="admin_2/enterprise-information-function.php" method="POST" enctype="multipart/form-data">
                                                                         <td>
                                                                             <input type="hidden" name="ids" class="form-control" value="<?php echo $row['enterp_id']; ?>">
                                                              ...
                                                              <tr>
                                                                 ...
                                                                 <?php if($row['NonGMO'] !=''){ ?>
                                                                  ...
                                                                  <?php if($row['NonGMO'] !=''){ ?>
                                                                    <td>
                                                                        <a href="admin_2/enterprise-details-download.php?pathNonGMO=<?php echo $row['enterp_id']; ?>"><?php echo $row['NonGMOFile']; ?></a>
                                                                    </td>
                                                                    <form action="admin_2/enterprise-information-function.php" method="POST" enctype="multipart/form-data">
                                                                         <td>
                                                                             <input type="hidden" name="ids" class="form-control" value="<?php echo $row['enterp_id']; ?>">
                                                             ...
                                                             <tr>
                                                                 ...
                                                                 <?php if($row['PlantBased'] !=''){ ?>
                                                                    <td>
                                                                        <a href="admin_2/enterprise-details-download.php?pathPlantBased=<?php echo $row['enterp_id']; ?>"><?php echo $row['PlantBasedFile']; ?></a>
                                                                    </td>
                                                                    <form action="admin_2/enterprise-information-function.php" method="POST" enctype="multipart/form-data">
                                                                         <td>
                                                                             <input type="hidden" name="ids" class="form-control" value="<?php echo $row['enterp_id']; ?>">
                                                              ...
                                                              <tr>
                                                                 ...
                                                                 <?php if($row['FacilityAccreditationOthers'] !=''){ ?>
                                                                    <td>
                                                                        <a href="admin_2/enterprise-details-download.php?pathFAO=<?php echo $row['enterp_id']; ?>"><?php echo $row['othersAccreditationFile']; ?></a>
                                                                    </td>
                                                                    <form action="admin_2/enterprise-information-function.php" method="POST" enctype="multipart/form-data">
                                                                         <td>
                                                                             <input type="hidden" name="ids" class="form-control" value="<?php echo $row['enterp_id']; ?>">
                                                     ...
                                                     <table class="table table-bordered">
                                                         ...
                                                         <tbody>
                                                             <tr>
                                                                 ...
                                                                 <?php if($row['FDA'] !=''){ ?>
                                                                    <td>
                                                                        <a href="admin_2/enterprise-details-download.php?pathFDA=<?php echo $row['enterp_id']; ?>"><?php echo $row['FDAfile']; ?></a>
                                                                    </td>
                                                                    <form action="admin_2/enterprise-information-function.php" method="POST" enctype="multipart/form-data">
                                                                         <td>
                                                                             <input type="hidden" name="ids" class="form-control" value="<?php echo $row['enterp_id']; ?>">
                                                             ...
                                                             <tr>
                                                                 <td>
                                                                  ...
                                                                  <?php if($row['USDA'] !=''){ ?>
                                                                    <td>
                                                                        <a href="admin_2/enterprise-details-download.php?pathUSDA=<?php echo $row['enterp_id']; ?>"><?php echo $row['USDAfile']; ?></a>
                                                                    </td>
                                                                    <form action="admin_2/enterprise-information-function.php" method="POST" enctype="multipart/form-data">
                                                                         <td>
                                                                             <input type="hidden" name="ids" class="form-control" value="<?php echo $row['enterp_id']; ?>">
                                                              ...
                                                              <tr>
                                                                 ...
                                                                 <?php if($row['ComplianceRequirementsOthers'] !=''){ ?>
                                                                    <td>
                                                                        <a href="admin_2/enterprise-details-download.php?pathCRO=<?php echo $row['enterp_id']; ?>"><?php echo $row['ComplianceRequirementsfile']; ?></a>
                                                                    </td>
                                                                    <form action="admin_2/enterprise-information-function.php" method="POST" enctype="multipart/form-data">
                                                                         <td>
                                                                             <input type="hidden" name="ids" class="form-control" value="<?php echo $row['enterp_id']; ?>">
                                             ...
                                             <div class="row">
                                                 <div>
                                                     <table class="table table-bordered">
                                                         <thead>
                                                             <tr>
                                                                 <td>Document &nbsp; <a href="admin_2/enterprise-details-download.php?pathERF=<?php echo $row['enterp_id']; ?>"><?php echo $row['EnterpriseRecordsFile']; ?></a></td>
                                                                 <td></td>
                                                                 <td>Title </td>
                                                                 <td>Description </td>
                                            ...
                                            <div class="row">
                                                <div class="form-group">
                                                    <div class="col-md-6">
                                                        <label class="control-label"><strong>Legal Name:<i style="color:orange;" title="This input box is required!!!">*</i></strong></label>
                                                            <input type="hidden" class="form-control" name="ids" value="<?php if($users == $row['users_entities']){ echo $row['enterp_id'];}else{ echo '';} ?>" required> 
                                                            <input type="" class="form-control" name="LegalNameNew" id="LegalNameUpdate" value="<?php echo $row['businessname']; ?>" onchange="LegalNameNew(this.value,'<?php echo $row['enterp_id']; ?>')"> 
                                                    </div>
                                                    <div class="col-md-3">
                                                    </div>
                                                    <div class="col-md-3">
                                            ...
                                            <div class="row">
                                                <div class="form-group">
                                                    <div class="col-md-6">
                                                        <label class="control-label"><strong>Country:<i style="color:orange;" title="This input box is required!!!">*</i></strong></label>
                                                        <!--<input class=" form-control" name="businessaddress" value="<?php echo $row['businessaddress']; ?>" required>-->
                                                        <select class="form-control" name="country" onchange="country(this.options[this.selectedIndex].value,'<?php echo $row['enterp_id']; ?>')" disabled>
                                                            <option value="0">---Select---</option>
                                            ...
                                            <?php if($row['country'] != '0'): ?>
                                             ...
                                             <div class="row">
                                                 ...
                                                 <table class="table table-bordered">
                                                     ...
                                                     <tbody>
                                                         <tr>
                                                             <td><input class=" form-control" name="Bldg" value="<?php echo $row['Bldg']; ?>" onchange="Bldg(this.value,'<?php echo $row['enterp_id']; ?>')" disabled></td>
                                                              <td>
                                                                 <select class="form-control" name="city" onchange="city(this.options[this.selectedIndex].value,'<?php echo $row['enterp_id']; ?>')" disabled>
                                                                    <option >---Select---</option>
                                                                    <?php 
                                                                     // for display states
                                                                    $States = $row['States'];
                                                              ...
                                                              <td>
                                                                 <select class="form-control" name="States" onchange="States(this.options[this.selectedIndex].value,'<?php echo $row['enterp_id']; ?>')" disabled>
                                                                    <option >---Select---</option>
                                                                    <?php 
                                                                     // for display states
                                                                    $country = $row['country'];
                                                             ...
                                                             <td><input class=" form-control" name="ZipCode" value="<?php echo $row['ZipCode']; ?>" onchange="ZipCode(this.value,'<?php echo $row['enterp_id']; ?>')" disabled></td>
                                                         </tr>
                                                     </tbody>
                                                 </table>
                                             ...
                                             <div class="row">
                                                 <table class="table table-bordered">
                                                     ...
                                                     <tbody>
                                                         <tr>
                                                             <td><input type="number" min="6" class=" form-control" name="businesstelephone" value="<?php echo $row['businesstelephone']; ?>"  onchange="businesstelephone(this.value,'<?php echo $row['enterp_id']; ?>')" disabled></td>
                                                             <td><input type="number" class=" form-control" name="businessfax" value="<?php echo $row['businessfax']; ?>" onchange="businessfax(this.value,'<?php echo $row['enterp_id']; ?>')" disabled></td>
                                                             <td><input type="email" class=" form-control" name="businessemailAddress" value="<?php echo $row['businessemailAddress']; ?>" onchange="businessemailAddress(this.value,'<?php echo $row['enterp_id']; ?>')" disabled></td>
                                                             <td><input type="url" class=" form-control" name="businesswebsite" value="<?php echo $row['businesswebsite']; ?>" onchange="businesswebsite(this.value,'<?php echo $row['enterp_id']; ?>')" disabled></td>
                                                         </tr>
                                                     </tbody>
                                                 </table>
                                                ...
                                                <table class="table table-bordered">
                                                    ...
                                                    <tbody>
                                                        <tr>
                                                            ...
                                                            <td> <input type="number" class=" form-control" name="contactpersoncellno" value="<?php echo $row['contactpersoncellno']; ?>" onchange="contactpersoncellno(this.value,'<?php echo $row['enterp_id']; ?>')" disabled> </td>
                                                            <td> <input type="number" class=" form-control" name="contactpersonphone" value="<?php echo $row['contactpersonphone']; ?>" onchange="contactpersonphone(this.value,'<?php echo $row['enterp_id']; ?>')" disabled> </td>
                                                            <td> <input class=" form-control" name="contactpersonfax" value="<?php echo $row['contactpersonfax']; ?>" onchange="contactpersonfax(this.value,'<?php echo $row['enterp_id']; ?>')" disabled> </td>
                                                            <td> <input class=" form-control" name="contactpersonemailAddress" value="<?php echo $row['contactpersonemailAddress']; ?>" onchange="contactpersonemailAddress(this.value,'<?php echo $row['enterp_id']; ?>')" disabled> </td>
                                                        </tr>
                                                    </tbody>
                                                </table>
                                            </div>
                                                 ...
                                                 <table class="table table-bordered">
                                                    ...
                                                    <tbody>
                                                        <tr>
                                                            ...
                                                            <td> <input class=" form-control" name="emergencycellno" value="<?php echo $row['emergencycellno']; ?>" onchange="emergencycellno(this.value,'<?php echo $row['enterp_id']; ?>')" disabled> </td>
                                                            <td> <input class=" form-control" name="emergencyphone" value="<?php echo $row['emergencyphone']; ?>" onchange="emergencyphone(this.value,'<?php echo $row['enterp_id']; ?>')" disabled> </td>
                                                            <td> <input class=" form-control" name="emergencyfax" value="<?php echo $row['emergencyfax']; ?>" onchange="emergencyfax(this.value,'<?php echo $row['enterp_id']; ?>')" disabled> </td>
                                                            <td> <input class=" form-control" name="emergencyemailAddress" value="<?php echo $row['emergencyemailAddress']; ?>" onchange="emergencyemailAddress(this.value,'<?php echo $row['enterp_id']; ?>')" disabled> </td>
                                                        </tr>
                                                    </tbody>
                                                </table>
        ...
        <script>
         ...
         // for New
          function LegalNameNew(value){  
              let url = "admin_2/enterprise-information-function";  
