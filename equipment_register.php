<?php 
    $title = "Equipment Calibration List";
    $site = "equipment_register.php";
    $breadcrumbs = '';
    $sub_breadcrumbs = 'Equipment Calibration List';
...
<script src="https://cdn.jsdelivr.net/npm/sweetalert2@11"></script>
                                    ...
                                    <div class="tab-content">
                                            ...
                                            <table class="table table-bordered">
                                                ...
                                                <tbody>
                                                    <?php
                                                        ...
                                                        $get= mysqli_query($pmp_connection,"SELECT * FROM area_list_glp WHERE deleted = 0 AND area_list_glp.enterprise_owner = $switch_user_id");
                                                        if($get){
                                        ...
                                        <div class="tab-pane" id="equipment_register">
                                            ...
                                            <table class="table table-bordered" id="sample_1">
                                                ...
                                                <tbody>
                                                    <?php
                                                        $get= mysqli_query($pmp_connection,"SELECT * FROM equipment_reg_glp WHERE deleted = 0 AND enterprise_owner = $switch_user_id ");
                                        ...
                                        <div class="tab-pane mt-5" id="parts_register">
                                            ...
                                            <table class="table table-bordered" id="sample_4">
                                                ...
                                                <tbody>
                                                    <?php
                                                        $get= mysqli_query($pmp_connection,"SELECT * FROM equipment_parts_glp WHERE deleted = 0 AND enterprise_owner = $switch_user_id");
                                                        while($row=mysqli_fetch_array($get)) {
                                                            echo '<tr>
                                        ...
                                        <div class="tab-pane  mt-5" id="maintenance_checklist">
                                            ...
                                            <table class="table table-bordered" id="sample_2">
                                                ...
                                                <tbody>
                                                    <?php
                                                        $get= mysqli_query($pmp_connection,"SELECT * FROM parts_maintainance_glp 
                                                        INNER JOIN equipment_reg_glp ON parts_maintainance_glp.equipment_PK_id = equipment_reg_glp.equip_id
                                                        INNER JOIN equipment_parts_glp ON parts_maintainance_glp.equipment_parts_PK_id = equipment_parts_glp.equipment_parts_id
                                                        WHERE equipment_reg_glp.enterprise_owner = $switch_user_id");
        ...
        <div class="modal fade" id="addmodal" tabindex="-1" aria-labelledby="EquipmentDetails" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered modal-lg">
                <div class="modal-content bg-info">
                    ...
                    <!--Code Here-->
                    <form action="controller.php" method="post" id="save_equipment_glp" enctype="multipart/form-data">
                        <script>
                        ...
                        <div id="add-modal-body" class="modal-body bg-white">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <select name="location" class="form-control"  >
                                            <?php
                                                $get= mysqli_query($pmp_connection,"SELECT * FROM area_list_glp WHERE enterprise_owner = $switch_user_id");
                                                while($row=mysqli_fetch_array($get)) {
                            ...
                            <div class="col-md-6">
                                <label>Equipment Certifate</label>
                                <input type="file" name="equipment_certificate" class="form-control">
                            </div>
                            <div class="col-md-6">
                                <label>Procedure</label>
                                <input type="file" name="procedure" class="form-control">
                            </div>
                            <div class="col-md-6" style="margin-top:15px">
                                <label>Equipment Manual</label>
                                <input type="file" name="equipment_manual" class="form-control">
                            </div>
        ...
        <div class="modal fade" id="add_parts" tabindex="-1" aria-labelledby="EquipmentDetails" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered modal-lg">
                <div class="modal-content bg-info">
                    ...
                    <!--Code Here-->
                    <form action="controller.php" method="post" id="save_equipment_parts_glp_form" enctype="multipart/form-data">
                        <script>
                            $(document).ready(function() {
                                var i = 1;
                                $('#add1').click(function(){  
                        ...
                        <div class="modal-footer bg-white">
                            <button type="button" class="btn btn-light shadow-none" data-dismiss="modal">Close</button>
                            <button type="button" class="btn btn-info shadow-none" id="save_equipment_parts_glp_btn" name="save_equipment_parts_glp">Save</button>
                        </div>
                    </form>
                </div>
            </div>
                        ...
                        <div id="add-modal-body" class="modal-body bg-white">
                            ...
                            <div class="form-group">
                                ...
                                <select name="equipment_PK_id" id="select_parts" class="custom-select form-control" required >
                                    ...
                                    <?php
                                        $get_equip=mysqli_query($pmp_connection,"SELECT * FROM equipment_reg_glp WHERE enterprise_owner = $switch_user_id");
            ...
            <div class="modal fade" id="add_area" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                <div class="modal-dialog  modal-lg" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-footer">
                            <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
                            <button type="submit" id="save_area_glp" class="btn btn-primary" name="save_area_glp">Save</button>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <script>
            $(document).ready(function(){
                ...
                $('#save_equipment_parts_glp').click(function(e){
                   e.preventDefault(); 
                ...
                $('#submit_equipments').click(function(e) {
                    ...
                    // Serialize form data
                    var formData = new FormData($('#save_equipment_glp')[0]);
                    formData.append('submit_equipments_glp', '1'); // Add the form submission key dynamically
                ...
                $('#save_maintainance').click(function(e) {
                    ...
                    formData.append('save_maintainance_glp', '1'); // Add the form submission key dynamically
                ...
                $('#save_equipment_parts_glp_btn').click(function(e) {
                    e.preventDefault(); // Prevent the default button click behavior
                        
                    // Serialize form data
                    var formData = new FormData($('#save_equipment_parts_glp_form')[0]);
                    formData.append('save_equipment_parts_glp', '1'); // Add the form submission key dynamically
                ...
                $(document).on('change','#equipment_parts',function(){
                    ...
                    var action = "get_parts_checklist_glp";
                ...
                $(document).on('change','#select_parts',function(){
                    ...
                    var action = "get_equipment_parts_glp";
            ...
            function btnDelete_EP(id, e) {
                swal({
                    ...
                    $.ajax({
                        type: "GET",
                        url: "controller.php?pmp_ep_del_glp="+id,
                        dataType: "html",
                        success: function(response){
                            $(e).parent().parent().remove();
                        }
