<?php 
    ...
    if( isset($_GET['modalViewApp']) ) {
    		...
    		$selectData = mysqli_query( $conn,"SELECT * FROM tblFacilityDetails_Emergency WHERE emerg_id = $id" );
    		if ( mysqli_num_rows($selectData) > 0 ) {
                $row = mysqli_fetch_array($selectData);
            }
    
    		echo '
    		<input class="form-control" type="hidden" name="ID" value="'. $row['emerg_id'] .'" />
             <div class="row">
