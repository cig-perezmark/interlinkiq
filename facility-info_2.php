                                                ...
                                                <div class="tab-content">
                                                   ...
                                                   <div class="tab-pane active" id="EI">
                                                    ...
                                                    <div class="tab-pane" id="ro">
                                                        <h4><strong>Regulatory Compliance Requirements</strong>&nbsp;<a data-toggle="modal" href="#addFacility_registration" class="btn btn-xs btn-primary"><i class="fa fa-plus"></i>&nbsp;ADD</a></h4>
                                                            ...
                                                            <div class="table-scrollable">
                                                                <table class="table table-bordered">
                                                                    ...
                                                                    <tbody id="data_registration">
                                                                         <?php 
                                                                        $usersQuery = $_COOKIE['ID'];
                                                                        $query_reg = mysqli_query($conn, "SELECT * FROM tblFacilityDetails_registration where ownedby = $switch_user_id and table_entities = 2");
                                                            ...
                                                            <div class="table-scrollable" style="border:none;">
                                                                <div class="col-md-12">
                                                                    <table class="table table-bordered">
                                                                        ...
                                                                        <tbody id="data_cst">
                                                                            <?php 
                                                                            $query_cst = mysqli_query($conn, "select * from tblFacilityDetails_community where enterprise_pk = $switch_user_id");
                                                        ...
                                                        <div class="row">
                                                            <div class="col-md-12">
                                                                ...
                                                                <table class="table table-bordered">
                                                                    ...
                                                                    <tbody id="data_diagram">
                                                                        <?php
                                                                             $query_pm = mysqli_query($conn, "select * from tblFacilityDetails_Diagram where enterprise_pk = $switch_user_id");
                                                            ...
                                                            <div class="col-md-12">
                                                                ...
                                                                <table class="table table-bordered">
                                                                    ...
                                                                    <tbody id="data_plan">
                                                                        <?php
                                                                             $query_plan = mysqli_query($conn, "select * from tblFacilityDetails_Plan where enterprise_pk = $switch_user_id");
                                                        ...
                                                        <div class="row">
                                                            <div class="col-md-12">
                                                                ...
                                                                <table class="table table-bordered">
                                                                    ...
                                                                    <tbody id="data_ib">
                                                                        <?php
                                                                             $query_ib = mysqli_query($conn, "select * from tblFacilityDetails_Bond where enterprise_pk = $switch_user_id");
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    <form method="post" class="form-horizontal modalForm modal_update_bond">
                        ...
                        <div class="modal-footer" style="margin-top:10px;">
                            <input type="submit" name="btnSave_insurance" id="btnSave_insurance" value="Save" class="btn btn-info">
                        </div>
                    </form>
                </div>
            </div>
...
$(document).on('click', '#update_bond', function(){
    ...
    $.ajax({
        type: "GET",
        url: "facility-function/function.php?get_insurance_id="+id,
        dataType: "html",
        success: function(data){
...
$(".modal_update_bond").on('submit',(function(e) {
    ...
    var formData = new FormData(this);
    formData.append('btnSave_insurance',true);

    var l = Ladda.create(document.querySelector('#btnSave_insurance'));
    l.start();
