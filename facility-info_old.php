...
?>
                                                ...
                                                <div class="caption caption-md">
                                                 ...
                                                 <ul class="nav nav-tabs">
                                                    <li class="active">
                                                     ...
                                                     <li>
                                                        <a href="#ro" data-toggle="tab"> <?php if($_COOKIE['client'] == 1 ){ echo 'Regulatory';}else{echo 'Registration / Organization';} ?></a>
                                                    </li>
                                                    <li>
                                                ...
                                                <div class="tab-content">
                                                   ...
                                                   <div class="tab-pane active" id="EI">
                                                        ...
                                                        <div class="row">
                                                            <table class="table">
                                                                ...
                                                                <?php 
                                                                            ...
                                                                            $queries = "SELECT * FROM tblFacilityDetails_contact where user_cookies = $usersQuery and facility_entities = $facility_id ";
                                                                ...
                                                                <thead style="border-bottom:solid #003865 2px;">
                                                                    <tr>
                                                                        ...
                                                                        <?php 
                                                                            ...
                                                                            $usersQuery = $switch_user_id;
                                                                            $facility_id = $_GET['facility_id'];
                                                                            $queries = "SELECT * FROM tblFacilityDetails_Emergency where user_cookies = $usersQuery and emergency_contact_entities = $facility_id";
                                                                            $resultQuery = mysqli_query($conn, $queries);
                                                    ...
                                                    <div class="tab-pane" id="ro">
                                                        <h4><strong>Facility Registration Number</strong></h4>
                                                         <?php 
                                                            // $usersQuery = $_COOKIE['ID'];
                                                            $usersQuery = $switch_user_id;
                                                            $facility_id = $_GET['facility_id'];
                                                            $queries = "SELECT * FROM tblFacilityDetails_Registration_Organization_FDA where user_entities = $usersQuery and facility_entities = $facility_id  order by Reg_Org_id desc LIMIT 1";
                                                            $resultQuery = mysqli_query($conn, $queries);
                                                            $rowfda = mysqli_fetch_array($resultQuery);
                                                            if(!empty($rowfda['user_entities'])){
                                                            ?>
                                                        <div class="row">
                                                        ...
                                                        <form action="facility-function/add-contact-function.php" method="POST" enctype="multipart/form-data">
                                                            ...
                                                            <div class="col-md-3">
                                                                <label>FDA</label>
                                                                <input type="hidden" class="form-control" name="ids" value="<?php if($users == $row['users_entities']){ echo $row['facility_id'];}else{ echo '';} ?>" required> 
                                                                <select class="form-control" name="Reg_Org_Certificate_name_FDA">
                                                                    <option value="No" <?php  if($rowfda['Reg_Org_Certificate_name_FDA']=='No'){echo 'selected';}else{echo '';} ?>>No</option>
                                                                    <option value="Yes" <?php  if($rowfda['Reg_Org_Certificate_name_FDA']=='Yes'){echo 'selected';}else{echo '';} ?>>Yes</option>
                                                                </select>
                                                            </div>
                                                            <div class="col-md-3">
                                                                <label>Supporting file: &nbsp;<a href="facility-function/facility-download-functions.php?FDA_files=<?php echo $rowfda['Reg_Org_id']; ?>"><?php echo $rowfda['Reg_Org_Supporting_files_FDA']; ?></a></label>
                                                                <input type="file" class="form-control" name="Reg_Org_Supporting_files_FDA">
                                                            </div>
                                                            <div class="col-md-2">
                                                                <label>Registration Date</label>
                                                                <input type="date" class="form-control" name="Reg_Org_Registration_Date_FDA" value="<?php echo  date("Y-m-d", strtotime($rowfda['Reg_Org_Registration_Date_FDA']));?>"> 
                                                            </div>
                                                            <div class="col-md-2">
                                                                <label>Expiry Date</label>
                                                                <input type="date" class="form-control" name="Reg_Org_Expiry_Date_FDA" value="<?php echo  date("Y-m-d", strtotime($rowfda['Reg_Org_Expiry_Date_FDA']));?>">
                                                            </div>
                                                            <div class="col-md-2">
                                                                <label style="color:transparent">...</label>
                                                                <input type="submit" class="btn btn-success form-control" name="btnRegistration_Organization_FDA" value="Save"> 
                                                            </div>
                                                            </form>
                                                            </div>
                                                            <?php }else{  ?>
                                                            <div class="row">
                                                                <form action="facility-function/add-contact-function.php" method="POST" enctype="multipart/form-data">
                                                                    ...
                                                                    <div class="col-md-3">
                                                                        ...
                                                                        <input type="file" class="form-control" name="Reg_Org_Supporting_files_FDA" required>
                                                                    </div>
                                                                    <div class="col-md-2">
                                                                        <label>Registration Date</label>
                                                                        <input type="date" class="form-control" name="Reg_Org_Registration_Date_FDA" required> 
                                                                    </div>
                                                                    <div class="col-md-2">
                                                                        <label>Expiry Date</label>
                                                                        <input type="date" class="form-control" name="Reg_Org_Expiry_Date_FDA" required>
                                                                    </div>
                                                                    <div class="col-md-2">
                                                                        <label style="color:transparent">...</label>
                                                                        <input type="submit" class="btn btn-success form-control" name="btnRegistration_Organization_FDA" value="Save"> 
                                                        ...
                                                        <?php 
                                                            ...
                                                            $usersQuery = $switch_user_id;
                                                            $facility_id = $_GET['facility_id'];
                                                            $queries = "SELECT * FROM tblFacilityDetails_Registration_Organization_USDA where user_entities = $usersQuery and facility_entities = $facility_id  order by Reg_Org_id_USDA desc  LIMIT 1";
                                                            $resultQuery = mysqli_query($conn, $queries);
                                                            $rowusda = mysqli_fetch_array($resultQuery);
                                                            if(!empty($rowusda['user_entities'])){?>
                                                            <div class="row">
                                                                <form action="facility-function/add-contact-function.php" method="POST" enctype="multipart/form-data">
                                                                ...
                                                                <div class="col-md-3">
                                                                    <label>USDA</label>
                                                                    <input type="hidden" class="form-control" name="ids" value="<?php if($users == $row['users_entities']){ echo $row['facility_id'];}else{ echo '';} ?>" required> 
                                                                    <select class="form-control" name="Reg_Org_Certificate_name_USDA">
                                                                        <option value="No" <?php  if($rowusda['Reg_Org_Certificate_name_USDA']=='No'){echo 'selected';}else{echo '';} ?>>No</option>
                                                                        <option value="Yes" <?php  if($rowusda['Reg_Org_Certificate_name_USDA']=='Yes'){echo 'selected';}else{echo '';} ?>>Yes</option>
                                                                    </select>
                                                                </div>
                                                                <div class="col-md-3">
                                                                    <label>Supporting file: &nbsp;<a href="facility-function/facility-download-functions.php?USDA_files=<?php echo $rowusda['Reg_Org_id_USDA']; ?>"><?php echo $rowusda['Reg_Org_Supporting_files_USDA']; ?></a></label>
                                                                    <input type="file" class="form-control" name="Reg_Org_Supporting_files_USDA">
                                                                </div>
                                                                <div class="col-md-2">
                                                                    <label>Registration Date</label>
                                                                    <input type="date" class="form-control" name="Reg_Org_Registration_Date_USDA" value="<?php echo  date("Y-m-d", strtotime($rowusda['Reg_Org_Registration_Date_USDA']));?>"> 
                                                                </div>
                                                                <div class="col-md-2">
                                                                    <label>Expiry Date</label>
                                                                    <input type="date" class="form-control" name="Reg_Org_Expiry_Date_USDA" value="<?php echo  date("Y-m-d", strtotime($rowusda['Reg_Org_Expiry_Date_USDA']));?>">
                                                                </div>
                                                                <div class="col-md-2">
                                                                    <label style="color:transparent">...</label>
                                                                    <input type="submit" class="btn btn-success form-control" name="btnRegistration_Organization_USDA" value="Save"> 
                                                                </div>
                                                                </form>
                                                            </div>
                                                            <?php }else{ ?>
                                                              <div class="row">
                                                                ...
                                                                <div class="col-md-3">
                                                                    <label>Supporting file: </label>
                                                                    <input type="file" class="form-control" name="Reg_Org_Supporting_files_USDA" required>
                                                                </div>
                                                                <div class="col-md-2">
                                                                    <label>Registration Date</label>
                                                                    <input type="date" class="form-control" name="Reg_Org_Registration_Date_USDA" required> 
                                                                </div>
                                                                <div class="col-md-2">
                                                                    <label>Expiry Date</label>
                                                                    <input type="date" class="form-control" name="Reg_Org_Expiry_Date_USDA" required>
                                                                </div>
                                                                <div class="col-md-2">
                                                                    <label style="color:transparent">...</label>
                                                                    <input type="submit" class="btn btn-success form-control" name="btnRegistration_Organization_USDA" value="Save"> 
                                                        ...
                                                        <?php 
                                                            ...
                                                            $usersQuery = $switch_user_id;
                                                            $facility_id = $_GET['facility_id'];
                                                            $queries = "SELECT * FROM tblFacilityDetails_Registration_Organization_Others where user_entities = $usersQuery and facility_entities = $facility_id  order by Reg_Org_id_Others desc  LIMIT 1";
                                                            $resultQuery = mysqli_query($conn, $queries);
                                                            $rowr = mysqli_fetch_array($resultQuery);
                                                            if(!empty($rowr['user_entities'])){?>
                                                                <div class="row">
                                                                    <form action="facility-function/add-contact-function.php" method="POST" enctype="multipart/form-data">
                                                                    ...
                                                                    <div class="col-md-3">
                                                                        <label>Others</label>
                                                                        <input type="hidden" class="form-control" name="ids" value="<?php if($users == $row['users_entities']){ echo $row['facility_id'];}else{ echo '';} ?>" required> 
                                                                        <select class="form-control" name="Reg_Org_Certificate_name_Others">
                                                                            <option value="No" <?php  if($rowr['Reg_Org_Certificate_name_Others']=='No'){echo 'selected';}else{echo '';} ?>>No</option>
                                                                            <option value="Yes" <?php  if($rowr['Reg_Org_Certificate_name_Others']=='Yes'){echo 'selected';}else{echo '';} ?>>Yes</option>
                                                                        </select>
                                                                    </div>
                                                                    <div class="col-md-3">
                                                                        <label>Supporting file: &nbsp;<a href="facility-function/facility-download-functions.php?Others_files=<?php echo $rowr['Reg_Org_id_Others']; ?>"><?php echo $rowr['Reg_Org_Supporting_files_Others']; ?></a></label>
                                                                        <input type="file" class="form-control" name="Reg_Org_Supporting_files_Others">
                                                                    </div>
                                                                    <div class="col-md-2">
                                                                        <label>Registration Date</label>
                                                                        <input type="date" class="form-control" name="Reg_Org_Registration_Date_Others" value="<?php echo  date("Y-m-d", strtotime($rowr['Reg_Org_Registration_Date_Others']));?>" required> 
                                                                    </div>
                                                                    <div class="col-md-2">
                                                                        <label>Expiry Date</label>
                                                                        <input type="date" class="form-control" name="Reg_Org_Expiry_Date_Others" value="<?php echo  date("Y-m-d", strtotime($rowr['Reg_Org_Expiry_Date_Others']));?>" required>
                                                                    </div>
                                                                    <div class="col-md-2">
                                                                        <label style="color:transparent">...</label>
                                                                        <input type="submit" class="btn btn-success form-control" name="btnRegistration_Organization_Others" value="Save"> 
                                                                    </div>
                                                                    </form>
                                                                </div>
                                                            <?php }else{ ?>
                                                              <div class="row">
                                                                    ...
                                                                    <div class="col-md-2">
                                                                        <label>Registration Date</label>
                                                                        <input type="date" class="form-control" name="Reg_Org_Registration_Date_Others" required> 
                                                                    </div>
                                                                    <div class="col-md-2">
                                                                        <label>Expiry Date</label>
                                                                        <input type="date" class="form-control" name="Reg_Org_Expiry_Date_Others" required>
                                                                    </div>
                                                                    <div class="col-md-2">
                                                                        <label style="color:transparent">...</label>
                                                                        <input type="submit" class="btn btn-success form-control" name="btnRegistration_Organization_Others" value="Save"> 
                                                                ...
                                                                <table class="table">
                                                                    ...
                                                                    <tbody>
                                                                        <?php 
                                                                            ...
                                                                            <tr>
                                                                                <td><?php echo $rowr['Organization_name']; ?>&nbsp;<?php echo $rowr['Organization_last_name']; ?></td>
                                                                                <td><?php echo $rowr['Organization_title']; ?></td>
                                                                                <td><?php echo $rowr['Organization_cellno']; ?></td>
                                                                                <td><?php echo $rowr['Organization_phone']; ?></td>
                                                                                <td><?php echo $rowr['Organization_emailAddress']; ?></td>
                                                                                <td>
                                                                                    <a class="btn blue btn-outline btnViewOrganization " data-toggle="modal" href="#modalGeFacilitytOrganization" data-id="<?php echo $rowr["Org_id"]; ?>" style="float:right;margin-right:20px;">
                                                                                            VIEW
                                                                                    </a>
                                                                                </td>
                                                                            </tr>
                                                    ...
                                                    <div class="tab-pane" id="fo">
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-md-4">
                                                                ...
                                                                <br>
                                                                <input type="checkbox" name="Facilty_Functions[]" value="13" <?php if(in_array('10', $array_data)){echo 'checked';}else{echo '';} ?>> 
                                                                <label>Microbusiness</label>
                                                            </div>
                                                            <div class="col-md-4">
                                                                <input type="checkbox" name="Facilty_Functions[]" value="14" <?php if(in_array('10', $array_data)){echo 'checked';}else{echo '';} ?>> 
                                                    ...
                                                    <div class="tab-pane" id="ppf">
                                                        ...
                                                        <div class="row">
                                                            <div class="col-md-12">
                                                                ...
                                                                <table class="table table-bordered">
                                                                    ...
                                                                    <tbody id="data_diagram">
                                                                        <?php
                                                                             $query_pm = mysqli_query($conn, "select * from tblFacilityDetails_Diagram where enterprise_pk = $current_userEmployerID");
                                                                            ...
                                                                            foreach($query_pm as $row_pm){?>
                                                                                <tr id="row_diagram<?=$row_pm['diagram_pk']; ?>">
                                                                                    ...
                                                                                    <!--        <a  href="#modal_update_by_plant" data-toggle="modal" type="button" id="update_by_plant" data-id="" class="btn btn-outline dark btn-sm">Edit</a>-->
                                                                    	               <!--     <a href="#modal_delete_by_plant" data-toggle="modal" type="button" id="delete_by_plant" data-id="" class="btn btn-danger btn-sm" onclick="">Delete</a>-->
                                                                                    <!--    </div>-->
                                                                                    <!--</td>-->
                                                                                </tr>
                                                                            <?php } 
                                                            ...
                                                            <div class="col-md-12">
                                                                ...
                                                                <table class="table table-bordered">
                                                                    ...
                                                                    <tbody id="data_plan">
                                                                        <?php
                                                                             $query_plan = mysqli_query($conn, "select * from tblFacilityDetails_Plan where enterprise_pk = $current_userEmployerID");
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-md-6">
                                                                ...
                                                                <div class="col-md-4">
                                                                    <input type="checkbox" name="N_A[]"  id="FPTNA" onclick="FPTfunction()" value="1" <?php if(in_array('1', $array_N_A) || in_array('', $array_N_A)){echo 'checked';}else{echo '';} ?>> 
                                                                    <label>N/A</label>
                                                                </div>
                                                            </div>
                                                            <div class="col-md-6">
                                                                ...
                                                                <div class="col-md-4">
                                                                    <input type="checkbox" name="N_A[]" id="WSNA" onclick="WSfunction()" value="2" <?php if(in_array('2', $array_N_A) || in_array('', $array_N_A)){echo 'checked';}else{echo '';} ?>> 
                                                                    <label>N/A</label>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="row">
                                                            <div class="col-md-6">
                                                                ...
                                                                <div class="col-md-4">
                                                                    <input type="checkbox" name="N_A[]" id="CCNA" onclick="CCfunction()" value="3" <?php if(in_array('3', $array_N_A) || in_array('', $array_N_A)){echo 'checked';}else{echo '';} ?>> 
                                                                    <label>N/A</label>
                                                                </div>
                                                            </div>
                                                            <div class="col-md-6">
                                                                ...
                                                                <div class="col-md-4">
                                                                    <input type="checkbox" name="N_A[]" id="FSNA" onclick="FSfunction()" value="4" <?php if(in_array('4', $array_N_A) || in_array('', $array_N_A)){echo 'checked';}else{echo '';} ?>> 
                                                                    <label>N/A</label>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="row">
                                                            <div class="col-md-6">
                                                                ...
                                                                <div class="col-md-4">
                                                                    <input type="checkbox" name="N_A[]" id="PANA" onclick="PAfunction()" value="5" <?php if(in_array('5', $array_N_A) || in_array('', $array_N_A)){echo 'checked';}else{echo '';} ?>> 
                                                                    <label>N/A</label>
                                                                </div>
                                                            </div>
                                                            <div class="col-md-6">
                                                                ...
                                                                <div class="col-md-4">
                                                                    <input type="checkbox" name="N_A[]" id="PASNA" onclick="PASfunction()" value="6" <?php if(in_array('6', $array_N_A) || in_array('', $array_N_A)){echo 'checked';}else{echo '';} ?>> 
                                                                    <label>N/A</label>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="row">
                                                            <div class="col-md-6">
                                                                ...
                                                                <div class="col-md-4">
                                                                    <input type="checkbox" name="N_A[]" id="FANA" onclick="FAfunction()" value="7" <?php if(in_array('7', $array_N_A) || in_array('', $array_N_A)){echo 'checked';}else{echo '';} ?>> 
                                                                    <label>N/A</label>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    ...
                                                    <div class="tab-pane" id="bond">
                                                        ...
                                                        <div class="row">
                                                            <div class="col-md-12">
                                                                <h4><strong>Insurance and Bond</strong>&nbsp;<a data-toggle="modal" href="#addInsurance" class="btn btn-xs btn-primary"><i class="fa fa-plus"></i>&nbsp;ADD</a></h4>
                                                                <br>
                                                                <table class="table table-bordered">
                                                                    <thead>
                                                                        <tr>
                                                                    ...
                                                                    <tbody id="data_ib">
                                                                        <?php
                                                                             $query_ib = mysqli_query($conn, "select * from tblFacilityDetails_Bond where enterprise_pk = $current_userEmployerID");
                                                                            if(mysqli_fetch_row($query_ib)){
                                                                            foreach($query_ib as $row_ib){?>
                                                                                <tr id="row_diagram<?=$row_ib['bond_pk']; ?>">
                                                                                    <td><?=$row_ib['ib_title']; ?></td>
                                                                                    <td><a href="facility_files_Folder/<?= $row_ib['ib_files']; ?>" target="_blank"><?= $row_ib['ib_files']; ?></a></td>
                                                                                    <td><?= $row_ib['expiry_date']; ?></td>
                                                                                    <!--<td>-->
                                                                                    <!--    <div class="btn-group btn-group-circle">-->
                                                                                    <!--        <a  href="#modal_update_by_plant" data-toggle="modal" type="button" id="update_by_plant" data-id="" class="btn btn-outline dark btn-sm">Edit</a>-->
                                                                    	               <!--     <a href="#modal_delete_by_plant" data-toggle="modal" type="button" id="delete_by_plant" data-id="" class="btn btn-danger btn-sm" onclick="">Delete</a>-->
    ...
    <!--Free Add Contact Person modal MODAL AREA-->
        ...
        <div class="modal fade" id="addInsurance" tabindex="-1" role="dialog" >
            <div class="modal-dialog">
                <div class="modal-content">
                    <form method="post" class="form-horizontal modalForm addInsurance">
                        <div class="modal-header bg-primary">
                            <button type="button" class="close" data-dismiss="modal" aria-hidden="true"></button>
                            <h4 class="modal-title">Add Insurance and Bond</h4>
                        </div>
                        <div class="modal-body">
                            <div class="col-md-12">
                                <div class="form-group">
                           ...
                           <br>
                            <div class="col-md-12">
                                <div class="form-group">
                                    <label>Supporting Files</label>
                                    <input class="form-control" type="file" name="ib_files" required>
                                </div>
                            </div>
                            <br>
                             <div class="col-md-12">
                        ...
                        <div class="modal-footer" style="margin-top:10px;">
                            <input type="submit" name="btnInsurance" id="btnInsurance" value="Add" class="btn btn-info">
                        </div>
                    </form>
                </div>
            </div>
                            ...
                            <br>
                             <div class="row">
                                <div class="form-group">
                                    ...
                                    <div class="col-md-12">
                                        <input class="form-control" type="text" id="Organization_emailAddress" name="Organization_emailAddress" required/>
                                    </div>
                                </div>
                            </div>
                        </div>
...
$(".addPlan").on('submit',(function(e) {
    ...
    $.ajax({
       ...
       // Insurance and Bond
$(".addInsurance").on('submit',(function(e) {
    e.preventDefault();
    //  var row_tbl = $("#Status_tbl").val();
    formObj = $(this);
    if (!formObj.validate().form()) return false;
    ...
    var formData = new FormData(this);
    formData.append('btnInsurance',true);

    var l = Ladda.create(document.querySelector('#btnInsurance'));
    l.start();
