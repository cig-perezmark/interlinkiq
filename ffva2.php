        ...
        <script type="text/javascript">
            ...
            function btnSendNotification(e, type, id) {
                ...
                if (SendNotification > 0) {
                    $.ajax({
                        type: "GET",
                        url: "function2.php?btnSendNotification="+SendNotification+"&t="+type+"&i="+id,
                        dataType: "html",
            ...
            function btnHistory(id) {
                $.ajax({
                    type: "GET",
                    url: "function2.php?modalHistory_FFVA="+id,
                    dataType: "html",
                    success: function(data){
            ...
            function btnArchived(id) {
                $.ajax({
                    type: "GET",
                    url: "function2.php?modalArchived_FFVA="+id,
                    dataType: "html",
                    success: function(data){
            ...
            function btnNew(id) {
                $.ajax({
                    type: "GET",
                    url: "function2.php?modalNew_FFVA="+id,
                    dataType: "html",
                    success: function(data){
            ...
            function btnEdit(id, type) {
                $.ajax({
                    type: "GET",
                    url: "function2.php?modalEdit_FFVA="+id,
                    dataType: "html",
                    success: function(data){
            ...
            function btnView(id) {
                $.ajax({
                    type: "GET",
                    url: "function2.php?modalView_FFVA="+id,
                    dataType: "html",
                    success: function(data){
            ...
            function btnDelete(id, table) {
                swal({
                    ...
                    $.ajax({
                        type: "GET",
                        url: "function2.php?btnDelete_FFVA="+id+"&reason="+inputValue,
                        dataType: "html",
                        success: function(response){
            ...
            function btnArchive(id, table) {
                swal({
                    ...
                    $.ajax({
                        type: "GET",
                        url: "function2.php?btnArchive_FFVA="+id,
                        dataType: "html",
                        success: function(response){
                            $('#tableData_'+table+' tbody #tr_'+id).remove();
                        }
            ...
            function btnRevert(id, table) {
                swal({
                    ...
                    $.ajax({
                        type: "GET",
                        url: "function2.php?btnRevert_FFVA="+id,
                        dataType: "html",
                        success: function(response){
            ...
            function btnTemplate(id, tab) {
                ...
                swal({
                    ...
                    $.ajax({
                        type: "GET",
                        url: "function2.php?btnTemplate_FFVA="+id+"&tab="+tab,
                        dataType: "html",
                        success: function(response){
                            if ($.trim(response)) {
                                msg = "Sucessfully Save!";
            ...
            function btnRef(id, type) {
                $.ajax({
                    type: "GET",
                    url: "function2.php?modalRef_FFVA="+id+"&type="+type,
                    dataType: "html",
                    success: function(data){
            ...
            function btnSign(id, area) {
                $.ajax({
                    type: "GET",
                    url: "function2.php?modalSign_FFVA="+id+"&area="+area,
                    dataType: "html",
                    success: function(data){
            ...
            function btnFile(id, area) {
                $.ajax({
                    type: "GET",
                    url: "function2.php?modalFile_FFVA="+id+"&area="+area,
                    dataType: "html",
                    success: function(data){
            ...
            function btnInt(id, type, tab) {
                $.ajax({
                    type: "GET",
                    url: "function2.php?modalInt_FFVA="+id+"&type="+type+"&tab="+tab,
                    dataType: "html",
                    success: function(data){
            ...
            function btnDeleteKatva(id) {
                swal({
                    ...
                    $.ajax({
                        type: "GET",
                        url: "function2.php?btnDeleteKatva_FFVA="+id+"&reason="+inputValue,
                        dataType: "html",
                        success: function(response){
            ...
            function btnNewKatva(modal) {
                $.ajax({
                    type: "GET",
                    url: "function2.php?modalNewKatva_FFVA="+modal,
                    dataType: "html",
                    success: function(data){
            ...
            function btnViewKatva(id) {
                $.ajax({
                    type: "GET",
                    url: "function2.php?modalViewKatva_FFVA="+id,
                    dataType: "html",
                    success: function(data){
