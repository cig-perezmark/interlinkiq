<?php
    ...
    if ($likelihood_type == 2 AND $likelihood_user_id == 1) {
    ...
    if ($likelihood_type == 2 AND $likelihood_user_id == 1) {
        $html .= '<table cellpadding="7" cellspacing="0" border="1" style="width: 100%;" nobr="true">
            ...
            <tr style="background-color: yellow;">
                ...
                <td style="text-align: center;"><b>2 - Medium Risl</b></td>
                ...
                if (in_array($row["type"], $likelihood_type_arr)) {
                    ...
                    $html .= '<tr>
                        ...
                        <td style="width: 15%; word-break: break-word;">';
                            ...
                            if (!empty($likelihood_low_risk) AND $likelihood_type == 2 AND $likelihood_user_id == 1) {
            ...
            while($rowConsequence = mysqli_fetch_array($selectConsequence)) {
                ...
                $html .= '<tr>
                    ...
                    <td>';
                        ...
                        if (!empty($consequence_low_risk) AND $likelihood_type == 2 AND $likelihood_user_id == 1) {
