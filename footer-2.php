<!-- MODAL SERVICE -->
                    ...
                    <!-- new task modal -->
                    <div class="modal fade" id="newTask" tabindex="-1" role="newTask" aria-hidden="true">
                        <div class="modal-dialog">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <button type="button" class="close" data-dismiss="modal" aria-hidden="true"></button>
                                ...
                                <form class="form-horizontal newTask" role="form" id="task_form">
                                    <div class="modal-body">
                                            <div class="form-body">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-8">
                                                        <select class="form-control" name="action" id="task_action">
                                                            <?php
                                                                $actions = $conn->query("SELECT * FROM tbl_service_logs_actions");
                    ...
                    <div class="chatbox-wrap bg-white" id="chatbotBox" style="height: 480px; width: 330px; display: none;">
                        <div class="chatbox-content">
                            ...
                            <form id="chatbotComposeMessage" class="chatbox-footer">
                                <div style="width: 100%;">
                                    <textarea style="resize: none; border: none;" name="message" class="form-control" rows="1" placeholder="Write a message..."></textarea>
                                </div>
                        ...
                        <div class="modal-dialog modal-lg">
                            <div class="modal-content">
                                <form method="post" enctype="multipart/form-data" class="modalSpeakUpView">
                                    ...
                                    <div class="modal-footer">
                                        <div class="input-group">
                                            <textarea class="form-control" placeholder="Write something here..." aria-label="Write something here..." aria-describedby="btnSend_Chat" name="comment" id="textSpeakUp"></textarea>
