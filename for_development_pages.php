...
?>
                                        ...
                                        <div class="tab-pane active" id="tab_Dashboard">
                                            <!--<h3>Dashboard &nbsp;<a class="btn btn-primary" data-toggle="modal" href="#addNew"> Create Project</a></h3>-->
                                                            <?php
                                                             ...
                                                             if(!empty($_GET['to_layer_2'])){$myPro2 = $_GET['to_layer_2'];}else{$myPro2 = $_GET['view_id']; }
                                                                    ...
                                                                    <thead>
                                                                        <tr>
                                                                            ...
                                                                            <td>
                                                                               ...
                                                                               <i style="color:#D36B00;">(<?php if(!empty($count_in)){echo $count_in;}else{echo '0';} ?>)</a>
                                                                            </b>
                                                            ...
                                                            <div id="overflowTable">
                                                                    ...
                                                                    <table class="table-bordered" style="border:solid #fff 1px;" id="tblHistory">
                                                                        ...
                                                                        <?php
                                                    		                ...
                                                    		                WHERE MyPro_PK = '$myPro' || MyPro_PK = '$myPro2'" );
                                                    				        if ( mysqli_num_rows($selectFile) > 0 ) {
                                                    					        ...
                                                    					        ?>
                                                    					        	<tr id="<?php echo $rowFile["History_id"]; ?>" style="background-color:<?php echo $parentcolor; ?>;color:#fff;hover:black;" class="parentTbls">
                                                    					        	    ...
                                                    					        	    <td class="paddId">
                                                    					        	        <?php
                                                    					        	        $user_ids = $_COOKIE['employee_id'];
                                                    					        	        $history_ids = $rowFile['History_id'];
                                                                                            $query_count = "SELECT COUNT(CAI_id) as count  FROM tbl_MyProject_Services_Childs_action_Items where Services_History_PK = $history_ids and CAI_Assign_to = $user_ids";
                                                                                            $result_count = mysqli_query($conn, $query_count);
                                                                                                                        
                                                                                            while($row_count = mysqli_fetch_array($result_count))
                                                                                            {
                                                                                                echo '<a class="btn default btn-outline">My Task: '.$total = $row_count['count'].'</a>';
                                                                                            }
                                                                    					   ?>
                                                                    					 </td>
                                                                                        <td>
                                                                                        ...
                                                                                        <td class="paddId" style="background-color:<?php if($rowCAI['Parent_MyPro_PK'] == $parent_id){ echo $parentcolor;}else{echo $childcolor1;} ?>;color:#fff; width:100px !important;">
                                                                                                
                                                                                            <?php
                                                                                            $user_ids = $_COOKIE['ID'];
                                                                                            $query = "SELECT *  FROM tbl_MyProject_Services_Show_hide where show_status = 1";
                                                                                            $result = mysqli_query($conn, $query);
                                                                                                                        
                                                                                            while($row = mysqli_fetch_array($result))
                                                                                            {
                                                                                                $done = false;
                                                                                                if($row['user_ids'] == $user_ids and $row['task_id'] == $rowFile["History_id"]){
                                                                                                    $done = true;
                                                                                                    break;
                                                                                                }
                                                                                                
                                                                                            }
                                                                                            if($done == true){ echo '<button class="btn red btn-xs show_hide" id="'.$rowFile["History_id"].'" type="button" onClick="window.location.reload();">Hide</button>';}
                                                                                            else{ echo '<button class="btn blue btn-xs show_hide" id="'.$rowFile["History_id"].'" type="button" onClick="window.location.reload();">Show</button>';}
                                                                                            ?>
                                                                                        </td>
                                                                                    </tr>
                                                                                    ...
                                                                                    $query2 = "SELECT * FROM tbl_MyProject_Services_Childs_action_Items left join tbl_MyProject_Services_Action_Items on Action_Items_id = CAI_Action_taken
                                                    		                         left join tbl_hr_employee on CAI_Assign_to = ID left join tbl_user on employee_id = tbl_hr_employee.ID 
                                                    		                           WHERE Parent_MyPro_PK = $project_id ";
                                                    		                           if($done == true)
                                                                                        {
                                                                                            $parent_id = $rowFile["History_id"];
                                                                                        	$query2 .= "
                                                                                            and CIA_Indent_Id = '$parent_id' and Services_History_PK = '$parent_id' 
                                                                                        	";
                                                                                        }
                                                                                        else
                                                                                        {
                                                                                            $parent_id = $rowFile["History_id"];
                                                                                            $emp_ids = $_COOKIE['employee_id'];
                                                                                            $query2 .= "
                                                                                        	and Services_History_PK = $parent_id and CAI_Assign_to = $emp_ids
                                                                                        	";
                                                                                        }
                                                    		                       
                                                                                    
                                                        					        $result2 = mysqli_query($conn, $query2);
                                                        					        while($rowCAI = mysqli_fetch_array($result2)) {
                                                    					           ...
                                                    					           $url = $base_url.'MyPro_Folder_Files/';?>
                                                                                        <tr id="<?php echo $rowCAI["CAI_id"]; ?>" style="border:solid <?php if($rowCAI["CAI_Assign_to"]== $_COOKIE['employee_id']){echo '#083AA9';}else{echo '#fff';} ?> 2px;" >
                                                                                            ...
                                                                                            <td class="paddId" style="background-color:<?php if($rowCAI['Parent_MyPro_PK'] == $parent_id){ echo $parentcolor;}else{echo $childcolor1;} ?>;color:#fff; width:100px !important;">
                                                                                                ...
                                                                                                {
                                                                                                    $done = false;
                                                                                                    if($row['user_ids'] == $user_ids and $row['task_id'] == $rowCAI['CAI_id']){
                                                                                                        $done = true;
                                                                                                        break;
                                                                                                    }
                                                                                                    
                                                                                                }
                                                                                                if($done == true){ echo '<button class="btn red btn-xs show_hide" id="'.$rowCAI['CAI_id'].'" type="button" onClick="window.location.reload();">Hide</button>';}
                                                                                                else{ echo '<button class="btn blue btn-xs show_hide" id="'.$rowCAI['CAI_id'].'" type="button" onClick="window.location.reload();">Show</button>';}
                                                                                                ?>
                                                                                            </td>
                                                                                        </tr>
                                                                                            <?php
                                                                                                ...
                                                                                                $query3 ="SELECT * FROM tbl_MyProject_Services_Childs_action_Items left join tbl_MyProject_Services_Action_Items on Action_Items_id = CAI_Action_taken
                                                                    		                         left join tbl_hr_employee on CAI_Assign_to = ID left join tbl_user on employee_id = tbl_hr_employee.ID where CIA_Indent_Id = $childLayer2
                                                                    		                       ";
                                                                    		                       if($done == true)
                                                                                                    {
                                                                                                        $project_id = $_GET['view_id'];
                                                                                                    	$query3 .= "
                                                                                                        and Parent_MyPro_PK = $project_id   
                                                                                                    	";
                                                                                                    }
                                                                                                    else
                                                                                                    {
                                                                                                        $query3 .= "
                                                                                                    	and Parent_MyPro_PK=$project_id Limit 0
                                                                                                    	";
                                                                                                    }
                                                                                                    
                                                                        					        $result3 = mysqli_query($conn, $query3);
                                                                    					        while($rowLayer3 = mysqli_fetch_array($result3)) {  
                                                                                                ...
                                                                                                <tr id="<?php echo $rowLayer3["CAI_id"]; ?>"  class="parentTbls" style="border:solid <?php if($rowLayer3["CAI_Assign_to"]== $_COOKIE['employee_id']){echo '#083AA9';}else{echo '#fff';} ?> 2px;">
                                                                					        	  ...
                                                                					        	  <td class="paddId" style="background-color:<?php echo $childcolor1; ?>;color:#fff;"> Assign to: <?php echo $rowLayer3["first_name"]; ?></td>
                                                                                                   ...
                                                                                                   <td class="paddId" style="background-color:<?php if($rowLayer3['Parent_MyPro_PK'] == $parent_id){ echo $parentcolor;}else{echo $childcolor1;} ?>;color:#fff;">
                                                                                                    ...
                                                                                                    <td class="paddId" style="background-color:<?php if($rowLayer3['Parent_MyPro_PK'] == $parent_id){ echo $parentcolor;}else{echo $childcolor1;} ?>;color:#fff; width:100px !important;">
                                                                                                        ...
                                                                                                        {
                                                                                                            $done = false;
                                                                                                            if($row['user_ids'] == $user_ids and $row['task_id'] == $rowLayer3['CAI_id']){
                                                                                                                $done = true;
                                                                                                                break;
                                                                                                            }
                                                                                                            
                                                                                                        }
                                                                                                        if($done == true){ echo '<button class="btn red btn-xs show_hide" id="'.$rowLayer3['CAI_id'].'" type="button" onClick="window.location.reload();">Hide</button>';}
                                                                                                        else{ echo '<button class="btn blue btn-xs show_hide" id="'.$rowLayer3['CAI_id'].'" type="button" onClick="window.location.reload();">Show</button>';}
                                                                                                        ?>
                                                                                                    </td>
                                                                                                </tr>
                                                                                                  <?php
                                                                                                        ...
                                                                                                        $query4 = "SELECT * FROM tbl_MyProject_Services_Childs_action_Items left join tbl_MyProject_Services_Action_Items on Action_Items_id = CAI_Action_taken
                                                                            		                         left join tbl_hr_employee on CAI_Assign_to = ID left join tbl_user on employee_id = tbl_hr_employee.ID
                                                                            		                       WHERE CIA_Indent_Id = '$childLayer3'";
                                                                            		                       if($done == true)
                                                                                                            {
                                                                                                                $project_id = $_GET['view_id'];
                                                                                                                $childLayer3 = $rowLayer3['CAI_id'];
                                                                                					        ...
                                                                                					        while($rowLayer4 = mysqli_fetch_array($result4)) { 
                                                                                                            ...
                                                                                                            <tr id="<?php echo $rowLayer4["CAI_id"]; ?>"  class="parentTbls" style="border:solid <?php if($rowLayer4["CAI_Assign_to"]== $_COOKIE['employee_id']){echo '#083AA9';}else{echo '#fff';} ?> 2px;">
                                                                                                               ...
                                                                                                               <td class="paddId" style="background-color:<?php if($rowLayer4['Parent_MyPro_PK'] == $parent_id){ echo $parentcolor;}else{echo $childcolor1;} ?>;color:#fff;">
                                                                                                                ...
                                                                                                                <td class="paddId" style="background-color:<?php if($rowLayer4['Parent_MyPro_PK'] == $parent_id){ echo $parentcolor;}else{echo $childcolor1;} ?>;color:#fff; width:100px !important;">
                                                                                                                    ...
                                                                                                                    {
                                                                                                                        $done = false;
                                                                                                                        if($row['user_ids'] == $user_ids and $row['task_id'] == $rowLayer4['CAI_id']){
                                                                                                                            $done = true;
                                                                                                                            break;
                                                                                                                        }
                                                                                                                        
                                                                                                                    }
                                                                                                                    if($done == true){ echo '<button class="btn red btn-xs show_hide" id="'.$rowLayer4['CAI_id'].'" type="button" onClick="window.location.reload();">Hide</button>';}
                                                                                                                    else{ echo '<button class="btn blue btn-xs show_hide" id="'.$rowLayer4['CAI_id'].'" type="button" onClick="window.location.reload();">Show</button>';}
                                                                                                                    ?>
                                                                                                                </td>
                                                                                                            </tr>
                                                                                                                <?php
                                                                                                            ...
                                                                                                            $query5 = "SELECT * FROM tbl_MyProject_Services_Childs_action_Items left join tbl_MyProject_Services_Action_Items on Action_Items_id = CAI_Action_taken
                                                                                		                         left join tbl_hr_employee on CAI_Assign_to = ID left join tbl_user on employee_id = tbl_hr_employee.ID
                                                                                		                       WHERE CIA_Indent_Id = '$childLayer4'";
                                                                                		                       if($done == true)
                                                                                                                {
                                                                                                                    $project_id = $_GET['view_id'];
                                                                                                                	$query5 .= "
                                                                                    					        ...
                                                                                    					        while($rowLayer5 = mysqli_fetch_array($result5)) { 
    ...
    function filter_notstarted(id) {
        $.ajax({
            type: "GET",
            url: "MyPro_Folders/show_hide.php?modal_filter_status="+id,
            dataType: "html",
            success: function(data){
    ...
    function filter_progress(id) {
        $.ajax({
            type: "GET",
            url: "MyPro_Folders/show_hide.php?modal_filter_status_progress="+id,
            dataType: "html",
            success: function(data){
    ...
    function filter_completed(id) {
        $.ajax({
            type: "GET",
            url: "MyPro_Folders/show_hide.php?modal_filter_status_completed="+id,
            dataType: "html",
            success: function(data){
...
<script>
    ...
    $(document).ready(function()
    {
        $(".show_hide").click(function()
        {
            ...
            $.ajax({
                type:'POST',
                url:'MyPro_Folders/show_hide.php',
                data:'show_id='+id,
                success: function(data)
                {
                    // location.reload();
