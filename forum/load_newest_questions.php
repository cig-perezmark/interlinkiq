...
$displayforums = $forumFunctions->forumdisplaynewest();

?>
 <input placeholder="Search" id="search" type="text" />
 <label style="border:solid lightgray 1px;padding:5px;border-radius:2px;"><i class="fa fa-filter" aria-hidden="true"></i> &nbsp; FILTER: <span id="current_filter">NEWEST</span>&nbsp;<i style="color:green;" class="fa fa-calendar-check-o" aria-hidden="true"></i></label>
<?php 
