...
//Display Forum
$user_id = $_COOKIE['ID'];
$question_tag = $_GET['tagskeyword'];
$keywordisplay = str_replace('%', ' ', $question_tag);

?>
 <input placeholder="Search" id="search" type="text" />
 <label style="border:solid lightgray 1px;padding:5px;border-radius:2px;"><i class="fa fa-filter" aria-hidden="true"></i> &nbsp; FILTER: <span id="current_filter" >BY KEYWORD/TAG: <span style="font-weight:bold;"><?php echo  $keywordisplay; ?></span> </span>&nbsp;<i style="color:green;" class="fa fa-eye" aria-hidden="true"></i></label>
<?php 

$selectquestiontag ="SELECT t1.* 
                ...
                FROM `questions` t1
                WHERE 1=1 AND t1.question_tags like '%$question_tag%' ";
$result = $conn->query($selectquestiontag);        
