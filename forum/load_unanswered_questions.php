...
$displayforums = $forumFunctions->forumdisplayunanswered();

?>
 <input placeholder="Search" id="search" type="text" />
 <label style="border:solid lightgray 1px;padding:5px;border-radius:2px;"><i class="fa fa-filter" aria-hidden="true"></i> &nbsp; FILTER: <span id="current_filter">UNANSWERED</span>&nbsp;<i style="color:green;" class="fa fa-pencil-square-o" aria-hidden="true"></i></label>
<?php 
      ...
      ?>
               <div class="card question-display-home cardholderforsearching">
                          ...
                          <a id="<?php echo $question_id;  ?>" class="btn btn-primary view_display"><i class="fa fa-eye" aria-hidden="true"></i>&nbsp;View</a>
                          ...
                          <input type="hidden" id="current_userfname" value="<?php echo $user_fname; ?>">
                   </div>
      <?php
