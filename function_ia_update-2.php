		...
		if ( mysqli_num_rows($selectForm) > 0 ) {
			...
			if ( mysqli_num_rows($selectIA) > 0 ) {
				...
				if (!empty($ia_sheet_id)) {
					...
					mysqli_query( $conn,"UPDATE tbl_ia_form set data = '". $data_content ."', score_result = '".$score_result."' WHERE ID = '". $ID ."'" );
		        }
