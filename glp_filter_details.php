                            ...
                            <div class="tab-content">
                                                        ...
                                                        if(!empty($_GET['equip_id'])){
                                                            ...
                                                            if ($registered_result) {
                                                                    foreach ($registered_result as $equipmentId) {
                                                                        ...
                                                                        $select_equipment = "SELECT * FROM equipment_reg_glp WHERE equip_id = {$equipmentId['equipment_id']}";
                                                                                    ...
                                                                                    <div class="row">
                                                                                        ...
                                                                                        <div class="col-md-3">
                                                                                            ...
                                                                                            <div class="d-flex">
                                                                                                ...
                                                                                                <input type="text"  class="form-control long-text" value="<?= $param_row['oum']?>"  readonly>
                                ...
                                <div class="tab-pane" id="tab2">
                                    <table id="inspectionTable" class="table table-bordered">
                                        ...
                                        <tbody>
                                            <?php
                                                $sql = "SELECT * FROM new_emp_records  
                                                INNER JOIN new_emp_parameters_glp ON new_emp_parameters_glp.id = new_emp_records.parameter_id
                                                INNER JOIN new_emp_equipment_settings_glp ON new_emp_equipment_settings_glp.parameter_id = new_emp_parameters_glp.id
                                                WHERE  new_emp_records.equip_id = {$_GET['equip_id']}";
                                                $result = mysqli_query($emp_connection,$sql);
                                                
                                                $sql_pmp = "SELECT * FROM equipment_reg_glp WHERE equip_id  = {$_GET['equip_id']}";
