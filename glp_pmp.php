                    ...
                    <form action="controller.php" method="post" enctype="multipart/form-data">
                        ...
                        <div id="add-modal-body" class="modal-body bg-white">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="inputFrequency">Assign Equipment Part Owner<?php echo $_COOKIE['client'] == 1 ? '':' <span style="color:red">*</span>'; ?></label>
                                        <select name="equipment_name[]" class="form-control mt-multiselect btn btn-default"  multiple data-live-search="true"  >
                                            <?php
                                                $get= mysqli_query($pmp_connection,"SELECT * FROM equipment_reg WHERE enterprise_owner = $switch_user_id");
                                                while($row=mysqli_fetch_array($get)) {
                                                    echo '<option value="'.$row['equip_id'].'">'.$row['equipment'].'</option>';
                                                }
                                            ?>
                                        </select>
                                    </div>
                        ...
                        <div id="add-modal-body" class="modal-body bg-white">
                            <div class="row">
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <!-- <input class="form-control" type="text" list="mc_assignee_1" />
                                    <datalist id="mc_assignee_1"> -->
                                        <?php
                                            ...
                                            //         $emp_name = $rowEmployee["e_first_name"] .' '. $rowEmployee["e_last_time"];
