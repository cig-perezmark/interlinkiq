                    ...
                    while ($rowNote = mysqli_fetch_array($selectNote)) {
                        ...
                        echo '<div class="userResult" id="note_' . $note_ID . '">
                                            <div class="d-flex align-items-center img-rounded excerpt p-2 position-relative">
                                                <div class="userData flex-grow-1" data-toggle="modal" data-target="#modalNotesView';
                        echo $note_user_id == $current_userID ? '' : 'Copy';
                        echo '" onclick="noteView';
                        echo $note_user_id == $current_userID ? '' : 'Copy';
                        echo '(' . $note_ID . ')">
                    ...
                    <ul class="nav navbar-nav pull-right">
                        <?php if ($current_client == 0 or $current_client == 10) { ?>
                            <li class="dropdown dropdown-extended" id="googleTranslate">
                                ...
                                <!--    <option data-content='<span class="fi fi-sa"></span> Arabic' value="Arabic" <?php if (isset($_COOKIE['googtrans']) && $_COOKIE['googtrans'] == '/en/ar') {
                                                                                                                        echo 'SELECTED';
                                                                                                                    } ?> >Arabic</option>-->
                                <!--    <option data-content='<span class="fi fi-fr"></span> French' value="French"<?php if (isset($_COOKIE['googtrans']) && $_COOKIE['googtrans'] == '/en/fr') {
                                                                                                                        echo 'SELECTED';
                                                                                                                    } ?> >French</option>-->
                                <!--    <option data-content='<span class="fi fi-it"></span> Italian' value="Italian"<?php if (isset($_COOKIE['googtrans']) && $_COOKIE['googtrans'] == '/en/it') {
                                                                                                                            echo 'SELECTED';
                                                                                                                        } ?> >Italian</option>-->
                                <!--    <option data-content='<span class="fi fi-jp"></span> Japanese' value="Japanese"<?php if (isset($_COOKIE['googtrans']) && $_COOKIE['googtrans'] == '/en/ja') {
                                                                                                                            echo 'SELECTED';
                                                                                                                        } ?> >Japanese</option>-->
                                <!--    <option data-content='<span class="fi fi-kr"></span> Korean' value="Korean"<?php if (isset($_COOKIE['googtrans']) && $_COOKIE['googtrans'] == '/en/ko') {
                                                                                                                        echo 'SELECTED';
                                                                                                                    } ?> >Korean</option>-->
                                <!--    <option data-content='<span class="fi fi-pt"></span> Portuguese' value="Portuguese"<?php if (isset($_COOKIE['googtrans']) && $_COOKIE['googtrans'] == '/en/pt') {
                                                                                                                                echo 'SELECTED';
                                                                                                                            } ?> >Portuguese</option>-->
                                <!--    <option data-content='<span class="fi fi-es"></span> Spanish' value="Spanish"<?php if (isset($_COOKIE['googtrans']) && $_COOKIE['googtrans'] == '/en/es') {
                                                                                                                            echo 'SELECTED';
                                                                                                                        } ?> >Spanish</option>-->
                                <!--</select>-->
                                <script type="text/javascript">
                        ...
                        <?php
                            ...
                            if ($current_userEmployeeID == 129 or $current_userEmployeeID == 128) {
                                ...
                                if (mysqli_num_rows($selectSpeak) > 0) {
                                    echo mysqli_num_rows($selectSpeak);
                                }
                                echo '</span>
                                        </a>
                                                ...
                                                echo '<li>
                                                    <form action="enterprise-function/export_users.php" method="POST" style="margin-top: 10px;">
                                                        <a style="text-decoration:none;" href="users-details-record">
                                                            <span class="time" style="background-color:red;color:white;margin-right:20px;">';
                                                echo $row['count'];
                                                echo '</span>
                                                            <span class="details">
                                                    ...
                                                    echo '<li>
                                                        <form action="enterprise-function/export_users.php" method="POST" style="margin-top: 10px;">
                                                            <a style="text-decoration:none;" href="enterprise_record">
                                                                <span class="time" style="background-color:red;color:white;margin-right:20px;">';
                                                    echo $row['count'] ?? '0'; /* added nullish fallback operator */
                                                    echo '</span>
                                                                <span class="details">
                                                                    <span class="label label-sm label-icon ">
            ...
            <div class="page-sidebar navbar-collapse collapse">
                ...
                <ul class="page-sidebar-menu  page-header-fixed page-sidebar-menu-hover-submenux page-sidebar-menu-compact" data-keep-expanded="false" data-auto-scroll="true" data-slide-speed="200">
                    ...
                    <?php if (($current_client == 0 and $switch_user_id <> 1106) or $switch_user_id == 1360 or $switch_user_id == 1366 or $switch_user_id == 1453 or $switch_user_id == 1482 or $switch_user_id == 1365 or $switch_user_id == 1477 or $switch_user_id == 145 or $switch_user_id == 1469) { ?>
                        ...
                        <li class="nav-item hide <?php echo $site === "app-store" ? "active" : "";
                                                    if (!empty($current_userEmployeeID) or $current_userEmployeeID > 0) {
                                                        echo menu('app-store', $current_userEmployerID, $current_userEmployeeID);
                                                    } ?>">
                    ...
                    <li class="nav-item <?php echo $site === "enterprise-info" ? "active open start" : "";
                                        if (!empty($current_userEmployeeID) or $current_userEmployeeID > 0) {
                                            echo menu('enterprise-info', $current_userEmployerID, $current_userEmployeeID);
                                        } ?>">
                        <a href="javascript:;" class="nav-link nav-toggle">
                        ...
                        <ul class="sub-menu">
                            ...
                            <li class="nav-item hide hidden <?php echo $site === "enterprise-info-subscription" ? "active " : "";
                                                            if (!empty($current_userEmployeeID) or $current_userEmployeeID > 0) {
                                                                echo menu('enterprise-info-subscription', $current_userEmployerID, $current_userEmployeeID);
                                                            } ?>">
                    ...
                    $query = mysqli_query($conn, "SELECT * FROM tblEnterpiseDetails WHERE enterpriseOperation = 'Yes' AND users_entities = $switch_user_id ");
                    if (mysqli_num_rows($query) > 0) { ?>
                        <li class="nav-item hide <?php echo $site === "facility-info" ? "active open start" : "";
                                                    if (!empty($current_userEmployeeID) or $current_userEmployeeID > 0) {
                                                        echo menu('enterprise-info-subscription', $current_userEmployerID, $current_userEmployeeID);
                                                    } ?>" id="menuFacility">
                            <a href="javascript:;" class="nav-link nav-toggle">
                    ...
                    <?php $query = mysqli_query($conn, "SELECT * FROM tblEnterpiseDetails WHERE enterpriseEmployees = 'Yes' AND users_entities = $switch_user_id ");
                    if (mysqli_num_rows($query) > 0) { ?>
                        <li class="nav-item hide <?php echo $site === "employee" || $site === "job-description" || $site === "trainings" || $site === "department" || $site === "quiz" || $site === "training-requirements" ? "active open start" : ""; ?>" id="menuHR">
                            ...
                            <ul class="sub-menu">
                                <li class="nav-item <?php echo $site === "department" ? "active " : "";
                                                    if (!empty($current_userEmployeeID) or $current_userEmployeeID > 0) {
                                                        echo menu('department', $current_userEmployerID, $current_userEmployeeID);
                                                    } ?>">
                                ...
                                <li class="nav-item <?php echo $site === "job-description" ? "active " : "";
                                                    if (!empty($current_userEmployeeID) or $current_userEmployeeID > 0) {
                                                        echo menu('job-description', $current_userEmployerID, $current_userEmployeeID);
                                                    } ?>">
                                ...
                                <li class="nav-item <?php echo $site === "employee" ? "active " : "";
                                                    if (!empty($current_userEmployeeID) or $current_userEmployeeID > 0) {
                                                        echo menu('employee', $current_userEmployerID, $current_userEmployeeID);
                                                    } ?>">
                                ...
                                <li class="nav-item <?php echo $site === "trainings" ? "active " : "";
                                                    if (!empty($current_userEmployeeID) or $current_userEmployeeID > 0) {
                                                        echo menu('trainings', $current_userEmployerID, $current_userEmployeeID);
                                                    } ?>">
                                ...
                                <li class="nav-item <?php echo $site === "quiz" ? "active " : "";
                                                    if (!empty($current_userEmployeeID) or $current_userEmployeeID > 0) {
                                                        echo menu('quiz', $current_userEmployerID, $current_userEmployeeID);
                                                    } ?>">
                                ...
                                <li class="nav-item <?php echo $site === "training-requirements" ? "active " : "";
                                                    if (!empty($current_userEmployeeID) or $current_userEmployeeID > 0) {
                                                        echo menu('training-requirements', $current_userEmployerID, $current_userEmployeeID);
                                                    } ?>">
                    ...
                    <?php $query = mysqli_query($conn, "SELECT * FROM tblEnterpiseDetails WHERE enterpriseProducts = 'Yes' AND users_entities = $switch_user_id ");
                    if (mysqli_num_rows($query) > 0) { ?>
                        <li class="nav-item <?php echo $site === "products" ? "active " : "";
                                            if (!empty($current_userEmployeeID) or $current_userEmployeeID > 0) {
                                                echo menu('products', $current_userEmployerID, $current_userEmployeeID);
                                            } ?>">
                    ...
                    <?php $query = mysqli_query($conn, "SELECT * FROM tblEnterpiseDetails WHERE enterpriseServices = 'Yes' AND users_entities = $switch_user_id ");
                    if (mysqli_num_rows($query) > 0) { ?>
                        <li class="nav-item <?php echo $site === "services" ? "active " : "";
                                            if (!empty($current_userEmployeeID) or $current_userEmployeeID > 0) {
                                                echo menu('services', $current_userEmployerID, $current_userEmployeeID);
                                            } ?>">
                    ...
                    <li class="nav-item <?php echo $site === "customer" ? "active " : "";
                                        if (!empty($current_userEmployeeID) or $current_userEmployeeID > 0) {
                                            echo menu('customer', $current_userEmployerID, $current_userEmployeeID);
                                        } ?>">
                    ...
                    <li class="nav-item <?php echo $site === "supplier" ? "active " : "";
                                        if (!empty($current_userEmployeeID) or $current_userEmployeeID > 0) {
                                            echo menu('supplier', $current_userEmployerID, $current_userEmployeeID);
                                        } ?>">
                    ...
                    <?php if ($switch_user_id == 34) { ?>
                        <li class="nav-item <?php echo $site === "Directory_Dashboard" ? "active " : "";
                                            if (!empty($current_userEmployeeID) or $current_userEmployeeID > 0) {
                                                echo menu('Directory_Dashboard', $current_userEmployerID, $current_userEmployeeID);
                                            } ?>">
                    ...
                    <?php if ($current_client == 0 and ($switch_user_id == 1 or $switch_user_id == 34 or $switch_user_id == 163)) { ?>
                        <li class="nav-item <?php echo $site === "listing" ? "active " : "";
                                            if (!empty($current_userEmployeeID) or $current_userEmployeeID > 0) {
                                                echo menu('listing', $current_userEmployerID, $current_userEmployeeID);
                                            } ?>">
                    ...
                    <?php } else { ?>
                        <li class="nav-item <?php echo $site === "job-ticket-request" || $site === "job-ticket-service" ? "active open start" : ""; ?>">
                            ...
                            <ul class="sub-menu">
                                ...
                                <?php
                                echo '<li class="nav-item ';
                                $site === "job-ticket-service" ? "active" : "";
                                echo '">
                    ...
                    function sidebarDisplay($site, $menu_ID, $menu_collab, $menu_icon, $menu_url, $menu_description, $current_userEmployerID, $current_userEmployeeID)
                    {
                        ...
                        if (!empty($menu_url)) {
                            ...
                            if ($menu_collab == 1 and $current_userEmployeeID > 0) {
                                $output .= menu($menu_url, $current_userEmployerID, $current_userEmployeeID);
                            }
                            $output .= '">
                            ...
                            $output = '<li class="nav-item ';
                            if (in_array($site, $menuDown_array)) {
                                $output .= 'active open start';
                            }
                            $output .= '">
                                    <a href="javascript:;" class="nav-link nav-toggle">
                                        <i class="icon-user-female"></i>
                            ...
                            if (mysqli_num_rows($selectMenuDown) > 0) {
                                while ($rowMenuDown = mysqli_fetch_array($selectMenuDown)) {
                                    ...
                                    $output .= '<li class="nav-item ';
                                    if ($site == $menuDown_url) {
                                        $output .= 'active';
                                    }
                                    if ($menuDown_collab == 1 and $current_userEmployeeID > 0) {
                                        $output .= menu($menuDown_url, $current_userEmployerID, $current_userEmployeeID);
                                    }
                                    $output .= '">
                    ...
                    <li class="nav-item hide <?php echo $site === "form-owned" ? "active" : "";
                                                if (!empty($current_userEmployeeID) or $current_userEmployeeID > 0) {
                                                    echo menu('form-owned', $current_userEmployerID, $current_userEmployeeID);
                                                } ?>">
                        <a href="form-owned" class="nav-link" disabled>
                            <i class="icon-graph"></i>
                            <span class="title">E-Forms</span>
                    ...
                    <li class="nav-item hide <?php echo $site === "archive" ? "active " : "";
                                                if (!empty($current_userEmployeeID) or $current_userEmployeeID > 0) {
                                                    echo menu('archive', $current_userEmployerID, $current_userEmployeeID);
                                                } ?>">
                    ...
                    <li class="nav-item hide <?php echo $site === "ffva" ? "active" : "";
                                                if (!empty($current_userEmployeeID) or $current_userEmployeeID > 0) {
                                                    echo menu('ffva', $current_userEmployerID, $current_userEmployeeID);
                                                } ?>">
                    ...
                    <?php if ($current_userEmployerID == 247 || $current_userEmployerID == 34 || $user_id == 34) : ?>
                        <li class="nav-item hide <?php echo $site === "meeting_minutes" ? "active" : "";
                                                    if (!empty($current_userEmployeeID) or $current_userEmployeeID > 0) {
                                                        echo menu('meeting_minutes', $current_userEmployerID, $current_userEmployeeID);
                                                    } ?>">
                    ...
                    <?php if ($current_userEmployerID == 247 || $current_userEmployerID == 324 || $switch_user_id == 34 || $current_userEmployeeID == 34) : ?>
                        <li class="nav-item hide <?php echo $site === "Customer_Relationship_Management" ? "active " : "";
                                                    if (!empty($current_userEmployeeID) or $current_userEmployeeID > 0) {
                                                        echo menu('Customer_Relationship_Management', $current_userEmployerID, $current_userEmployeeID);
                                                    } ?>">
                    ...
                    <?php if ($user_id == 185 || $user_id == 34 || $user_id == 42 || $user_id == 35 || $user_id == 55 || $user_id == 54 || $user_id == 41 || $user_id == 32 || $user_id == 109) : ?>
                        <li class="nav-item hide <?php echo $site === "Internal_Audit" ? "active " : "";
                                                    if (!empty($current_userEmployeeID) or $current_userEmployeeID > 0) { // echo menu('Internal_Audit', $current_userEmployerID, $current_userEmployeeID); 
                                                    } ?>">
                    ...
                    <?php if ($current_userEmployerID == 247 || $current_userEmployerID == 34 || $user_id == 362) : ?>
                        <li class="nav-item hide <?php echo $site === "inventory-management" ? "active" : "";
                                                    if (!empty($current_userEmployeeID) or $current_userEmployeeID > 0) {
                                                        echo menu('inventory-management', $current_userEmployerID, $current_userEmployeeID);
                                                    } ?>">
                    ...
                    <?php if ($current_userEmployerID == 254 || $current_userEmployerID == 247 || $current_userEmployerID == 34 || $user_id == 1 || $user_id == 362) : ?>
                        <li class="nav-item hide <?php echo $site === "library" ? "active " : "";
                                                    if (!empty($current_userEmployeeID) or $current_userEmployeeID > 0) {
                                                        echo menu('library', $current_userEmployerID, $current_userEmployeeID);
                                                    } ?>">
                    ...
                    <?php if ($user_id <> 259 || $user_id <> 155) : ?>
                        <li class="nav-item hide <?php echo $site === "rvm" ? "active " : "";
                                                    if (!empty($current_userEmployeeID) or $current_userEmployeeID > 0) {
                                                        echo menu('rvm', $current_userEmployerID, $current_userEmployeeID);
                                                    } ?>">
                            <a href="rvm" class="nav-link">
                                <i class="icon-docs"></i>
                                <span class="title">RVM</span>
                    ...
                    <?php if ($switch_user_id <> 249) : ?>
                        <li class="nav-item hide <?php echo $site === "pmp" ? "active" : "";
                                                    if (!empty($current_userEmployeeID) or $current_userEmployeeID > 0) {
                                                        echo menu('pmp', $current_userEmployerID, $current_userEmployeeID);
                                                    } ?>">
                            ...
                            <li class="nav-item hide <?php echo $site === "Legal_Expert" || $site === "Critical_Operation" || $site === "Types_Of_Crisis" ? "active open start" : "";  ?>" id="menuCMAA">
                                ...
                                <ul class="sub-menu">
                                    <li class="nav-item <?php echo $site === "Legal_Expert" ? "active" : "";
                                                        if (!empty($current_userEmployeeID) or $current_userEmployeeID > 0) {
                                                            echo menu('Legal_Expert', $current_userEmployerID, $current_userEmployeeID);
                                                        } ?>">
                                    ...
                                    <li class="nav-item <?php echo $site === "Critical_Operation" ? "active" : "";
                                                        if (!empty($current_userEmployeeID) or $current_userEmployeeID > 0) {
                                                            echo menu('Critical_Operation', $current_userEmployerID, $current_userEmployeeID);
                                                        } ?> ?>">
                                    ...
                                    <li class="nav-item <?php echo $site === "Types_Of_Crisis" ? "active" : "";
                                                        if (!empty($current_userEmployeeID) or $current_userEmployeeID > 0) {
                                                            echo menu('Types_Of_Crisis', $current_userEmployerID, $current_userEmployeeID);
                                                        } ?>">
                                    ...
                                    <li class="nav-item <?php echo $site === "crisis_incidents" ? "active" : "";
                                                        if (!empty($current_userEmployeeID) or $current_userEmployeeID > 0) {
                                                            echo menu('crisis_incidents', $current_userEmployerID, $current_userEmployeeID);
                                                        } ?>">
                                    ...
                                    <li class="nav-item <?php echo $site === "crisis_annual_review" ? "active" : "";
                                                        if (!empty($current_userEmployeeID) or $current_userEmployeeID > 0) {
                                                            echo menu('crisis_annual_review', $current_userEmployerID, $current_userEmployeeID);
                                                        } ?>">
                                    ...
                                    <?php if ($user_id == 185) : ?>
                                        <li class="nav-item <?php echo $site === "crisis_testing_verification" ? "active" : "";
                                                            if (!empty($current_userEmployeeID) or $current_userEmployeeID > 0) {
                                                                echo menu('crisis_testing_verification', $current_userEmployerID, $current_userEmployeeID);
                                                            } ?>">
                    ...
                    if ($switch_user_id == 1479) {
                        echo '<li class="nav-item ';
                        echo $site === "forms" or $site === "module" ? "active" : "";
                        echo '">
                                <a href="javascript:;" class="nav-link nav-toggle">
                    ...
                    <?php if ($user_id == 185 || $user_id == 34 || $user_id == 42 || $user_id == 35 || $user_id == 88 || $user_id == 95 || $user_id == 228 || $user_id == 208) : ?>
                        <li class="nav-item <?php echo $site === "Task_Tracker" ? "active " : "";
                                            if (!empty($current_userEmployeeID) or $current_userEmployeeID > 0) { // echo menu('Task_Tracker', $current_userEmployerID, $current_userEmployeeID); 
                                            } ?>">
                    ...
                    <?php if ($user_id == 34) : ?>
                        <li class="nav-item <?php echo $site === "pto_request" ? "active" : "";
                                            if (!empty($current_userEmployeeID) or $current_userEmployeeID > 0) {
                                                echo menu('pto_requestt', $current_userEmployerID, $current_userEmployeeID);
                                            } ?>">
        ...
        <div class="page-content-wrapper">
            ...
            <div class="page-content">
                ...
                <div class="page-bar">
                    ...
                    <div class="page-toolbar <?php if ($site == '404' or $site == '505' or $site == 'dashboard' or $current_userEmployeeID > 0) {
                                                    echo 'hide';
                                                } else if (!isset($_COOKIE['switchAccount'])) {
                                                    if ($current_userEmployeeID > 0 and $current_userAdminAccess == 0 and $current_userID <> 532) {
                                                        echo 'hide';
                                                    }
                                                } ?>">
