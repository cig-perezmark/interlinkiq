...
<html lang="en">
    ...
    <head>
        ...
        <link rel="stylesheet" type="text/css" href="<?=$base_url?>assets/global/plugins/font-awesome/css/font-awesome.min.css" />
        <link rel="stylesheet" type="text/css" href="<?=$base_url?>assets/global/plugins/simple-line-icons/simple-line-icons.min.css" />
        ...
        <link href="<?=$base_url?>assets/global/plugins/bootstrap-editable/bootstrap-editable/css/bootstrap-editable.css" rel="stylesheet" type="text/css" />
        <link href="<?=$base_url?>assets/global/plugins/bootstrap-wysihtml5/bootstrap-wysihtml5.css" rel="stylesheet" type="text/css" />
        <link href="<?=$base_url?>assets/global/plugins/bootstrap-editable/inputs-ext/address/address.css" rel="stylesheet" type="text/css" />
        ...
        <link rel="shortcut icon" href="<?=$base_url?>assets/img/interlink icon.png" />
        ...
        <!--chat bot-->
        <link rel="stylesheet" href="<?=$base_url?>Chat_Bot/assets/style.css">
        <!--end chat bot-->
        <style type="text/css">
            <?php
                if (isset($_COOKIE['switchAccount'])) {
                    ...
                    if ( mysqli_num_rows($selectMenuAccess) > 0 ) {
                        ...
                        if ( mysqli_num_rows($selectMenuSubs) > 0 ) {
                            while($rowMenuSub = mysqli_fetch_array($selectMenuSubs)) {
                                ...
                                if ($sub_date_start_o <= $current_dateNow_o && $sub_date_end_o >= $current_dateNow_o) { $countRunning++; }
                            }

                            if ($countRunning > 0) { $FreeAccess = 0; }
                        }
                    }
                // } else {
                            ...
                            if ($current_client == 1) {
                                if ($switch_user_id == 27) {
                                    if(!empty($enterp_logo)) {
                                        echo '<a href="'.$base_url.'dashboard"><img src="'.$base_url.'companyDetailsFolder/'.$enterp_logo.'" height="60px" alt="logo" /></a>';
                                    } else {
                                        echo '<a href="'.$base_url.'dashboard"><img src="'.$base_url.'assets/img/Canna-OS-Logo_gear.png" height="60px" alt="logo" /></a>';
                                    }
                                } else {
                                    echo '<a href="'.$base_url.'dashboard"><img src="'.$base_url.'assets/img/Canna-OS-Logo_gear.png" height="60px" alt="logo" /></a>';
                                }
                                ...
                                if (isset($_COOKIE['switchAccount'])) {
                                    ...
                                    if(!empty($enterp_logo)) {
                                        ...
                                        echo '<a href="'.$base_url.'dashboard"><img src="'.$base_url.'assets/img/interlinkiq v3.png" height="60px" alt="logo" /></a>';
                                    }
                                }
                            }
                        ?>
                        ...
                        <div class="btn-group">
                            ...
                            <ul class="dropdown-menu" role="menu">
                                <?php if ($current_userType == 1) { ?>
                                    <li>
                                        <a href="<?=$base_url?>employee#new"><i class="icon-user"></i> Employee Roster</a>
                                    </li>
                                    <li>
                                        <a href="<?=$base_url?>job-description#new"><i class="icon-notebook"></i> Job Description</a>
                                    </li>
                                    <li>
                                        <a href="<?=$base_url?>trainings#new"><i class="icon-graduation"></i> Trainings</a>
                                    </li>
                                    <li>
                                        <a href="<?=$base_url?>department#new"><i class="icon-directions"></i> Department</a>
                                    </li>
                                    <li>
                                        <a href="<?=$base_url?>customer#new"><i class="icon-users"></i> Customer</a>
                                    </li>
                                    <li>
                                        <a href="<?=$base_url?>supplier#new"><i class="icon-basket-loaded"></i> Supplier</a>
                                    </li>
                    ...
                    <div class="top-menu">
                        ...
                        <ul class="nav navbar-nav pull-right">
                            <li class="dropdown dropdown-extended" id="googleTranslate">
                                ...
                                <script type="text/javascript">
                                    function googleTranslateElementInit() {
                                        new google.translate.TranslateElement({
                                            pageLanguage: 'en',
                                            autoDisplay: 'true',
                                            includedLanguages:'en,fr,zh-CN,zh-TW,ja,ko,es,it,pt,ar', 
                                ...
                                <script type="text/javascript">
                                    ...
                                    function translateLanguage(lang) {
                                        ...
                                        //     return false;
                                        // }
                                        if (lang == "English") { location.reload(); }
                                    ...
                                    if ($current_userEmployeeID == 129 OR $current_userEmployeeID == 128) {
                                        ...
                                        echo '<li class="dropdown dropdown-extended" id="speakup_employer">
                                            ...
                                            <ul class="dropdown-menu">
                                                <li class="external">
                                                    <h3 class="hide"><a href="'.$base_url.'#modalSpeakUp" data-toggle="modal" class="btn btn-success btn-xs xdropdown-toggle">Create New</a></h3>
                                                    <h3>SpeakUp!</h3>
                                                    <a href="'.$base_url.'#modalSpeakUpViewAll" data-toggle="modal" onclick="btnSpeakupAll('.$current_userEmployerID.')">view all</a>
                                                </li>';
                                                    ...
                                                    echo '<li>
                                                        <ul class="dropdown-menu-list speakupList" style="max-height: 275px; overflow: auto;">';
                                                            ...
                                                            while($rowSpeak = mysqli_fetch_array($selectSpeak)) {
                                                                ...
                                                                echo '<li>
                                                                    <a href="'.$base_url.'#modalSpeakUpView" data-toggle="modal" onclick="btnSpeakup('.$speak_ID.')" style="text-decoration: none;">
                                        ...
                                        echo '<li class="dropdown dropdown-extended" id="speakup_employee">
                                            ...
                                            <ul class="dropdown-menu">
                                                <li class="external">
                                                    <h3>SpeakUp!</h3>
                                                    <a href="'.$base_url.'#modalSpeakUp" data-toggle="modal">say something</a>
                            ...
                            <li class="dropdown dropdown-extended dropdown-notification" id="header_notification_bar">
                                <?php if($user_id == 35 || $user_id == 42 || $user_id == 163 || $user_id == 38 || $user_id == 88 || $switch_user_id == 34): ?>
                            ...
                            <li class="dropdown dropdown-extended dropdown-notification" id="header_notification_bar">
                                <?php if($user_id == 2 || $user_id == 13 || $user_id == 42 || $user_id == 44 || $user_id == 185 || $user_id == 95 || $user_id == 38): ?>
                            ...
                            <li class="dropdown dropdown-extended dropdown-notification" id="header_notification_bar">
                                ...
                                <ul class="dropdown-menu">
                                    ...
                                    <li class="external">
                                        <h3>
                                            <span class="bold">9 pending</span> for approval</h3>
                                        <a href="<?=$base_url?>page_user_profile_1.html">view all</a>
                                    </li>
                                    <li>
                                        <ul class="dropdown-menu-list scroller" style="height: 250px;" data-handle-color="#637283">
                                            <li>
                                                ...
                                                ?>
                                                <a href="<?=$base_url?>pto_request_for_approve.php">
                            ...
                            <li class="dropdown dropdown-extended dropdown-notification" id="header_notification_bar" >
                                <?php if($user_id == 108 OR $user_id == 1): ?>
                                 <a data-toggle="modal" data-target="<?=$base_url?>#modal_export" class="dropdown-toggle" >
                                    <i class="icon-cloud-upload"></i>
                                 </a>
                                 <?php endif; ?>
                            </li>
                            <li class="dropdown dropdown-extended dropdown-notification" id="header_notification_bar">
                                <?php if($user_id == 2 || $user_id == 1 || $user_id == 19): ?>
                                <a href="javascript:;" class="dropdown-toggle" data-toggle="dropdown" data-hover="dropdown" data-close-others="true">
                            ...
                            <?php } ?>
                                ...
                                <ul class="dropdown-menu">
                                    <li class="external">
                                        <h3>
                                            <span class="bold hide">12 pending</span> Notifications</h3>
                                        <a href="#">view all</a>
                                    </li>
                                    <li>
                                        <ul class="dropdown-menu-list scroller" style="height: 250px;" data-handle-color="#637283">
                                             <?php 
                                                ...
                                                {?>
                                            <li>
                                                <form action="<?=$base_url?>enterprise-function/export_users.php" method="POST" style="margin-top: 10px;">  
                                                <a style="text-decoration:none;" href="users-details-record.php">
                                             ...
                                             <?php 
                                                ...
                                                {?>
                                                <li>
                                                    <a href="<?=$base_url?>enterprise_record" style="text-decoration:none; padding: 0; margin-top: 10px;">
                                                        <span class="time" style="background-color:green; color:white; margin-right:20px;"><?php echo $row['count']; ?></span>
                                                        <span class="details">
                                                            <span class="label label-sm label-icon">
                                                                <button class="btn btn-xs btn-success" type="submit">
                                                                    <i class="fa fa-book"></i>
                                                                </button>
                                                            </span>Enterprise Record </span>
                                                    </a>
                                                </li>
                                                <?php } ?>
                                            <li class="hide">
                            ...
                            <li class="dropdown dropdown-extended dropdown-inbox hide" id="header_inbox_bar">
                                ...
                                <ul class="dropdown-menu">
                                    <li class="external">
                                        ...
                                        <a href="<?=$base_url?>app_inbox.html">view all</a>
                                    </li>
                                    <li>
                            ...
                            <li class="dropdown dropdown-user">
                                <a href="javascript:;" class="dropdown-toggle profile-avatar" data-toggle="dropdown" data-hover="dropdown" data-close-others="true">
                                    <?php
                                        if ( empty($current_userAvatar) ) {
                                            ...
                                            echo '<img src="'.$base_url.'uploads/avatar/'. $current_userAvatar .'" class="img-circle" alt="Avatar" />';
                                        }
                                    ?>
                                ...
                                <ul class="dropdown-menu dropdown-menu-default">
                                    <li>
                                        <a href="<?=$base_url?>profile"><i class="icon-user"></i> My Profile </a>
                                    </li>
                                    <?php if($user_id == 35 || $user_id == 42 || $user_id == 185 || $user_id == 38 || $user_id == 95): ?>
                                    <li>
                                        <a href="<?=$base_url?>executive_assistant_services"><i class="icon-layers"></i>Mgmt. Services </a>
                                    </li>
                                    <?php endif; ?>
                                    ...
                                    <?php // } ?>
                                    <li class="hide">
                                        <a href="<?=$base_url?>app_calendar.html"><i class="icon-calendar"></i> My Calendar </a>
                                    </li>
                                   <?php if ($current_userEmployerID == 34 || $user_id == 34) { ?>
                                        <li>
                                            <a href="<?=$base_url?>service_log_index.php"><i class="icon-pie-chart"></i> Service logs</a>
                                        </li>
                                   <?php } ?>
                                    <li class="hide">
                                        <a href="<?=$base_url?>app_inbox.html"><i class="icon-envelope-open"></i> My Inbox <span class="badge badge-danger">3</span></a>
                                    </li>
                                    <?php if ($current_userEmployerID == 34 || $user_id == 34) { ?>
                                    <li>
                                        <a href="<?=$base_url?>auto_service_log.php"><i class="icon-rocket"></i> Auto Logs <span class="badge badge-success myTask"></span></a>
                                    </li>
                                    <?php } ?>
                                    <li>
                                    ...
                                    <?php
                                        if ($current_userID == 34 || $current_userID == 163 || $current_userEmployerID == 27) {
                                            if ($current_userEmployeeID == 0 || ($current_userEmployeeID > 0 && $current_userAdminAccess == 1)) {
                                                echo '<li><a href="'.$base_url.'sidebar"><i class="icon-login"></i> Sidebar Setting</a></li>';
                                            }
                                        }
                                    ?>
                                    <li>
                                    ...
                                    <?php if ($current_userEmployerID == 1) { ?>
                                        <li><a href="<?=$base_url?>settings"><i class="icon-settings"></i> System Settings</a></li>
                                    <?php } ?>
                                    <?php if($switch_user_id == 34): ?>
                                        <li><a href="<?=$base_url?>#request_pto" data-toggle="modal"><i class="icon-calendar"></i> Request PTO</a></li>
                                    <?php endif; ?>
                                    <?php if ($user_id == 34) { ?>
                                        <li><a href="<?=$base_url?>pto_request.php" ><i class="icon-calendar"></i> PTO For Approval</a></li>
                                    <?php } ?>
                                    <?php if($switch_user_id == 34 && $user_id != 34 ): ?>
                                        <li><a href="<?=$base_url?>pto_request_for_approve.php"><i class="icon-calendar"></i> PTO For Approval</a></li>
                                    <?php endif ?>
                                    <?php if($switch_user_id == 34 && $user_id != 34 ): ?>
                                        <li><a href="<?=$base_url?>pto.php"><i class="icon-calendar"></i>My PTO Dashboard</a></li>
                                    <?php endif ?>
                                    <?php if ($user_id == 108 OR $user_id == 1 OR $user_id == 2 OR $user_id == 387 OR $user_id == 54 OR $user_id == 32) { ?>
                                    ...
                                    <?php if ($current_userEmployerID == 34) { ?>
                                        <li><a href="<?=$base_url?>payslip" ><i class="icon-wallet"></i> Payslip</a></li>
                                    <?php } ?>
                                    <?php if ($_COOKIE['ID'] == 108) { ?>
                                        <li><a href="<?=$base_url?>#generate_pto" data-toggle="modal"  ><i class="icon-wallet"></i> Generate PTO</a></li>
                                    <?php } ?>
                                    <?php if($switch_user_id == 34 && $user_id == 34 ): ?>
                                        <li><a href="<?=$base_url?>pto_tracker.php"><i class="icon-calendar"></i> PTO Tracker</a></li>
                                    <?php endif ?>
                                    <li>
                                        <a href="javascript:void(0)" onclick="btnLogout()"><i class="icon-key"></i> Log Out</a>
                                    </li>
                                </ul>
                            </li>
            ...
            <div class="page-sidebar-wrapper">
                ...
                <div class="page-sidebar navbar-collapse collapse">
                    ...
                    <ul class="page-sidebar-menu  page-header-fixed page-sidebar-menu-hover-submenux page-sidebar-menu-compact" data-keep-expanded="false" data-auto-scroll="true" data-slide-speed="200">
                        ...
                        <?php if($current_client == 0) { ?>
                            ...
                            <li class="nav-item <?php echo $site === "app-store" ? "active" : "";?>">
                                <a href="<?=$base_url?>app-store" class="nav-link">
                                    <i class="icon-grid"></i>
                            ...
                            <li class="nav-item">
                                ...
                                <ul class="sub-menu">
                                    <li class="nav-item">
                                        <a href="<?=$base_url?>survey" class="nav-link " target="_blank"  onclick="myfunction(<?= $current_userEmployerID; ?>)">
                                            <i class="fa fa-minus" style="font-size: 10px;"></i>
                                            <span class="title">Qualification Survey</span>
                                        </a>
                                    </li>
                                    <li class="nav-item">
                                        <a href="<?=$base_url?>e-forms/Sanitary_controller/Sanitary/gmp_food_v" class="nav-link " target="_blank" onclick="set_newCookie(<?= $switch_user_id; ?>)">
                                            <i class="fa fa-minus" style="font-size: 10px;"></i>
                        ...
                        <li class="nav-item <?php echo $site === "enterprise-info" ? "active open start" : ""; ?>">
                            <a href="javascript:;" class="nav-link nav-toggle">
                            ...
                            <ul class="sub-menu">
                                <li class="nav-item <?php echo $site === "enterprise-info" ? "active " : "";?>">
                                    <a href="<?=$base_url?>enterprise-info" class="nav-link ">
                                        <i class="fa fa-minus" style="font-size: 10px;"></i>
                                ...
                                <?php if($user_id==19 OR $user_id==1 OR $user_id==481 OR $user_id==963): ?>
                                 ...
                                 ">
                                    ...
                                    <a href="<?=$base_url?>risk_and_liabilities" class="nav-link ">
                                        <i class="fa fa-minus" style="font-size: 10px;"></i>
                                        <span class="title">Risk And Liabilities</span>
                                    </a>
                                </li>
                                <?php endif; ?>
                                <li class="nav-item hide hidden <?php echo $site === "enterprise-info-subscription" ? "active " : ""; ?>">
                        ...
                        <?php $query = mysqli_query( $conn,"SELECT * FROM tblEnterpiseDetails WHERE enterpriseOperation = 'Yes' AND users_entities = $switch_user_id " ); if ( mysqli_num_rows($query) > 0 ) { ?>
                            <li class="nav-item hide <?php echo $site === "facility-info" ? "active open start" : ""; ?>" id="menuFacility">
                                <a href="javascript:;" class="nav-link nav-toggle">
                                    <i class="icon-layers"></i>
                                        ...
                                        if ( mysqli_num_rows($queryFacility) > 0 ) {
                                            while($rowFacility = mysqli_fetch_array($queryFacility)) {
                                                echo '<li class="nav-item">
                                                    <a href="<?=$base_url?>facility-info?facility_id='.$rowFacility['facility_id'].'" class="nav-link ">
                                                        <i class="fa fa-minus" style="font-size: 10px;"></i>
                                                        <span class="title">'.$rowFacility['facility_category'].'</span>
                                                    </a>
                                                </li>';
                                            }
                                        }
                            ...
                            <li class="nav-item hide <?php echo $site === "employee" || $site === "job-description" || $site === "trainings" || $site === "department" || $site === "quiz" || $site === "training-requirements" ? "active open start" : ""; ?>" id="menuHR">
                                ...
                                <ul class="sub-menu">
                                    ...
                                    <li class="nav-item <?php echo $site === "job-description" ? "active " : "";?>">
                                        <a href="<?=$base_url?>job-description" class="nav-link ">
                                            <i class="fa fa-minus" style="font-size: 10px;"></i>
                                    ...
                                    <li class="nav-item <?php echo $site === "trainings" ? "active " : "";?>">
                                        <a href="<?=$base_url?>trainings" class="nav-link ">
                                            <i class="fa fa-minus" style="font-size: 10px;"></i>
                                            <span class="title">Trainings</span>
                                        </a>
                                    </li>
                                    <li class="nav-item <?php echo $site === "quiz" ? "active " : "";?>">
                                        <a href="<?=$base_url?>quiz" class="nav-link ">
                                            <i class="fa fa-minus" style="font-size: 10px;"></i>
                                            <span class="title">Comprehensive Quiz</span>
                                        </a>
                                    </li>
                                    <li class="nav-item <?php echo $site === "training-requirements" ? "active " : "";?>">
                                        <a href="<?=$base_url?>training-requirements" class="nav-link ">
                                            <i class="fa fa-minus" style="font-size: 10px;"></i>
                        ...
                        <li class="nav-item <?php echo $site === "customer" ? "active " : "";?>">
                        ...
                        <li class="nav-item <?php echo $site === "supplier" ? "active " : "";?>">
                        ...
                        <?php if($current_client == 0) { ?>
                            <li class="nav-item <?php echo $site === "Directory_Dashboard" ? "active " : ""; ?>">
                                <a href="<?=$base_url?>Directory_Dashboard" class="nav-link">
                                    <i class="icon-layers"></i>
                        ...
                        <?php if($current_client == 0 AND ($switch_user_id == 1 OR $switch_user_id == 34 OR $switch_user_id == 163)) { ?>
                            <li class="nav-item <?php echo $site === "listing" ? "active " : "";?>">
                                <a href="<?=$base_url?>listing" class="nav-link">
                        ...
                        <?php if($current_userEmployeeID == 0 OR $current_userID == 95 OR $current_userID == 42 OR $current_userID == 88) { ?>
                            <li class="nav-item <?php echo $site === "job-ticket" ? "active " : "";?>">
                                <a href="<?=$base_url?>job-ticket" class="nav-link">
                                    <i class="icon-earphones-alt"></i>
                            ...
                            <li class="nav-item <?php echo $site === "job-ticket-request" || $site === "job-ticket-service" ? "active open start" : ""; ?>">
                                ...
                                <ul class="sub-menu">
                                    <li class="nav-item <?php echo $site === "job-ticket-request" ? "active" : ""; ?>">
                                        <a href="<?=$base_url?>job-ticket-request" class="nav-link ">
                                            <i class="fa fa-minus" style="font-size: 10px;"></i>
                        ...
                        <?php
                            ...
                            //     if (!empty($menu_url)) {
                            //         $output = '<li class="nav-item '; if ($site == $menu_url) { $output .= 'active'; } $output .= '">
                            ...
                            //                         $output .= '<li class="nav-item '; if ($site == $menuDown_url) { $output .= 'active'; } $output .= '">
                    ...
                    //         }
                        ...
                        <li class="nav-item hide <?php echo $site === "form-owned" ? "active" : "";?>">
                            <a href="<?=$base_url?>form-owned" class="nav-link" disabled>
                                <i class="icon-graph"></i>
                                <span class="title">E-Forms</span>
                                <span class="selected"></span>
                            </a>
                        </li>
                        <li class="nav-item hide <?php echo $site === "archive" ? "active " : "";?>">
                            <a href="<?=$base_url?>archive" class="nav-link">
                                <i class="icon-folder-alt"></i>
                                <span class="title">Archive</span>
                                <span class="selected"></span>
                            </a>
                        </li>
                        <li class="nav-item hide <?php echo $site === "ffva" ? "active" : "";?>">
                            <a href="<?=$base_url?>ffva" class="nav-link">
                                <i class="icon-doc"></i>
                        ...
                        <?php if($current_client == 1): ?>
                            <li class="nav-item <?php echo $site === "emp" ? "active" : "";?>">
                                <a href="<?=$base_url?>emp_zone_list.php" class="nav-link">
                                    <i class="icon-clock"></i>
                                    <span class="title" style="color:yellow">EMP</span>
                                    <span class="selected"></span>
                                </a>
                            </li>
                        <?php  endif;?>
                        ...
                        <?php if($current_userEmployerID == 247 || $current_userEmployerID == 34 || $user_id == 34): ?>
                            <li class="nav-item hide <?php echo $site === "meeting_minutes" ? "active" : "";?>">
                                <a href="<?=$base_url?>meeting_minutes.php" class="nav-link">
                                    <i class="icon-clock"></i>
                        ...
                        <?php if($current_userEmployerID == 254 || $current_userEmployerID == 247 || $current_userEmployerID == 34 || $user_id == 34 || $user_id == 1 || $user_id == 185 || $user_id == 19 || $user_id == 155 || $user_id == 308 || $user_id == 189 || $user_id == 337): ?>
                            <li class="nav-item hide <?php echo $site === "MyPro" ? "active" : ""; ?>">
                                <a href="<?=$base_url?>MyPro" class="nav-link">
                                    <i class="icon-earphones-alt"></i>
                        ...
                        <?php if($current_client == 1): ?>
                            <li class="nav-item <?php echo $site === "MyPro" ? "active" : ""; ?>">
                                <a href="<?=$base_url?>test_MyPro" class="nav-link">
                                    <i class="icon-earphones-alt"></i>
                                    <span class="title">My Pro</span>
                                    <span class="selected"></span>
                                </a>
                        ...
                        <?php if($current_userEmployerID == 247 || $current_userEmployerID == 324 || $switch_user_id == 34 || $current_userEmployeeID == 34): ?>
                            <li class="nav-item hide <?php echo $site === "Customer_Relationship_Management" ? "active " : ""; ?>">
                                <a href="<?=$base_url?>Customer_Relationship_Management" class="nav-link">
                                    <i class="icon-users"></i>
                        ...
                        <?php if($user_id == 185 || $user_id == 34 || $user_id == 42 || $user_id == 35 || $user_id == 55 || $user_id == 54 || $user_id == 41 || $user_id == 32 || $user_id == 109): ?>
                            <li class="nav-item hide <?php echo $site === "Internal_Audit" ? "active " : ""; if (!empty($current_userEmployeeID) OR $current_userEmployeeID > 0) { // echo menu('Internal_Audit', $current_userEmployerID, $current_userEmployeeID); 
                                ...
                                <a href="<?=$base_url?>Internal_Audit" class="nav-link">
                                    <i class="icon-layers"></i>
                        ...
                        <?php if($current_userEmployerID == 247 || $current_userEmployerID == 34 || $user_id == 362): ?>
                            <li class="nav-item hide <?php echo $site === "inventory-management" ? "active" : "";?>">
                                <a href="<?=$base_url?>inventory-management" class="nav-link">
                                    <i class="icon-social-dropbox"></i>
                        ...
                        <?php if($current_userEmployerID == 254 || $current_userEmployerID == 247 || $current_userEmployerID == 34 || $user_id == 1 || $user_id == 362): ?>
                            <li class="nav-item hide <?php echo $site === "library" ? "active " : "";?>">
                                <a href="<?=$base_url?>library" class="nav-link">
                        ...
                        <?php if($user_id <> 259 || $user_id <> 155): ?>
                            <li class="nav-item hide <?php echo $site === "rvm" ? "active " : "";?>">
                                <a href="<?=$base_url?>rvm" class="nav-link">
                                    <i class="icon-docs"></i>
                        ...
                        <?php if($switch_user_id <> 249): ?>
                            <li class="nav-item hide <?php echo $site === "pmp" ? "active" : "";?>">
                                <a href="<?=$base_url?>pmp.php" class="nav-link">
                                    <i class="icon-layers"></i>
                        ...
                        <?php $query = mysqli_query( $conn,"SELECT * FROM tblEnterpiseDetails WHERE enterpriseEmployees = 'Yes' AND users_entities = $switch_user_id " ); if ( mysqli_num_rows($query) > 0 ) { ?>
                            <?php if($switch_user_id == 34 || $switch_user_id == 19): ?>
                                <li class="nav-item hide <?php echo $site === "Legal_Expert" || $site === "Critical_Operation" || $site === "Types_Of_Crisis" ? "active open start" : "";  ?>" id="menuCMAA">
                                    ...
                                    <ul class="sub-menu">
                                        <li class="nav-item <?php echo $site === "Legal_Expert" ? "active" : "";?>">
                                            <a href="<?=$base_url?>Legal_Expert" class="nav-link ">
                                                <i class="fa fa-minus" style="font-size: 10px;"></i>
                                                <span class="title">Legal & Expert</span>
                                            </a>
                                        </li>
                                        <li class="nav-item <?php echo $site === "Critical_Operation" ? "active" : "";?>">
                                            <a href="<?=$base_url?>Critical_Operation" class="nav-link ">
                                                <i class="fa fa-minus" style="font-size: 10px;"></i>
                                                <span class="title">Critical Operation</span>
                                            </a>
                                        </li>
                                        <li class="nav-item <?php echo $site === "Types_Of_Crisis" ? "active" : "";?>">
                                            <a href="<?=$base_url?>Types_Of_Crisis" class="nav-link ">
                                                <i class="fa fa-minus" style="font-size: 10px;"></i>
                                                <span class="title">Types Of Crisis</span>
                                            </a>
                                        </li>
                                        <li class="nav-item <?php echo $site === "crisis_incidents" ? "active" : "";?>">
                                            <a href="<?=$base_url?>crisis_incidents" class="nav-link ">
                                                <i class="fa fa-minus" style="font-size: 10px;"></i>
                                                <span class="title">Crisis Incidents</span>
                                            </a>
                                        </li>
                                        <li class="nav-item <?php echo $site === "crisis_annual_review" ? "active" : "";?>">
                                            <a href="<?=$base_url?>crisis_annual_review" class="nav-link ">
                                                <i class="fa fa-minus" style="font-size: 10px;"></i>
                                                <span class="title">Annual Review</span>
                                            </a>
                                        </li>
                                        <?php if($user_id == 185): ?>
                                            <li class="nav-item <?php echo $site === "crisis_testing_verification" ? "active" : "";?>">
                                                <a href="<?=$base_url?>crisis_testing_verification" class="nav-link ">
                                                    <i class="fa fa-minus" style="font-size: 10px;"></i>
                        ...
                        <li class="nav-item hide <?php echo $site === "researchandDev" ? "active" : ""; ?>">
                            <a href="<?=$base_url?>researchandDev" class="nav-link">
                        ...
                        <?php if($user_id == 185 || $user_id == 34 || $user_id == 42 || $user_id == 35 || $user_id== 88 || $user_id== 95 || $user_id== 228 || $user_id== 208): ?>
                            <li class="nav-item <?php echo $site === "Task_Tracker" ? "active " : ""; ?>">
                                <a href="<?=$base_url?>Task_Tracker" class="nav-link">
                                    <i class="icon-earphones-alt"></i>
                        ...
                        <?php if($user_id == 34): ?>
                            <li class="nav-item <?php echo $site === "pto_request" ? "active" : "";?>">
                                <a href="<?=$base_url?>pto_request" class="nav-link">
                                    <i class="icon-social-dropbox"></i>
