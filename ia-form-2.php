...
<html>
	...
	<body>
                                                    ...
                                                    foreach($ia_sheet_id_arr as $sheet_id) {
                                                        ...
                                                        if ( mysqli_num_rows($selectSheet) > 0 ) {
                                                            ...
                                                            echo '<li class="" id="li_'.$sheet_id.'">
                                                                ...
                                                                <a href="#tabSheet_'.$sheet_id.'" data-toggle="tab" aria-expanded="true" onClick="btnTabSheet('.$sheet_id.')">'.$sheet_name.' <i class="fa fa-pencil text-danger" data-toggle="modal" href="#modalViewSheet" onclick="btnViewSheet('.$sheet_id.', '.$modal.')"></i></a>
                                                            </li>';
                                                        }
                                                    }
                                                }
        ...
        <script type="text/javascript">
            ...
            function btnTabSheet(id) {
                var newTab = $('#tabSheet_'+id+' > table');
                if (newTab.length == 0) {
                    widget_uiBlock(id);
                    $.ajax({
                        type: "GET",
                        url: "function.php?modalTab_Sheet="+id,
                        dataType: "html",
                        success: function(data){
