...
<style>
    ...
    .gauge {
                                ...
                                <div class="portlet-body">
                                    <div class="tab-content">
                                        ...
                                        <div class="tab-pane" id="tabHistory">
                                            <table class="table table-bordered table-hover" id="tableDataHistory">
                                                <thead>
                                                    <tr class="bg-default">
                                                    ...
                                                    <?php
                                                        ...
                                                        if ( mysqli_num_rows($selectHistory) > 0 ) {
                                                            while($rowHistory = mysqli_fetch_array($selectHistory)) {
                                                                ...
                                                                $history_portal_user = $rowHistory['first_name'].' '.$rowHistory['last_name'];
                                                                $history_activity = $rowHistory['activity'];

                                                                $history_action = $rowHistory['action'];
                                                                $action = array(
                                                                    1 => 'Added New',
                                                                    2 => 'Updated the',
                                                                    3 => 'Deleted the',
                                                                ...
                                                                $history_page = $rowHistory['page'];
                                                                $page = array(
                                                                    1 => 'Template',
                                                                    2 => 'Form'
                                                                );

                                                                if ($history_page == 1) { $history_activity = $rowHistory['title']; }
                                                                else if ($history_page == 2) { $history_activity = $rowHistory['organization']; }

                                                                $history_last_modified = $rowHistory['last_modified'];
                                                                $history_last_modified = new DateTime($history_last_modified);
                                                                $history_last_modified = $history_last_modified->format('M d, Y');

                                                                echo '<tr>
                                                                    <td>'.$history_ID.'</td>
                                                                    <td>'.$history_portal_user.'</td>
                                                                    <td>'.$action[$history_action].' '.$page[$history_page].': '.$history_activity.'</td>
                                                                    <td class="text-center">'.$history_last_modified.'</td>
                                                                </tr>';
                                                            }
                                                        }
                                                    ?>
        ...
        <script type="text/javascript" src="assets/excel/tableExport.js"></script>
        ...
        <script type="text/javascript">
            ...
            $(".modalGenerate").on('submit',(function(e) {
                ...
                $.ajax({
                    url: "function_ia_new.php?btnType="+button,
                    type: "POST",
                    data: formData,
                    contentType: false,
                    processData:false,
            ...
            $(".modalEditForm").on('submit',(function(e) {
                ...
                var button = $('.modalEditForm').find("button[type=submit]:focus").attr("id");
                console.log(button);
                ...
                $.ajax({
                    url: "function_ia_update.php?btnType="+button,
                    type: "POST",
                    data: formData,
                    contentType: false,
                    processData:false,
                ...
                $.ajax({
                    ...
                    success:function(response) {
                        ...
                        if ($.trim(response)) {
                            ...
                            var obj = jQuery.parseJSON(response);
                            $("#modalNew .modal-body .tabbable .tab-content #tabSheet_"+obj.sheet_id+" table:not(#tableTemplate_"+obj.sheet_id+") tbody").html(obj.data);
