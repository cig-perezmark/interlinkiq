...
if(isset($_POST['key'])){
    ...
    if ($_POST['key'] == 'ids') {
        $i++;
       $response .= '
         <tr id="row_tblcustomer'; $response .= $i;  $response .= '">
            ...
            <td><button type="button" name="remove" id="'; $response .= $i;  $response .= '" class="btn btn-danger btn_remove_customer_row"><i class="fa fa-close"></i></button></td>
        </tr>
       ';
        }
   exit($response);
