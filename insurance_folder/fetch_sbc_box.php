...
if(isset($_POST['key'])){
    ...
    if ($_POST['key'] == 'ids') {
        $i++;
       $response .= '
         <tr id="row_tblsbc'; $response .= $i;  $response .= '">
            ...
            <td><button type="button" name="remove" id="'; $response .= $i;  $response .= '" class="btn btn-danger float-right btn_remove_sbc_row"><i class="fa fa-close"></i></button></td>
        </tr>
       ';
        }
   exit($response);
