   ...
   <div class=row>
      <div class="col-lg-12">
         <ul class="nav nav-tabs">
            <li><a data-toggle="tab" href="#sales_tab">Sales</a></li>
            <li><a data-toggle="tab" href="#production_tab">Production</a></li>
            <li><a data-toggle="tab" href="#warehouse_tab">Warehouse</a></li>
            <li><a data-toggle="tab" href="#purchases_tab">Purchase</a></li>
         </ul>

         <div class="tab-content">
            <div id="sales_tab" class="tab-pane fade">
            </div>

            <?php include_once("view_inventory_production.php"); ?>
