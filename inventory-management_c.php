        			            ...
        			            <tr id="row_supplier_<?= $row['id']; ?>">
        			                ...
        			                <td width="100px">
                                        <div class="btn-group btn-group-circle">
                                            <a  href="#modal_update_inventory" data-toggle="modal" type="button" id="update_inventory" data-id="<?= $row['id']; ?>" class="btn btn-outline dark btn-sm">Edit</a>
                        ...
                        <div class="alert alert-success display-hide">
                         ...
                         <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <select id="single-append-radio" class="form-control select2-allow-clear" onchange="search_filter(this.value)" name="manufacturer" placeholder="Company Name" required>
                                    <option></option>
                                    <?php
