...
<div class="modal fade" id="view_stock_card" role="dialog" tabindex="-1">
   <div class="modal-dialog modal-lg">
      ...
      <div class="modal-content">
         <div class="modal-header">
            <button type="button" class="close" data-dismiss="modal">&times;</button>
            <h4 class="modal-title text-center"><strong>Stock Card<strong></h4>
         </div>
         <div class="modal-body">
            <div class=container-fluid>
               ...
               <div class="row">
                  <form class="form-inline">
                     <div class="form-group">
                        ...
                        <input type="date" class="form-control" name="start_date" style="margin-left:8px;">
                     </div>
                     <div class="form-group">
                        <label style="margin-left:16px;">End Date</label>
                        <input type="date" class="form-control" name="end_date" style="margin-left:8px;">
                     </div>
                     <button style="margin-left:16px;" type="button" class="submit btn btn-default">Filter</button>
                  </form>
               </div>
               <div class="row">
