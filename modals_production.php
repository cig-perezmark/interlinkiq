...
<div class="modal fade" id="view_product_modal" role="dialog" tabindex="-1">
   <div class="modal-dialog modal-full">
      <!-- Modal content-->
      <div class="modal-content">
         <div class="modal-header">
            <button type="button" class="close" data-dismiss="modal">&times;</button>
            <h4 class="modal-title"><strong>Product Ingredient List<strong></h4>
         </div>
         <div class="modal-body">
            <div class=container-fluid>
               <form>
                  ...
                  <div class="row">
                     <?= create_el(2, "Order Date", '<input type="text" class="form-control" name="order_date" disabled>'); ?>
                     <?= create_el(2, "Sales Order No.", '<input type="text" class="form-control" name="sales_order" disabled>'); ?>
                     <?= create_el(6, "Customer Name", '<input type="text" class="form-control" name="customer_name" disabled>'); ?>
                     <?= create_el(2, "Delivery Deadline", '<input type="date" class="form-control" name="delivery_deadline" disabled>'); ?>
                  </div>
                  <div class="row">
                     <?= create_el(4, "Product Name", '<input type="text" class="form-control" name="product_name" disabled>'); ?>
                     <?= create_el(2, "Product Quantity", '<input type="text" class="form-control" name="quantity" disabled>'); ?>
                  </div>
               </form>
               <div class="row">
                  <div class=col-lg-12>
                     <div class="form-group">
                        ...
                        <table class="table table-bordered xtable-striped table-condensed">
                           <thead>
                              <tr>
                                 <th class=text-center width=10%>Batch/Lot Code</th>
                                 <th class=text-center>Raw Material Name</th>
                                 <th class=text-center>Supplier Name</th>
                                 <th class=text-center width=10%>Expiration Date</th>
                                 <th class=text-center width=10%>Quantity</th>
                                 <th class=text-center width=10%>Quantity<br> Received</th>
                                 <th class=text-center width=5%>UoM</th>
               ...
               <div class="row">
                  <?= create_el(12, "Remarks", '<textarea class=form-control name=remarks_for_products height=100></textarea>'); ?>
               </div>
               <div class="row mt-2">
                  <div class="col-lg-offset-4 col-lg-4">
                     <div id=view_product_sig_container class=text-center></div>  
                  </div>
               </div>
            </div>
         </div>
...
<div class="modal fade" id="view_processes_modal" role="dialog" tabindex="-1">
   <div class="modal-dialog modal-full">
      <!-- Modal content-->
      <div class="modal-content">
         <div class="modal-header">
            <button type="button" class="close" data-dismiss="modal">&times;</button>
            <h4 class="modal-title"><strong>Product Processes List<strong></h4>
         </div>
         <div class="modal-body">
            <div class=container-fluid>
               <form>
                  ...
                  <div class=col-lg-12>
                     <div class="form-group">
                        ...
                        <table class="table table-bordered xtable-striped table-condensed">
                           <thead>
                              <tr>
                                 <th class=text-center width=5%>Item Order</th>
                                 <th class=text-center width=30%>Process</th>
                                 <th class=text-center width=30%>Description</th>
                                 <th class=text-center width=25%>e-Forms</th>
                                 <th class=text-center width=10%>Status</th>
                              </tr>
                           </thead>
                           <tbody></tbody>
               ...
               <div class="row">
                  <?= create_el(12, "Remarks", '<textarea class=form-control name=remarks_for_processes height=100></textarea>'); ?>
               </div>
               <div class="row mt-2">
                  <div class="col-lg-offset-4 col-lg-4">
                     <div id=view_processes_sig_container class=text-center></div>  
                  </div>
               </div>
            </div>
         </div>
