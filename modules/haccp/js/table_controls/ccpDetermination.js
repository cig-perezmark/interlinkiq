tcTable.prototype.ccp_determination = function () {
    ...
    processes.forEach((id) => {
        ...
        let ccpIndicator = ccpCell.append(
            `<div style="text-align: center; margin: 0 0 1rem 0;" data-ccpindicator>${ccp.ccpNumber || ""}</div>`
        );
        ...
        const updCCPInput = () => {
            ...
            Object.entries(ccp).forEach(([key, val]) => {
                if (key == "B" || key == "C" || key == "P") {
                    (val.q1 == "y" && val.q2 == "y" && (isCCP = true)) ||
                        (val.q1 == "y" && val.q2 == "n" && val.q3 == "y" && val.q4 == "n" && (isCCP = true));
