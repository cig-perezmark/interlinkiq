...
if(isset($_GET['postId'])){
    ...
    <div class="form-group">
       <div class="col-md-12">
           ...
           <input class="form-control" name="CAI_filename" value="<?= $row['CAI_filename']; ?>" <?php if($row['data_type'] == 1): ?> <?php if($_COOKIE['ID'] == 34 OR $_COOKIE['ID'] == 387 OR $_COOKIE['ID'] == 32 OR $_COOKIE['ID'] == 54 OR $_COOKIE['ID'] == 38){echo'';}else{echo 'readonly';} ?><?php endif; ?>>
       </div>
   </div>
   <div class="form-group">
       <div class="col-md-12">
           <label>Description</label>
           <textarea class="form-control " name="CAI_description" id="your_summernotes2" rows="3"  >
               <?= $row['CAI_description']; ?>
            </textarea>
       </div>
    </div>
    ...
    <div class="form-group">
       <div class="col-md-6">
           ...
           <select class="form-control mt-multiselect btn btn-default" name="CAI_Accounts">
                ...
                <?php
                     $query_accounts = "SELECT * FROM tbl_service_logs_accounts where owner_pk = '$user_id' order by name ASC";
    ...
    <div class="form-group">
        <div class="col-md-6">
           ...
           <input type="date" class="form-control" name="CAI_Action_date" value="<?= date('Y-m-d', strtotime($row['CAI_Action_date'])); ?>" <?php if($row['data_type'] == 1): ?><?php if($_COOKIE['ID'] == 34 OR $_COOKIE['ID'] == 387 OR $_COOKIE['ID'] == 32 OR $_COOKIE['ID'] == 54 OR $_COOKIE['ID'] == 38){echo'';}else{echo 'readonly';} ?><?php endif; ?>>
       </div>
       <div class="col-md-6">
           <label><?php if($row['data_type'] == 1){echo 'End';}else{ echo'Due Date';} ?></label>
           <input type="date" class="form-control" name="CAI_Action_due_date" value="<?= date('Y-m-d', strtotime($row['CAI_Action_due_date'])); ?>" <?php if($row['data_type'] == 1): ?><?php if($_COOKIE['ID'] == 34 OR $_COOKIE['ID'] == 387 OR $_COOKIE['ID'] == 32 OR $_COOKIE['ID'] == 54 OR $_COOKIE['ID'] == 38){echo'';}else{echo 'readonly';} ?><?php endif; ?>>
       </div>
    </div>
    <?php if($row['data_type'] != 1): ?>
    <div class="form-group">
