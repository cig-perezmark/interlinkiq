...
if (isset($_POST['btnCreate_Project'])) { 
        ...
        $sql = "INSERT INTO tbl_MyProject_Services (Project_Name,Project_Description,Start_Date,Desired_Deliver_Date,Sample_Documents,Collaborator_PK,user_cookies,Project_status,Accounts_PK) 
        VALUES ('$Project_Name','$Project_Description','$Start_Date','$Desired_Deliver_Date','$Sample_Documents','$cCollaborator','$userID',0,'$h_accounts')";
...
if( isset($_POST['btnSave_AddChildItem']) ) {
            ...
            echo '
                        <tr id="sub_two_'.$rowData['CAI_id'].'" style="border:solid yellow 1px;">
                           ...
                           if(strlen($stringProduct) > 22):
                               ...
                               $stringProduct .='&nbsp;<a style="font-size:12px;" href="#modalGet_more_detail2" data-toggle="modal" onclick="get_moreDetails2('.$rowData['CAI_id'].')">
                           ...
                           echo '
                            ...
                            echo'</td>
                            <td class="child_2">'.$rowData['CAI_Rendered_Minutes'].$completed.'</td>
    ...
    // autologs
        ...
        $sql2= "INSERT INTO tbl_service_logs_draft (user_id,description,action,comment,account,task_date,minute) 
        VALUES ('$user_cookie','$filename','Created','$description','$CAI_Accounts','$today',2)";
...
if( isset($_POST['btnSave_AddChildItemb']) ) {
	...
	if (mysqli_query($conn, $sql)) {
    	...
    	//start here
    	$query_item2 = "SELECT * FROM tbl_MyProject_Services_Action_Items where Action_Items_id = $Action_taken";
        $result_item2 = mysqli_query($conn, $query_item2);
        while($row_item = mysqli_fetch_array($result_item2))
        { 
               $Action_taken2 = $row_item['Action_Items_name']; 
        } 
        
        //for overtime logs
        if($_POST['CIA_progress'] != 0 &&  $_POST['checked_choice'] == 'yes'):
        	$total_minute =0;
            $total = 0;
            $not_approved = 3;
            ...
            foreach($ot_query as $ot_row){
                ...
                $input_date = date('Y-m-d',strtotime($CAI_Action_due_date));
            ...
            $total_minute;
            $overall = $total_minute + $CAI_Estimated_Time;
        ...
        echo'
            ...
            <div class="form-group">
                ...
                <div class="col-md-6">
                   ...
                   <select class="form-control mt-multiselect btn btn-default" type="text" name="CAI_Action_taken">
                        <option value="">---Select---</option>
                        ';
                            $ai = $rowChildTask['CAI_Action_taken'];
                            $queryType = "SELECT * FROM tbl_MyProject_Services_Action_Items order by Action_Items_name ASC";
                            $resultType = mysqli_query($conn, $queryType);
                             while($rowType = mysqli_fetch_array($resultType))
                             {?> 
            ...
            <div class="form-group">
                <div class="col-md-12">
                    <label>Date Updated '; if($user_id == 34):  echo' (<i style="color:red;">Note:This will be reflected to your logs please check. Thank you</i>) '; endif; echo'</label>
                    <input type="date" class="form-control" name="date_updated" required>
                </div>
            </div>
        ';
        echo '
            ...
            <div class="col-md-12">
                <select class="form-control mt-multiselect btn btn-default" type="text" name="CAI_Assign_to" readonly>
                    ...
                    ';
                        ...
                        while($rowAssignto = mysqli_fetch_array($resultAssignto))
                        { ?>
                           <option value="<?php echo $rowAssignto['ID']; ?>" <?php if($rowAssignto['ID'] == $rowChildTask['CAI_Assign_to'] ){echo 'selected';}else{echo '';} ?>><?php echo $rowAssignto['first_name']; ?> <?php echo $rowAssignto['last_name']; ?></option>
                        <?php } 
    	...
    	$sql = "UPDATE tbl_MyProject_Services_Childs_action_Items  SET CAI_Assign_to = '$CAI_Assign_to',CAI_filename = '$CAI_filename',CAI_files ='$to_Db_files',CIA_progress = '$CIA_progress',CAI_description ='$CAI_description',CAI_Completed = '$CAI_Completed',CAI_Rendered_Minutes='$CAI_Rendered_Minutes',CAI_Accounts = '$CAI_Accounts',CAI_Action_date = '$CAI_Action_date',CAI_Action_due_date = '$CAI_Action_due_date',Date_Completed = '$date_updated',CAI_Action_taken='$CAI_Action_taken' where CAI_id = $ID";
     	if (mysqli_query($conn, $sql)) 
     	{
            ...
            $resultType = mysqli_query($conn, $queryType);
             while($rowType = mysqli_fetch_array($resultType))
             { 
                $taken = $rowType['Action_Items_name'];
           } 
            
    	    if($CAI_Assign_to == $user_cookie_emp){
    	        $sql2= "INSERT INTO tbl_service_logs_draft (user_id,description,action,comment,account,task_date,minute) 
                VALUES ('$user_cookie','$CAI_filename','$taken','$CAI_description','$CAI_Accounts','$date_updated','$CAI_Rendered_Minutes')";
                if(mysqli_query($conn, $sql2)){$last_id_log = mysqli_insert_id($conn);}
    	    }else{
                $sql2= "INSERT INTO tbl_service_logs_draft (user_id,description,action,comment,account,task_date,minute) 
...
if( isset($_GET['getId_2b']) ) {
    ...
    while($rowChildTask = mysqli_fetch_array($resultChildTask)) { 
        ...
        echo'
            ...
            <div class="form-group">
                <div class="col-md-12">
                    <label>Date Updated '; if($user_id == 34):  echo' (<i style="color:red;font-size:12px;">Note:This will be reflected to your logs please check. Thank you</i>) '; endif; echo'</label>
                    <input type="date" class="form-control" name="date_updated" required>
                </div>
            </div>
        ';
...
//$user_id = $_COOKIE['ID'];
        ...
        if (!empty($files)) {
        	...
        	$path = $path.$files;
        	move_uploaded_file($tmp,$path);
        }else{ $to_Db_files = $_POST['CAI_files2']; }
    	$sql = "UPDATE tbl_MyProject_Services_Childs_action_Items  SET CAI_Assign_to = '$CAI_Assign_to',CAI_filename = '$CAI_filename',CAI_files ='$to_Db_files',CIA_progress = '$CIA_progress',CAI_description ='$CAI_description',CAI_Completed = '$CAI_Completed',CAI_Rendered_Minutes='$CAI_Rendered_Minutes',CAI_Accounts = '$CAI_Accounts',CAI_Action_date = '$CAI_Action_date',CAI_Action_due_date = '$CAI_Action_due_date',Date_Completed = '$date_updated',CAI_Action_taken='$CAI_Action_taken' where CAI_id = $ID";
     	if (mysqli_query($conn, $sql)) 
     	{
     	    $ID = $_POST['ID'];
            ...
            if($CAI_Assign_to == $user_cookie_emp){
                ...
                $sql2= "INSERT INTO tbl_service_logs_draft (user_id,description,action,comment,account,task_date,minute) 
                VALUES ('$user_cookie','$filename','Update','$description','$h_accounts','$today',2)";
                if(mysqli_query($conn, $sql2)){$last_id_log = mysqli_insert_id($conn);}
            }
     	}
}
     		 ...
     		 //   $last_id = mysqli_insert_id($conn);
    			...
    			if ( mysqli_num_rows($selectData) > 0 )
    			{
            	   ...
            	   $render = $rowData['CAI_Rendered_Minutes'].' minute(s)';
                    ...
                    $acc = $rowData['CAI_Accounts'];
                    $add_btn = '<a style="font-weight:800;color:#fff;" href="#modalGetHistory_Child3b" data-toggle="modal" class="btn blue btn-xs" onclick="btnNew_History_Child3('.$rowData['CAI_id'].')">Add</a>';
                    $edit_btn = '<a style="font-weight:800;color:#fff;" href="#modalGet_child3b" data-toggle="modal" class="btn red btn-xs" onclick="onclick_3('.$rowData['CAI_id'].')">Edit</a>';
     		 ...
     		 //   $last_id = mysqli_insert_id($conn);
    			...
    			if ( mysqli_num_rows($selectData) > 0 )
    			{
            	   ...
            	   $render = $rowData['CAI_Rendered_Minutes'].' minute(s)';
                    ...
                    $acc = $rowData['CAI_Accounts'];
                    $add_btn = '<a style="font-weight:800;color:#fff;" href="#modalGetHistory_Child4b" data-toggle="modal" class="btn blue btn-xs" onclick="btnNew_History_Child4('.$rowData['CAI_id'].')">Add</a>';
                    $edit_btn = '<a style="font-weight:800;color:#fff;" href="#modalGet_child4b" data-toggle="modal" class="btn red btn-xs" onclick="onclick_4('.$rowData['CAI_id'].')">Edit</a>';
     		 ...
     		 //   $last_id = mysqli_insert_id($conn);
    			...
    			if ( mysqli_num_rows($selectData) > 0 )
    			{
            	   ...
            	   $render = $rowData['CAI_Rendered_Minutes'].' minute(s)';
                    ...
                    $acc = $rowData['CAI_Accounts'];
                    $edit_btn = '<a style="font-weight:800;color:#fff;" href="#modalGet_child5b" data-toggle="modal" class="btn red btn-xs" onclick="onclick_5('.$rowData['CAI_id'].')">Edit</a>';
        ...
        echo'
            ...
            <div class="form-group">
                ...
                <div class="col-md-6">
                    ...
                    <input class="form-control" type="hidden" name="files2" value="'.$row['files'].'">
                </div>
            </div>
            <div class="form-group">
                <div class="col-md-12">
            ...
            <div class="col-md-12">
                <select class="form-control mt-multiselect btn btn-default" type="text" name="Assign_to_history" readonly>
                    ...
                    ';
                        ...
                        while($rowAssignto = mysqli_fetch_array($resultAssignto))
                        { ?>
                           <option value="<?php echo $rowAssignto['ID']; ?>" <?php if($rowAssignto['ID'] == $row['Assign_to_history'] ){echo 'selected';}else{echo '';} ?>><?php echo $rowAssignto['first_name']; ?> <?php echo $rowAssignto['last_name']; ?></option>
                       <?php } 
        ...
        <div class="form-group">
            ...
            <label>Account</label>
                <select class="form-control mt-multiselect btn btn-default" type="text" name="CAI_Accounts" required>
                    <option value="">---Select---</option>
                    ';
                        $query_account = "SELECT * FROM tbl_service_logs_accounts where owner_pk = '$user_id' and  is_status = 0 order by name ASC";
...
if( isset($_GET['modalAddHistory_Child2b']) ) {
	$ID = $_GET['modalAddHistory_Child2b'];
	$today = date('Y-m-d');
	$last_sudId3 = '';
    $query_c = "SELECT * FROM  tbl_MyProject_Services_Childs_action_Items  where CIA_Indent_Id =$ID order by CAI_id DESC LIMIT 1";
    $result_c = mysqli_query($conn, $query_c);
...
if( isset($_POST['btnSave_AddChildItem_layer2b']) ) {
	...
	if (mysqli_query($conn, $sql)) {
        ...
        if($_POST['CIA_progress'] != 0 &&  $_POST['checked_choice'] == 'yes'):
            ...
            foreach($ot_query as $ot_row){
                ...
                $input_date = date('Y-m-d',strtotime($Action_date));
                $find_date = date('Y-m-d',strtotime($ot_row['task_date']));
            ...
            if($overall > 480){
                $user_cookie  = $_COOKIE['ID'];
                $sql_over= "INSERT INTO tbl_service_logs (user_id,description,action,comment,account,task_date,minute,not_approved,my_pro_id) 
                VALUES ('$user_cookie','$filename','$Action_taken2','$description','$CAI_Accounts','$Action_date','$CAI_Estimated_Time','$not_approved','$last_id')";
                if(mysqli_query($conn, $sql_over)){$last_id_log = mysqli_insert_id($conn);}
                exit;
            }
            else{
                $user_cookie  = $_COOKIE['ID'];
                $sql_auto= "INSERT INTO tbl_service_logs (user_id,description,action,comment,account,task_date,minute,my_pro_id) 
                VALUES ('$user_cookie','$filename','$Action_taken2','$description','$CAI_Accounts','$Action_date','$CAI_Estimated_Time','$last_id')";
                if(mysqli_query($conn, $sql_auto)){$last_id_log = mysqli_insert_id($conn);}
            }
        endif;
        ...
        if($_POST['CIA_progress'] != 0 &&  $_POST['checked_choice'] == 'no'):
            	...
            	$user_cookie  = $_COOKIE['ID'];
                $sql2= "INSERT INTO tbl_service_logs_draft (user_id,description,action,comment,account,task_date,minute) 
                VALUES ('$user_cookie','$filename','$Action_taken2','$description','$CAI_Accounts','$Action_date','$CAI_Estimated_Time')";
                if(mysqli_query($conn, $sql2)){$last_id_log = mysqli_insert_id($conn);}
        endif;
...
if( isset($_GET['modalAddHistory_Child3b']) ) {
	$ID = $_GET['modalAddHistory_Child3b'];
	$today = date('Y-m-d');
	$last_sudId4 = '';
    $query_c = "SELECT * FROM  tbl_MyProject_Services_Childs_action_Items  where CIA_Indent_Id =$ID order by CAI_id DESC LIMIT 1";
    $result_c = mysqli_query($conn, $query_c);
...
if( isset($_POST['btnSave_AddChildItem_layer3b']) ) {
        ...
        while($data2 = mysqli_fetch_array($result2))
         {
    		...
    		echo '<tr id="sub_four_'.$data2['CAI_id'].'">
                    ...
                    <td class="child_2">';
                        echo '<a style="font-weight:800;color:#fff;" href="#modalGetHistory_Child4b" data-toggle="modal" class="btn blue btn-xs" onclick="btnNew_History_Child4('.$data2['CAI_id'].')">Add</a>';
                        echo '<a style="font-weight:800;color:#fff;" href="#modalGet_child4b" data-toggle="modal" class="btn red btn-xs" onclick="onclick_4('.$data2['CAI_id'].')">Edit</a>';
                        echo '
                    </td>
                </tr>
    		';
...
if( isset($_GET['modalAddHistory_Child4b']) ) {
	$ID = $_GET['modalAddHistory_Child4b'];
	$today = date('Y-m-d');
	$last_sudId5 = '';
    $query_c = "SELECT * FROM  tbl_MyProject_Services_Childs_action_Items  where CIA_Indent_Id =$ID order by CAI_id DESC LIMIT 1";
    $result_c = mysqli_query($conn, $query_c);
...
if( isset($_POST['btnSave_AddChildItem_layer4b']) ) {
        ...
        while($data2 = mysqli_fetch_array($result2))
         {
    		...
    		echo '<tr id="sub_five_'.$data2['CAI_id'].'">
                    ...
                    <td class="child_2">';
                        echo '<a style="font-weight:800;color:#fff;" href="#modalGet_child5b" data-toggle="modal" class="btn red btn-xs" onclick="onclick_5('.$data2['CAI_id'].')">Edit</a>';
                        echo '
                    </td>
                </tr>
    		';
