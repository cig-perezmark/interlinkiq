       ...
       //layer 2
		...
		$response .= '
			<tr id="sub_two_'.$data2['CAI_id'].'" >
				...
				<td class="child_2a">'.$data2['CAI_Accounts'].'</td>
				<td class="child_2a">'.$data2['Action_Items_name'].'</td>
				<td class="child_2a">Assigned To: '.$data2['first_name'].'</td>
				<td class="child_2a">';
				if($data2['CIA_progress']== 1){ $response .= '<b>Inprogress</b>'; }
	            else if($data2['CIA_progress']== 2){ $response .= '<b>Completed</b>';}
	            else{ $response .= '<b>Not Started</b>';}
	            $response .= '</td>
	            <td class="child_2a">';
        	        $response .= 'Rendered: '.$data2['CAI_Rendered_Minutes'].' minute(s)';
				$response .= '
				</td>
				<td class="child_2a">Start: '.date("Y-m-d", strtotime($data2['CAI_Action_date'])).'</td>
				<td class="child_2a">Due: '.date("Y-m-d", strtotime($data2['CAI_Action_due_date'])).'</td>
					<td class="child_2a">
					';
    				...
    				<td class="child_2a" style="min-width:80px;">
    				';
                ...
                <td class="child_2a" style="min-width:100px;">';
		...
		$response .= '
			<tr id="sub_three_main'.$data3['CAI_id'].'">
				...
				<td class="child_2">Assigned To '.$data3['first_name'].'</td>
				<td class="child_2">';
				if($data3['CIA_progress']== 1){ $response .= '<b>Inprogress</b>'; }
	            else if($data3['CIA_progress']== 2){ $response .= '<b>Completed</b>';}
	            else{ $response .= '<b>Not Started</b>';}
	            $response .= '</td>
	            <td class="child_2">';
        	        $response .= 'Rendered: '.$data3['CAI_Rendered_Minutes'].' minute(s)';
				$response .= '
				</td>
		...
		$response .= '
			<tr id="sub_four_'.$data4['CAI_id'].'">
				...
				<td class="child_2">Assigned To '.$data4['first_name'].'</td>
				<td class="child_2">';
				if($data4['CIA_progress']== 1){ $response .= '<b>Inprogress</b>'; }
	            else if($data4['CIA_progress']== 2){ $response .= '<b>Completed</b>';}
	            else{ $response .= '<b>Not Started</b>';}
	            $response .= '</td>
	            <td class="child_2">';
        	        $response .= 'Rendered: '.$data4['CAI_Rendered_Minutes'].' minute(s)';
				$response .= '
				</td>
		...
		$response .= '
			<tr id="sub_five_'.$data5['CAI_id'].'">
				...
				<td class="child_2">Assigned To '.$data5['first_name'].'</td>
				<td class="child_2">';
				if($data5['CIA_progress']== 1){ $response .= '<b>Inprogress</b>'; }
	            else if($data5['CIA_progress']== 2){ $response .= '<b>Completed</b>';}
	            else{ $response .= '<b>Not Started</b>';}
	            $response .= '</td>
	            <td class="child_2">';
        	        $response .= 'Rendered: '.$data5['CAI_Rendered_Minutes'].' minute(s)';
				$response .= '
				</td>
		...
		$response .= '
			<tr id="sub_six_'.$data6['CAI_id'].'">
				...
				<td class="child_2">Assigned To: '.$data6['first_name'].'</td>
				<td class="child_2">';
				if($data6['CIA_progress']== 1){ $response .= '<b>Inprogress</b>'; }
	            else if($data6['CIA_progress']== 2){ $response .= '<b>Completed</b>';}
	            else{ $response .= '<b>Not Started</b>';}
	            $response .= '</td>
	            <td class="child_2">';
        	        $response .= 'Rendered: '.$data6['CAI_Rendered_Minutes'].' minute(s)';
				$response .= '
				</td>
                                    	...
                                    	<table style="table-layout: fixed; width: 100%;font-size:13px;">
                                    	    <tbody>
                                    	        <tr onclick="view_more('.$rowData['History_id'].')">
                                					...
                                					<th class="child_1">Assigned To '.$rowData['first_name'].'</th>
