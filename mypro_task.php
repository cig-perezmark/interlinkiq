                ...
                <div class="row">
                    <div class="form-group">
                        <div class="col-md-6">
                         ...
                         <div class="col-md-2">
                           <?php
                            ...
                            $Not_started = 1;
                            $ns_id = '';
                            $select_NS = mysqli_query( $conn,"SELECT * FROM tbl_MyProject_Services_Childs_action_Items where CIA_progress = 0 and Parent_MyPro_PK = '$project_id' and is_deleted = 0" );
                        ...
                        <?php
                            ...
                            $inprogress = 1;
                            $ip = 0;
                            $select_in = mysqli_query( $conn,"SELECT * FROM tbl_MyProject_Services_Childs_action_Items where CIA_progress = 1 and Parent_MyPro_PK = '$project_id' and is_deleted = 0" );
                         ...
                         <div class="col-md-2">
                            ...
                            $project_id = $_GET['view_id'];
                            $Completed = 1;
                            $select_Completed = mysqli_query( $conn,"SELECT * FROM tbl_MyProject_Services_Childs_action_Items where CIA_progress = 2 and Parent_MyPro_PK = '$project_id' and is_deleted = 0" );
