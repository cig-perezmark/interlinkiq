<?php
    ...
    // if ($current_minute == 0 AND $current_hour == 0) {
        ...
        $selectUser = mysqli_query( $conn,"SELECT first_name, last_name, email FROM tbl_user WHERE ID = 43 OR ID = 153 OR ID = 456 OR ID = 35 OR ID = 54 OR ID = 55 OR ID = 42 OR ID = 178 OR ID = 40" );
