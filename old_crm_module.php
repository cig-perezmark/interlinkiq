...
<style type="text/css">
            ...
            <div class="portlet light portlet-fit ">
                ...
                <div class="portlet-body">
                    ...
                    <div class="table-scrollable">
                        <div id="result_crm"></div>
                    </div>
                    <!--     <div style="overflow: scroll;width:100%;height:750px;"> -->
                    <!--    <table id="table_data_tr" class="table table-striped table-bordered table-hover dt-responsive" style="table-layout: fixed; width: 100%">-->
                    <!--        	<thead>-->
                    <!--                <tr>-->
                    <!--                    <th>Account Rep.</th>-->
                    <!--                    <th>Date</th>-->
                                ...
                                <div class="tab-content margin-top-20">
                                    ...
                                    <div class="tab-pane" id="tabContact_1">
                                        <div class="row">
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    <label class="control-label">Report o</label>
                                         ...
                                         <div class="row">
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                   ...
                                                   <select class="form-control" id="account_category" name="account_status">
    ...
    //         if(search != ""){
    //             $.ajax({
    //                 url:'Customer_Relationship_Folder/fetch_crm_data.php',
    //                 method: 'POST',
    //                 data: {search:search},
    //                 success:function(data){
...
//--------------
    $(document).ready(function(){
         ...
         {
          $.ajax({
           url:"Customer_Relationship_Folder/fetch_contacts.php",
           method:"POST",
           data:{query:query},
           success:function(data)
           {
            $('#result_crm').html(data);
           }
          });
         }
