                                ...
                                <thead>
                                        <tr style="text-align:center">
                                            <td rowspan="2" colspan="2" width="200">
                                                <img src="https://interlinkiq.com/companyDetailsFolder/logo_cargo.gif" alt="Interlinkiq Logo" height="100">
                                            </td>
                                            <td>
                                        ...
                                        <tr>
                                            <td colspan="2">
                                                Name: &nbsp;&nbsp; Emmanuel Alexis Castil Quiapo<br> <br>
                                                Employee ID : &nbsp;&nbsp; 001124<br><br>
                                                Position : &nbsp;&nbsp; Safety Assistant <br><br>
                                ...
                                <tbody>
                                        ...
                                        <tr>
                                            <td colspan="2" rowspan="3" >
                                                Gross Pay to Date :  &nbsp;&nbsp; <?= "$" ?>240 <br><br>
                                                Year to Date Gross Pay : $960
                                                <br>
                                                <?= "Notes:" ?><?php
