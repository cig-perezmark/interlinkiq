<?php
    ...
    $selectLibrary= mysqli_query( $conn,"
        SELECT
        *,
        CASE WHEN ar3.ar_applicable = 0 OR ar3.ar2_applicable = 0 OR ar3.ar3_applicable = 0 OR ar3.aro_applicable = 0 OR ar3.arc_applicable = 0 THEN 0 ELSE 1 END AS applicable
        FROM (
            SELECT
            *,
            ...
            FROM (
                ...
                ar.r_applicable AS ar_applicable,
                ar.r2_applicable AS ar2_applicable,
                ar.r3_applicable AS ar3_applicable,
                aro.applicable AS aro_applicable,
                arc.applicable AS arc_applicable,
    ...
    if ( mysqli_num_rows($selectLibrary) > 0 ) {
        while($rowLibrary = mysqli_fetch_array($selectLibrary)) {
            ...
            $applicable = $rowLibrary["applicable"];
            ...
            if (!empty($compliance_requirement)) {
                $compliance_sum++;
            }
            
            if ($compliant == 0 AND $applicable == 1) {
                ...
                $html_full .= '<tr class="'.$l_type.'">
                    ...
                    <td style="text-align: center;"><input type="checkbox" onclick="return false" '; $html_full .= ($compliant != 1 AND $applicable == 0) ? 'checked="checked"':''; $html_full .= ' readonly /></td>
                    <td>
                        <strong>'.$aro_title.'</strong><br>'.$aro_comment;
        ...
        if ($compliance_sum > 0) {
            $compliance_total = ($compliance_qty / $compliance_sum) * 100;
        }
    }
	$html_company = '';
	...
	$html = '<html>
	    ...
	    <body>
	        ...
	        <table width="100%" cellpadding="7" cellspacing="0" border="1">
	            ...
	            <tr>
	                <td><strong>Compliance Percentage</strong></td>
	                <td>'.round($compliance_total, 2).' %</td>
	            </tr>
	        </table>
	        ...
	        <table width="100%" cellpadding="7" cellspacing="0" border="0">
	            <tr>
	                ...
	                <td style="width: 30%;">
	                    <img src="'.$l_approver_signature.'" class="signature_img" style="display: block; border: 0; border-bottom: 1px solid; object-fit: contain; max-width: 300px; max-height: 100px;" />
	                    '.$l_auditor_name.'<br>
	                    Auditor, Compliance
	                </td>
	                ...
	                <td style="width: 30%;">
	                    <img src="'.$l_reviewer_signature.'" class="signature_img" style="display: block; border: 0; border-bottom: 1px solid; object-fit: contain; max-width: 300px; max-height: 100px;" />
