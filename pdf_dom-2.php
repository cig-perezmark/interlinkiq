<?php
    ...
    $selectData = mysqli_query( $conn,"SELECT
        ...
        f.final_audit,
        f.cert_valid,
        f.date_review_started,
        f.date_review_finished,
        f.total_time_review,
        f.date_inspection_started,
        f.date_inspection_finished,
        f.total_time_inspection,
        f.preliminary_audit,
        f.final_audit,
        f.score_type,
        f.score_result,
        ...
        $html .= '<html>
            ...
            <body>
                <p style="text-align: center;">
                    ...
                    <b>'.stripcslashes($rowForm['title']).'</b><br>
                ...
                <table style="page: cover; page-break-after: always;" cellpadding="7" cellspacing="0" border="1" nobr="true" width="100%" >
                    ...
                    <tr>
                        ...
                        <td>'.stripcslashes($rowForm['date_start']).'</td>
                    </tr>
                    <tr>
                        <td style="background-color: #e1e5ec;">Date End</td>
                        <td>'.stripcslashes($rowForm['date_end']).'</td>
                    </tr>
                    <tr>
                ...
                // $pdf->AddPage('L');
                $html .= '<table cellpadding="7" cellspacing="0" border="1" nobr="true" style="width: 100%;">';
    ...
    // $dompdf->stream();
    $dompdf->stream($rowForm['title'].'-'.date('Ymd'), array("Attachment" => 0));
?>