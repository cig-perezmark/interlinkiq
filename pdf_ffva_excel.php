<?php
    ...
    <table cellpadding="7" cellspacing="0" border="1" style="background-color: #a8d08d;">
        <tr>
            <td colspan="7" style="text-align: center;"><b>Prevention and Deterrence Controls</b></td>
        </tr>
    </table>
    <p></p>
    <table cellpadding="7" cellspacing="0" border="1" style="background-color: #a8d08d;">
        <tr>
            <td colspan="7"><b>Prevention</b></td>
        </tr>';
    ...
    //             <tr>
    //                 <td colspan="7"><b>Is there an approved supplier program and verification process (e.g., COA, country of origin)?</b></td>
    //             </tr>';
    ...
    //                         $html .= '</td>
    //                         <td colspan="6" style="width: 95%;">'.$approved_name.'</td>
    //                     </tr>';
    //                 }
    //             }
    ...
    //         <table cellpadding="7" cellspacing="0" border="1" style="background-color: #a8d08d; width: 100%;">
    //             <tr>
    //                 <td colspan="7"><b>Is routine lab testing for authenticity and contaminants conducted on this material?</b></td>
    //             </tr>';
    ...
    //                         $html .= '</td>
    //                         <td colspan="6" style="width: 95%;">'.$routine_name.'</td>
    //                     </tr>';
    //                 }
    //             }
    ...
    //         <table cellpadding="7" cellspacing="0" border="1" style="background-color: #a8d08d; width: 100%;">
    //             <tr>
    //                 <td colspan="7"><b>Are supplier audits conducted regularly and documented?</b></td>
    //             </tr>';
    ...
    //                         $html .= '</td>
    //                         <td colspan="6" style="width: 95%;">'.$supplier_name.'</td>
    //                     </tr>';
    //                 }
    //             }
    ...
    $html .= '<table id="exTable" cellpadding="7" cellspacing="0" border="1" style="text-align: center;">';
        if ($signed == 1) {
            $html .= '<tr>
