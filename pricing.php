    ...
    a:hover { text-decoration: none; color: rgb(72, 103, 126) !important; }
                    ...
                    <div style="text-align:right;">
                        ...
                        <button type="button" class="btn btn-primary" href="#modalView" data-toggle="modal" class="modalNew">
                           Add New Pricing &nbsp; <i class="fa fa-plus-square-o" aria-hidden="true"></i>
                        </button>
                    ...
                    <div class="row" id="main-box">
                        ...
                        <div id="dataRow">
                            ...
                            <?php
                                $selectData = mysqli_query( $conn,"SELECT * FROM tbl_pricing WHERE deleted = 0 ORDER BY name ASC" );
                                if ( mysqli_num_rows($selectData) > 0 ) {
                                    while($rowData = mysqli_fetch_array($selectData)) {
                                        ...
                                        echo '<div class="col-md-2 margin-bottom-15 card" id="div_'.$data_ID.'">';
                        ...
                        <?php 
                            $selectDataPricing = mysqli_query( $conn,"SELECT * FROM tbl_pricing WHERE deleted = 0 AND status = 1 ORDER BY name ASC" );
                            if ( mysqli_num_rows($selectDataPricing) > 0 ) {
                                while($rowData = mysqli_fetch_array($selectDataPricing)) {
                                    $data_name = $rowData['name'];
                                    $data_ID = $rowData['ID'];
                                ...
                                <form method="post" class="form-horizontal modalForm modalView">
                                    ...
                                    <div class="modal-body">
                                        <div class="form-group">
                                            <label class="col-md-3 control-label">Pricing Name</label>
                                            <div class="col-md-8">
                                    ...
                                    <div class="modal-footer">
                                        ...
                                        <button type="submit" class="btn green ladda-button" name="btnSave_Pricing" id="btnSave_Pricing" data-style="zoom-out"><span class="ladda-label">Submit</span></button>
                                    </div>
                                </form>
                            </div>
                        </div>
                    </div>
                    <div class="modal fade" id="modalPricing" tabindex="-1" role="dialog" aria-hidden="true">
                        <div class="modal-dialog modal-full">
                            <div class="modal-content">
                                <form method="post" class="form-horizontal modalForm modalPricing">
        ...
        <script>
            ...
            function btnDelete(id) {
                swal({
                    ...
                    $.ajax({
                        type: "GET",
                        url: "function.php?btnDelete_Pricing="+id,
                        dataType: "html",
                        success: function(response){
                            $('#div_'+id).remove();
                        }
            ...
            function btnView(frequency) {
                $.ajax({
                    type: "GET",
                    url: "function.php?modalPricing="+frequency,
                    dataType: "html",
                    success: function(data){
                        $("#modalPricing .modal-body").html(data);
                        widget_date();
                    }
                });
            }
