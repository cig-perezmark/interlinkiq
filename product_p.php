                                    ...
                                    <div class="actions">
                                        <div class="btn-group">
                                            ...
                                            <ul class="dropdown-menu pull-right">
                                                <li>
                                                    <a id="addProduct-modal-btn" data-toggle="modal" data-target="#addProduct-modal" > Add New Products</a>
                                                </li>
                                                <li class="divider"> </li>
                                                <li>
                                ...
                                <div class="portlet-body">
                                    <div class="table-scrollable hide">
                                        <table class="table table-bordered table-hover" id="tableData">
                                            ...
                                            <tbody>
                                                <?php
                                                    $result = mysqli_query( $conn,"SELECT * FROM tbl_products WHERE deleted = 0 AND user_id = $current_userID" );
                                            ...
                                            if ( mysqli_num_rows($result) > 0 ) {
                                                while($row = mysqli_fetch_array($result)) {
                                                    ...
                                                    echo '<div class="mt-action" id="mt_action_'. $row["ID"] .'">
                                                        <div class="mt-action-img"><img src="uploads/products/'. $row["files"] .'" style="width: 40px; height: 40px; object-fit: cover; object-position: center;" /></div>
                                ...
                                <div class="modal-content">
                                    <form method="post" enctype="multipart/form-data" class="form-horizontal modalForm modalSave">
                                        ...
                                        <div class="modal-footer">
                                            ...
                                            <input type="submit" class="btn green" name="btnSave_Products" id="btnSave_Products" value="Save" />
                                        </div>
                                    </form>
                                </div>
                            </div>
                            ...
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    <form method="post" enctype="multipart/form-data" class="form-horizontal modalForm modalUpdate">
                                        ...
                                        <div class="modal-footer">
                                            <input type="button" class="btn dark btn-outline" data-dismiss="modal" value="Close" />
                                            <input type="submit" class="btn green" name="btnUpdate_Products" id="btnUpdate_Products" value="Save" />
                                        </div>
                                    </form>
                                </div>
                            </div>
