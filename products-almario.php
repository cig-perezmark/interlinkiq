                                    ...
                                    <div class="actions">
                                        <div class="btn-group">
                                            ...
                                            <ul class="dropdown-menu pull-right">
                                                <li>
                                                    <a data-toggle="modal" href="#modalNew" >Add New Products</a>
                                                </li>
                                                            ...
                                                            <div class="mt-action-row">
                                                                <div class="mt-action-info ">
                                                                    <div class="mt-action-details ">
                                                                        <span class="mt-action-author">'. $row["name"] .'</span>
                                                                        <p class="mt-action-desc">'. $row["description"] .'</p>
                                                                    </div>
                                                                </div>
                                        ...
                                        <div class="modal-body">
                                            <div class="tabbable tabbable-tabdrop">
                                                ...
                                                <ul class="nav nav-tabs">
                                                    ...
                                                    <li>
                                                        <a href="#tabProductDescription" data-toggle="tab">Product Description</a>
                                                    </li>
                                                    <li>
                                                ...
                                                <div class="tab-content margin-top-20">
                                                            ...
                                                            <div class="col-md-3">
                                                                <div class="form-group">
                                                                    ...
                                                                    <select class="form-control" name="vendor_code">
                                                                        <option value="" selected disabled>--Select vendor code--</option>
                                                                    </select>
                                                                </div>
                                                            </div>
                                                            <div class="col-md-3">
                                                                <div class="form-group">
                                                                    ...
                                                                    <select class="form-control" class="vendor_name">
                                                    ...
                                                    <div class="tab-pane" id="tabAllergens">
                                                        ...
                                                        <div class="row">
                                                            <div class="col-md-4">
                                                                <div class="form-group">
                                                                    <div class="mt-checkbox-list">
                                                                        ...
                                                                        <label class="mt-checkbox mt-checkbox-outline"> Egg
                                                            ...
                                                            <div class="col-md-4">
                                                                <div class="form-group">
                                                                    <div class="mt-checkbox-list">
                                                                        <label class="mt-checkbox mt-checkbox-outline"> Tree nuts (e.g., almonds, walnuts, peca)
                                                    ...
                                                    <div class="tab-pane" id="tabManufacturing">
                                                        ...
                                                        <div class="row hide" data-manufacturing-details="[27,28]">
                                                            ...
                                                            <div class="col-md-3">
                                                                <div class="form-group">
                                                                    <label class="control-label">Manunfactured Date</label>
                                                    ...
                                                    <div class="tab-pane" id="tabProductDescription">
                                                        ...
                                                        <div class="row">
                                                            <div class="col-md-4">
                                                                <div class="form-group">
                                                                    <label class="control-label">Physical Characteristics </label>
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        if ($.trim(response)) {
                            ...
                            var html = '<div class="mt-action" id="mt_action_'+obj.ID+'">';
                                html += '<div class="mt-action-img"><img src="'+obj.image+'" style="width: 40px; height: 40px; object-fit: cover; object-position: center;" /></div>';
                                html += '<div class="mt-action-body">';
                                    html += '<div class="mt-action-row">';
                                        html += '<div class="mt-action-info ">';
                                            html += '<div class="mt-action-details ">';
                                                html += '<span class="mt-action-author">'+obj.name+'</span>';
                                                html += '<p class="mt-action-desc">'+obj.description+'</p>';
                                            html += '</div>';
                                        html += '</div>';
                                        html += '<div class="mt-action-datetime" style="width: 150px;">';
                                            html += '<span class="label label-sm label-success btn-circle">'+obj.category+'</span>';
                                        html += '</div>';
                                        ...
                                        html += '<div class="mt-action-buttons ">';
                                           html += ' <div class="btn-group btn-group-circle">';
                                                html += '<a href="#modalView" data-toggle="modal" data-id="'+obj.ID+'" class="btn btn-outline dark btn-sm btnView" onclick="btnView('+obj.ID+')">View</a>';
                                                html += '<a href="javascript:;" class="btn btn-outlinex red btn-sm btnDelete" data-id="'+obj.ID+'" onclick="btnDelete('+obj.ID+')">Delete</a>';
                                            html += '</div>';
                                        html += '</div>';
                                    html += '</div>';
                                html += '</div>';
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        if ($.trim(response)) {
                            ...
                            var data = '<div class="mt-action-img"><img src="'+obj.image+'" style="width: 40px; height: 40px; object-fit: cover; object-position: center;" /></div>';
                            data += '<div class="mt-action-body">';
                                data += '<div class="mt-action-row">';
                                    data += '<div class="mt-action-info ">';
                                        data += '<div class="mt-action-details ">';
                                            data += '<span class="mt-action-author">'+obj.name+'</span>';
                                            data += '<p class="mt-action-desc">'+obj.description+'</p>';
                                        data += '</div>';
                                    data += '</div>';
                                    data += '<div class="mt-action-datetime" style="width: 150px;">';
                                        data += '<span class="label label-sm label-success btn-circle">'+obj.category+'</span>';
                                    data += '</div>';
                                    data += '<div class="mt-action-datetime ">';
                                        data += '<span class="mt-action-date">'+obj.last_modified+'</span>';
                                    data += '</div>';
                                    data += '<div class="mt-action-buttons ">';
                                        data += '<div class="btn-group btn-group-circle">';
                                            data += '<a href="#modalView" data-toggle="modal" data-id="'+obj.ID+'" class="btn btn-outline dark btn-sm btnView" onclick="btnView('+obj.ID+')">View</a>';
                                            data += '<a href="javascript:;" class="btn btn-outlinex red btn-sm btnDelete" data-id="'+obj.ID+'" onclick="btnDelete('+obj.ID+')">Delete</a>';
                                        data += '</div>';
                                    data += '</div>';
                                data += '</div>';
                            data += '</div>';

                            $('#mt_action_'+obj.ID).html(data);
