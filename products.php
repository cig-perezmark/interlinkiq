                                ...
                                productDT.row.add([
                                    `
                                        <div style="display: flex; gap:1rem;">
                                            <img src="${d.image}" onerror="this.onerror=null;this.src=\'https://via.placeholder.com/40x40/EFEFEF/AAAAAA.png?text=no+image\';" style="width: 40px; height: 40px; object-fit: cover; object-position: center;" />
                                            <div>
