                                ...
                                <div class="portlet-body">
                                    <div class="tab-content">
                                        <div class="tab-pane active" id="tabProduct">
                                            <a href="#modalNew" data-toggle="modal" onclick="btnReset('modalNew')" class="btn btn-success margin-bottom-15 pull-right">Add New Products</a>
                                            ...
                                            <table class="table table-bordered table-hover" id="productsTable">
                                                <thead>
                                                    <tr>
                                                        ...
                                                        <th style="width: 150px;">Code/ID</th>
                                        ...
                                        <div class="tab-pane" id="tabFormulation">
                        ...
                        if(Array.isArray(data) && data.length) {
                            ...
                            data.forEach((d) => {
                                productDT.row.add([
                                    ...
                                    `<span>${d.code}</span>`,
                                    `<span class="text-center text-muted">${d.last_update}</span>`,
                                    `
                                        <div class="btn-group btn-group-circle" style="position: unset;">
                                            ...
                                            <input type="button" class="btn btn-sm btn-info" value="Print" onclick="window.open(&quot;print_product_info.php?id=${d.id}&quot;)">
