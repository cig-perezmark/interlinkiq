<!-- BEGIN PROFILE SIDEBAR -->
                            <div class="profile-sidebar">
                                    ...
                                    <div class="profile-usermenu">
                                        <ul class="nav">
                                            <li class="<?php echo $site === 'profile' ? 'active' : ''; ?>">
                                                <a href="profile"><i class="icon-home"></i> Personal Dashboard</a>
                                            </li>
                                            <li class="<?php echo $site === 'profile-setting' ? 'active' : ''; ?>">
                                                <a href="profile-setting"><i class="icon-settings"></i> My Profile</a>
                                            </li>
                                            
                                            <?php
                                                if ($current_client == 0) {
                                                    echo '<li class="'; echo $site === 'profile-job' ? 'active' : ''; echo '">
                                                        <a href="profile-job"><i class="icon-briefcase"></i> Specialist / Job Seeker</a>
                                                    </li>';
                                                }
                                            ?>
                                            
                                            <li class="hide <?php echo $site === 'profile-help' ? 'active' : ''; ?>">
                                                <a href="profile-help"><i class="icon-info"></i> Help</a>
                                            </li>
                                        </ul>
                                    </div>
                                    <!-- END MENU -->
                                        ...
                                        <div class="modal-content">
                                            <form method="post" enctype="multipart/form-data" class="form-horizontal modalProject">
                                                                                    ...
                                                                                    while($rowProject = mysqli_fetch_array($selectProject)) {
                                                                                        ...
                                                                                        echo '<tr id="tr_'. $rowProject["ID"] .'">
                                                                                            <td class="mt-element-ribbon">';
                                                                                                ...
                                                                                                echo '<b>'. htmlentities($rowProject["project"] ?? '') .'</b></br>
                                                                                                <span><b>Assigned To: </b><i>'. $data_assigned_to_id .'</i></span></br>
                                                                                                <span><b>Due Date: </b><i>'. htmlentities($rowProject["due_date"] ?? '') .'</i></span></br>
                                                                                                <span><b>Remarks: </b><i>';
                                                                                                    ...
                                                                                                    if ( empty($rowProject["remarks"]) ) {
                                                                                                        ...
                                                                                                        echo '<span>'. htmlentities($rowProject["remarks"] ?? '') .'</span>';
                                                                                                    }
                                                ...
                                                <div class="modal-footer">
                                                    ...
                                                    <input type="reset" class="btn dark" name="btnReset_USER_Project" id="btnReset_USER_Project" value="Reset" />
                                    ...
                                    <div class="modal-dialog modal-lg">
                                        <div class="modal-content">
                                            <form method="post" enctype="multipart/form-data" class="form-horizontal modalTask">
                                                ...
                                                <div class="modal-footer">
                                                    <input type="button" class="btn dark btn-outline" data-dismiss="modal" value="Close" />
                                                    <input type="reset" class="btn dark" name="btnReset_USER_Task" id="btnReset_USER_Task" value="Reset" />
                                ...
                                <!-- PORTLET MAIN -->
                                <div class="portlet light <?php echo $current_client == 0 ? '':'hide'; ?>">
                                    <!-- STAT -->
                                    ...
                                    <div>
                                        ...
                                        <div class="margin-top-20 profile-desc-link <?php echo empty($current_userLinkedIn) ? "display-hide" : ""; ?>">
                                            ...
                                            <a href="https://linkedin.com/<?php echo $current_userLinkedIn; ?>" target="_blank" id="profileLinkedIn">LinkedIn.com</a>
                                        </div>
                                        <div class="margin-top-20 profile-desc-link <?php echo empty($current_userFacebook) ? "display-hide" : ""; ?>">
                                            <i class="fa fa-facebook"></i>
                                            <a href="https://facebook.com/<?php echo $current_userFacebook; ?>" target="_blank" id="profileFacebook">Facebook.com</a>
                                        </div>
                                    </div>
                                </div>
                                <!-- END PORTLET MAIN -->
