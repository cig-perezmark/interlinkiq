...
?>
                                                            ...
                                                            echo '<tr id="tr_'. $row["ID"] .'">
                                                                ...
                                                                <td class="text-center">';
                                                                    ...
                                                                    if (empty($current_permission_array_key) OR in_array(5, $permission)) {
                                                                        echo '<a href="#modalView" class="btn btn-outline dark btn-sm btnView" data-toggle="modal" onclick="btnView('. $row["ID"].')">View</a>';
                                                                    }
                                                                    if (empty($current_permission_array_key) OR in_array(6, $permission)) {
                                                                        echo '<a class="btn btn-danger red btn-sm" onclick="btnDelete_Q('. $row["ID"].', this)">Delete</a>';
                                                                    }
                                ...
                                <div class="modal-content">
                                    <form method="post" enctype="multipart/form-data" class="form-horizontal modalForm modalSave">
                                        ...
                                        <div class="modal-footer">
                                            ...
                                            <button type="submit" class="btn green ladda-button" name="btnSave_HR_QuizSet" id="btnSave_HR_QuizSet" data-style="zoom-out"><span class="ladda-label">Save Changes</span></button>
                                        </div>
                                    </form>
                                </div>
                            </div>
                            ...
                            <div class="modal-dialog modal-lg">
                                <div class="modal-content">
                                    <form method="post" enctype="multipart/form-data" class="form-horizontal modalForm modalUpdate">
                                        ...
                                        <div class="modal-footer">
                                            <input type="button" class="btn dark btn-outline" data-dismiss="modal" value="Close" />
                                            <button type="submit" class="btn green ladda-button" name="btnUpdate_HR_QuizSet" id="btnUpdate_HR_QuizSet" data-style="zoom-out"><span class="ladda-label">Save Changes</span></button>
                                        </div>
                                    </form>
                                </div>
                            </div>
                            ...
                            <div class="modal-dialog modal-lg">
                                <div class="modal-content">
                                    <form method="post" enctype="multipart/form-data" class="form-horizontal modalForm modalNew_HR_Quiz">
                                        ...
                                        <div class="modal-footer">
                                            <input type="button" class="btn dark btn-outline" data-dismiss="modal" value="Close" />
                                            <button type="submit" class="btn green ladda-button" name="btnSave_HR_Quiz" id="btnSave_HR_Quiz" data-style="zoom-out"><span class="ladda-label">Save Changes</span></button>
                                        </div>
                                    </form>
                                </div>
                            </div>
                            ...
                            <div class="modal-dialog modal-lg">
                                <div class="modal-content">
                                    <form method="post" enctype="multipart/form-data" class="form-horizontal modalForm modalUpdate_HR_Quiz">
                                        ...
                                        <div class="modal-footer">
                                            <input type="button" class="btn dark btn-outline" data-dismiss="modal" value="Close" />
                                            <button type="submit" class="btn green ladda-button" name="btnUpdate_HR_Quiz" id="btnUpdate_HR_Quiz" data-style="zoom-out"><span class="ladda-label">Save Changes</span></button>
                                        </div>
                                    </form>
                                </div>
                            </div>
        ...
        <script type="text/javascript">
            ...
            function btnView(id) {
                $.ajax({    
                    type: "GET",
                    url: "function.php?modalEdit_HR_QuizSet="+id+"&p="+current_permission_array_key,
                    dataType: "html",                  
