                        ...
                        <div class="portlet light " id="form_wizard_1">
                                <div class="portlet-title">
                                    <div class="caption">
                                        ...
                                        <span class="caption-subject font-green bold uppercase"> Risk & Liabilities -
                                            ...
                                            <div class="form-body">
                                                <ul class="nav nav-pills nav-justified steps">
                                                    ...
                                                    <li>
                                                        <a href="#tab2" data-toggle="tab" class="step">
                                                            ...
                                                            <span class="desc">
                                                                <i class="fa fa-check"></i> Sales </span>
                                                        </a>
                                                    </li>
                                                    <li>
                                                        <a href="#tab3" data-toggle="tab" class="step active">
                                                            ...
                                                            <span class="desc">
                                                                <i class="fa fa-check"></i> Coverage Options </span>
                                                        </a>
                                                    </li>
                                                    <li>
                                                ...
                                                <div class="tab-content">
                                                    ...
                                                    <div class="tab-pane active" id="tab1">
                                                        <div class="col-md-12">
                                                            <?php include "risk_and_liabilities_folder/organization.php"; ?>
                                                        </div>
                                                    </div>
