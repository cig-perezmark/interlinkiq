<?php 
    ...
    $site = "sanitation";
    $breadcrumbs = '';
    $sub_breadcrumbs = 'Sanitation Management';
    ...
    include("database-sanitation.php");
    include("header.php");
?>
        ...
        <div class="portlet light ">
            <div class="portlet-title tabbable-line">
                ...
                <ul class="nav nav-tabs tab-drop">
                    ...
                    <li>
                        <a href="#maintenance_checklist" data-toggle="tab">Sanitation Checklist</a>
                    </li>
                    <li>
                    ...
                    <li >
                        <a href="#list_of_areas" data-toggle="tab">Areas </a>
                    </li>
                </ul>
            </div>
            <div class="portlet-body">
                <div class="tab-content">
                    ...
                    <div class="tab-pane  mt-5" id="maintenance_checklist">
                        <label style="font-weight:600">Add Equipment and Parts to be clean and sanitize</label>
                        <div style="display:flex;justify-content:flex-end;margin-right:10px;margin-bottom:20px">
                            <button type="button" class="btn btn-primary" data-toggle="modal" data-target="<?php echo $FreeAccess == false ? '#add_maintenance':'#modalService'; ?>">Add Sanitation</button>
                        </div>
                        <table class="table table-bordered" id="sample_2">
                            <thead>
                                <tr>
                                    ...
                                    <th>Sanitation Schedule</th>
                                    <th>Status</th>
                                    <th>Sanitation Action</th>
                            ...
                            <tbody>
                                <?php
                                    $get= mysqli_query($sanition_connection,"SELECT * FROM parts_maintainance 
                    ...
                    <div class="tab-pane mt-5" id="parts_register">
                        ...
                        <table class="table table-bordered" id="sample_4">
                            ...
                            <tbody>
                                <?php
                                    $get= mysqli_query($sanition_connection,"SELECT * FROM equipment_parts WHERE enterprise_owner = '$switch_user_id' OR enterprise_owner = '$cookie' ");
                        ...
                        <table class="table table-bordered" id="sample_1">
                            ...
                            <tbody>
                                <?php
                                    ...
                                    $get= mysqli_query($sanition_connection,"SELECT * FROM equipment_reg WHERE enterprise_owner = '$cookie' OR enterprise_owner = '$switch_user_id' ");
                                    while($row=mysqli_fetch_array($get)) {
                                ?>
                                <tr>
                                    <td><?= $row['equipment'] ?></td>
                    ...
                    <div class="tab-pane  mt-5" id="list_of_areas">
                        ...
                        <table class="table table-bordered" id="sample_2">
                            ...
                            <tbody>
                                <?php
                                    $get= mysqli_query($sanition_connection,"SELECT * FROM area_list 
...
<div class="modal fade" id="addmodal" tabindex="-1" aria-labelledby="EquipmentDetails" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-lg">
        <div class="modal-content bg-info">
            ...
            <!--Code Here-->
            <form action="sanitation_controller.php" method="post" enctype="multipart/form-data">
                <script>
                ...
                <div id="add-modal-body" class="modal-body bg-white">
                    ...
                    <div class="row" style="margin-top:5px">
                        <div class="col-md-12">
                            ...
                            <?php
                                $get= mysqli_query($sanition_connection,"SELECT * FROM area_list WHERE  enterprise_owner = '$cookie' OR enterprise_owner = '$switch_user_id' ");
                                while($row=mysqli_fetch_array($get)) { ?>
                    ...
                    <div class="form-group">
                        <label for="inputFrequency">Frequency of Santition <span style="color:red">*</span></label>
                    ...
                    <div class="row" id="dynamic_field" style="margin-top:15px">
                        <div class="col-md-12">
                            <label for="inputParts">SSOP/WI/Manuals</label><i class="fa fa-plus" style="font-size:15px;color:green;cursor:pointer" id="add"></i>
                        </div>
...
<div class="modal fade" id="add_maintenance" tabindex="-1" aria-labelledby="EquipmentDetails" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-lg">
        <div class="modal-content bg-info">
            <div class="modal-header">
                <h5 class="modal-title text-white">Sanitation Checklist </h5>
                <button type="button" class="close text-white" data-dismiss="modal" aria-label="Close" style="outline:none;">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <!--Code Here-->
            <form action="sanitation_controller.php" method="post">
                <div id="add-modal-body" class="modal-body bg-white">
                    <div class="row">
                        <div class="form-group col-md-6">
                            <label for="inputJob">Customer<span style="color:red">*</span></label>
                    ...
                    <div class="form-group">
                        <label for="inputDate">Area<span style="color:red">*</span></label>
                    ...
                    <div class="form-group">
                        <label for="inputDate">Date Performed <span style="color:red">*</span></label>
                    ...
                    <div class="form-group">
                        ...
                        <select name="equipment_PK_id" id="select_parts" class="custom-select form-control" required >
                            <option disabled selected>Choose...</option>
                            <?php
                                $get_equip=mysqli_query($sanition_connection,"SELECT * FROM equipment_reg WHERE enterprise_owner = '$switch_user_id' OR enterprise_owner = '$cookie'");
                    ...
                    <div class="form-group mt-3" >
                        <labe>Equipment parts to be clean and sanitize</labe>
                    ...
                    <div class="row">
                        <div class="form-group col-md-6">
                            <label for="inputFrequency">Next Sanitation Schedule <span style="color:red">*</span></label>
                            <input type="date" name="next_maintainance" class="form-control" required >
                        </div>
                        <div class="form-group col-md-6">
                            <label for="inputFrequency">Frequency of Sanitation</label>
...
<div class="modal fade" id="maintenance_history" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
    <div class="modal-content ">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLongTitle">SANITATION CHECKLIST HISTORY</h5>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>
...
<form action="sanitation_controller.php" method="POST">
    <div class="modal fade" id="update_equipment" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
      <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
        <div class="modal-content ">
          <div class="modal-header">
            <h5 class="modal-title" id="exampleModalLongTitle">EDIT SANITATION CHECKLIST</h5>
            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
              <span aria-hidden="true">&times;</span>
            </button>
          </div>
          <div class="modal-body">
            ...
            <div class="row mt-3" style="margin-top:15px">
                ...
                <div class="col-md-6">
                    <label>Sanitation Frequency</label>
...
<div class="modal fade" id="show_maintenance_history" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
    <div class="modal-content ">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLongTitle">SANITATION CHECKLIST HISTORY DETAILS</h5>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>
...
<form method="POST" action="sanitation_controller.php">
            ...
            <div class="row">
                <div class="col-md-6">
                    ...
                    <select class="form-control" name="equip_id_parts">
                        <?php
                            $get_equip=mysqli_query($sanition_connection,"SELECT DISTINCT parts_PK_id,equipment_parts_id,equipment_name FROM equipment_parts_owned 
...
<script>
    $(document).ready(function(){
        var calendar = $('#pmp_calendar').fullCalendar({
            ...
            events:'sanitation_fetch-event.php',
            editable:true,
