...
<?php
        ...
        if ( mysqli_num_rows($selectUser) > 0 ) {
            while($rowUser = mysqli_fetch_array($selectUser)) {
                ...
                if ($remaining_days == 60) {
                    ...
                    <a href="'. $base_url .'CannOS-Login?l=1&i='. $ID .'" target="_blank" style="font-weight: 600; padding: 10px 20px!important; text-decoration: none; color: #fff; background-color: #27a4b0; border-color: #208992; display: inline-block;">Update Password</a>';
    ...
    // Training Record - DAILY NOTIFICATION
