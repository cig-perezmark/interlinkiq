                                ...
                                <table class="table table-bordered" id="sample_5">
                                    ...
                                    <tbody>
                                        ...
                                        <?php
                                            ...
                                            $overtime_query1 = mysqli_query($conn, "select * from tbl_service_logs where not_approved = 0 and minute > 0 and user_id = {$_COOKIE['ID']} 
 ...
 $('#search_date1').click(function(){
  ...
  if(start_date_filter1 != '' && end_date_filter1 !='')
  {
     $.ajax({
        ...
        method: 'POST',
        data: {start_date_filter1:start_date_filter1,end_date_filter1:end_date_filter1},
        success:function(data){
            alert(data);
       ...
       var send_update_id = [];
        ...
        else
        {
            $.ajax({
                url:'task_service_log/action_approved.php',
                method:'POST',
                data:{send_update_id:send_update_id},
                success:function()
                {
