                            ...
                            <div class="portlet light">
                                <div class="portlet-title tabbable-line">
                                    <div class="caption">
                                        ...
                                        <span class="caption-subject font-dark bold uppercase">List of <?php echo $switch_user_id == 1984 ? 'FSVP / IOR Shippers':'Supplier'; ?></span>
                                        <?php
                                            // if($current_client == 0) {
                                                ...
                                                if (empty($current_permission_array_key) OR in_array(2, $permission)) {
                                                    echo '<div class="btn-group">
                                                        ...
                                                        <ul class="dropdown-menu pull-right">
            												...
            												echo '</li>
                                                            <li>
                                                                <a data-toggle="modal" href="#modalNew" onclick="btnReset(\'modalNew\')">Add New '; echo $switch_user_id == 1984 ? 'Shipment':'Material'; echo '</a>
                                                            </li>';
                                                ...
                                                <div class="tab-pane active" id="tab_actions_sent">
            										<div class="table-responsive">
                                                        ...
                                                        <table class="table table-bordered table-hover" id="tableData_1">
                                                            <thead>
                                                                <tr>
                                                                    <th rowspan="2">'; echo $switch_user_id == 1984 ? 'Shipper No.':'Vendor Code'; echo '</th>
                                                                    <th rowspan="2">'; echo $switch_user_id == 1984 ? 'Shipper':'Vendor'; echo ' Name</th>
                                                                    <th rowspan="2" class="col-type">Category</th>
                                                                    <th rowspan="2">Materials/Services</th>';
                                                                    
        															if($switch_user_id != 1211 AND $switch_user_id != 1684 AND $switch_user_id != 1984) {
                                ...
                                <div class="modal-content">
                                    <form method="post" enctype="multipart/form-data" class="modalForm modalSave">
                                        <div class="modal-header">
                                            ...
                                            <h4 class="modal-title">New <?php echo $switch_user_id == 1984 ? 'Shipper':'Supplier'; ?> Form</h4>
                                        </div>
                                            ...
                                            <div class="tabbable tabbable-tabdrop">
                                                <ul class="nav nav-tabs">
                                                    ...
                                                    <li class="tabMaterials">
                                                        <a href="#tabMaterials_1" data-toggle="tab"><?php echo $switch_user_id == 1984 ? 'Shipment':'Material'; ?> Requirements</a>
                                                    </li>
                                                ...
                                                <div class="tab-content margin-top-20">
                                                        ...
                                                        <div class="row">
                                                            <div class="col-md-3">
                                                                <div class="form-group">
                                                                    <label class="control-label"><?php echo $switch_user_id == 1984 ? 'Shipper':'Vendor'; ?> Code</label>
                                                                    <input class="form-control" type="text" name="vendor_code" />
                                                                </div>
                                                            </div>
                                                            <div class="col-md-3">
                                                                <div class="form-group">
                                                                    <label class="control-label"><?php echo $switch_user_id == 1984 ? 'Shipper':'Vendor'; ?> Name</label>
                                                                    <input class="form-control" type="text" name="supplier_name" required />
                                                                </div>
                                                            </div>
                                                            <div class="col-md-3 <?php echo $switch_user_id == 1984 ? 'hide':''; ?>">
                                                                <div class="form-group">
                                                    ...
                                                    <div class="tab-pane" id="tabMaterials_1">
                                                        ...
                                                        ?>
                                                        <a href="#modalNewMaterial" data-toggle="modal" class="btn green" onclick="btnNew_Material(<?php echo $switch_user_id; ?>, 1, 'modalNewMaterial', 1, 0)">Add New <?php echo $switch_user_id == 1984 ? 'Shipment':'Material'; ?></a>
                                                        <div class="table-scrollable">
                                                            <table class="table table-bordered table-hover" id="tableData_Material_1">
                                                                <thead>
                                                                    <tr>
                                                                        <th><?php echo $switch_user_id == 1984 ? 'Shipment':'Material'; ?> Name</th>
                                                                        <th>SKU</th>
                                                                        <th>Description</th>
                            ...
                            <div class="modal-dialog modal-full">
                                <div class="modal-content">
                                    <form method="post" enctype="multipart/form-data" class="modalForm modalUpdate">
                                        <div class="modal-header">
                                            <button type="button" class="close" data-dismiss="modal" aria-hidden="true"></button>
                                            <h4 class="modal-title"><?php echo $switch_user_id == 1984 ? 'Shipper':'Supplier'; ?> Details</h4>
                                        </div>
						...
						<div class="modal fade" data-backdrop="static" data-keyboard="false" id="modalListMaterial" tabindex="-1" role="basic" aria-hidden="true">
							<div class="modal-dialog modal-lg">
								<div class="modal-content">
									<div class="modal-header">
										<button type="button" class="close" data-dismiss="modal" aria-hidden="true"></button>
										<h4 class="modal-title"><?php echo $switch_user_id == 1984 ? 'Shipment':'Material'; ?> Details</h4>
									</div>
									<div class="modal-body"></div>
									<div class="modal-footer">
										<input type="button" class="btn dark btn-outline" data-dismiss="modal" value="Close" />
                                ...
                                <div class="modal-content">
                                    <form method="post" enctype="multipart/form-data" class="modalForm modalSave_Material">
                                        <div class="modal-header">
                                            ...
                                            <h4 class="modal-title">New <?php echo $switch_user_id == 1984 ? 'Shipment':'Material'; ?></h4>
                                        </div>
                                        <div class="modal-body"></div>
										<div class="modal-footer modal-footer--sticky bg-white">
                                            <input type="button" class="btn dark btn-outline" data-dismiss="modal" value="Close" />
                    ...
                    success: function(response) {
                        if ($.trim(response)) {
                            ...
                            var html = '<tr id="tr_'+obj.ID+'">';
								...
								if (switch_user_id != 1211 && switch_user_id != 1684 && switch_user_id != 1984) {
