...
if (isset($_GET['d'])) {
    $encoded_d = urlencode($_GET['d']);
}
if (isset($_GET['u'])) {
    $encoded_u = urlencode($_GET['u']);
}
if (isset($_GET['f'])) {
    $encoded_f = urlencode($_GET['f']);
}
...
<style type="text/css">
    ...
    #supplierchartdiv,
    #compliancePieChartDiv,
    #materialDonutChartDiv {
        width: 100%;
        height: 500px;
    }
    ...
    ?>#modalChecklist .mt-checkbox-list .mt-checkbox {
        padding-right: 30px;
    }

    #modalChecklist .mt-checkbox-list .mt-checkbox a {
        position: absolute;
        right: 0;
    }

    #modalChecklist .mt-checkbox-list .mt-checkbox:hover {
        background: #f7f7f7;
    }
    ...
    <div class="col-md-3">
        <div class="dashboard-stat2  counterup_3">
            ...
            <div class="progress-info">
                ...
                <div class="status">
                    <div class="status-title">percentage for this month</div>
                    <div class="status-number">%</div>
                </div>
            </div>
        </div>
        ...
        <div class="portlet light">
            <div class="portlet-title tabbable-line">
                ...
                if ($current_userInvited == 0 or $current_userEmployeeID > 0) {
                    ...
                    if ($current_client == 0 or $current_userID == 1684) {
                        echo '<li>
                ...
                if ($current_userInvited == 0 or $current_userEmployeeID > 0) {
                    ...
                    if (mysqli_num_rows($result) > 0) {
                        ...
                        while ($row = mysqli_fetch_array($result)) {
                            ...
                            if ($cn_email != "") {
                                echo '<li><a href="mailto:' . $cn_email . '" target="_blank" title="Email"><i class="fa fa-envelope"></i></a></li>';
                            }
                            if ($cn_phone != "") {
                                echo '<li><a href="tel:' . $cn_phone . '" target="_blank" title="Phone"><i class="fa fa-phone-square"></i></a></li>';
                            }
                            if ($cn_cell != "") {
                                echo '<li><a href="tel:' . $cn_cell . '" target="_blank" title="Cell Number"><i class="fa fa-phone"></i></a></li>';
                            }
                            if ($cn_fax != "") {
                                echo '<li><a href="tel:' . $cn_fax . '" target="_blank" title="Fax"><i class="fa fa-print"></i></a></li>';
                            }
                            echo '</ul>
        																	</td>
                    ...
                    if (mysqli_num_rows($result) > 0) {
                        ...
                        while ($row = mysqli_fetch_array($result)) {
                            ...
                            if (empty($current_permission_array_key) or in_array(5, $permission)) {
                                echo '<a href="#modalEditMaterial" data-toggle="modal" class="btn btn-outline dark btn-sm" onclick="btnEdit_Material(' . $m_ID . ', 2, \'modalEditMaterial\')">View</a>';
                            }
                    ...
                    if (mysqli_num_rows($result) > 0) {
                        while ($row = mysqli_fetch_array($result)) {
                            ...
                            if (mysqli_num_rows($selectTemplate) > 0) {
                                ...
                                if (empty($current_permission_array_key) or in_array(2, $permission)) {
                                    echo '<a href="#modalTemplate" class="btn btn-xs btn-success" data-toggle="modal" onclick="btnTemplate(' . $ID . ', ' . $temp_ID . ')"><i class="fa fa-cloud-upload"></i></a>';
                                }
                                if (empty($current_permission_array_key) or in_array(6, $permission)) {
                                    echo '<a href="javascript:;" data-type="' . $type . '" class="btn btn-xs btn-danger" onclick="btnTemplate_delete(' . $ID . ', ' . $temp_ID . ')"><i class="fa fa-trash"></i></a>';
                                }
                    ...
                    <div class="tabbable tabbable-tabdrop">
                        <ul class="nav nav-tabs">
                            ...
                            <li class="tabMaterials">
                                <a href="#tabMaterials_1" data-toggle="tab">Material Requirements</a>
                            </li>
                            ...
                            <div class="tab-pane" id="tabDocuments_1">
                                ...
                                <div class="mt-checkbox-list">
                                    ...
                                    if ($switch_user_id == 1211 or $switch_user_id == 1684 or $switch_user_id == 1486 or $switch_user_id == 1774 or $switch_user_id == 1832 or $switch_user_id == 1773 or $switch_user_id == 1850) {
                                        $checked = 'CHECKED';
                                        $sql_supplier .= " required = 1 AND FIND_IN_SET($switch_user_id, REPLACE(accounts, ' ', '')) > 0 AND ";
                                    }
                                    ...
                                    if (mysqli_num_rows($selectRequirement2) > 0) {
                                        while ($row = mysqli_fetch_array($selectRequirement2)) {
                                            ...
                                            if ($row["ID"] == 118 and $switch_user_id == 1738) {
                                    ...
                                    <table class="table table-bordered table-hover" id="tableData_Requirement_1">
                                        <thead class="bg-blue-ebonyclay bg-font-blue-ebonyclay">
                                            <tr>
                                                ...
                                                <th style="width: 165px;" class="text-center col-sop">SOP / Info</th>
                                            ...
                                            if ($switch_user_id == 1211 or $switch_user_id == 1684 or $switch_user_id == 1486 or $switch_user_id == 1774 or $switch_user_id == 1832 or $switch_user_id == 1773 or $switch_user_id == 1850) {
                                                ...
                                                if (mysqli_num_rows($selectRequirement2Table) > 0) {
                                                    while ($rowTable = mysqli_fetch_array($selectRequirement2Table)) {
                                                        ...
                                                        if ($req_id == 118 and $switch_user_id == 1738) {
                                                            $req_name = 'Traceability System';
                                                        }
                                                        ...
                                                        if (mysqli_num_rows($selectSOP) > 0) {
                                                            ...
                                                            echo '<p style="margin: 0;">
													                                                ...
													                                                <a href="#modalSOP2" class="btn btn-sm red-haze" data-toggle="modal" onclick="btnSOP2(' . $req_id . ', ' . $sop_ID . ', 2)">Upload</a>
													                                            </p>';
                                                        } else {
                                                            echo '<a href="#modalSOP2" class="btn btn-sm red-haze" data-toggle="modal" onclick="btnSOP2(' . $req_id . ', 0, 2)">Upload</a>';
                                                        }
                                                        ...
                                                        if (mysqli_num_rows($selectTemplate) > 0) {
                                                            ...
                                                            // echo '<button class="btn btn-sm btn-info" onclick="window.location.href=\'https://interlinkiq.com/document/document-stamping/public/stamping/' . $temp_ID . '\'">Stamp</button>';
                                                        ...
                                                        echo '</td>
													                                ...
													                                <tr class="tr_' . $req_id . '">
													                                    <td colspan="3">
													                                    	<input type="text" class="form-control" name="document_comment[]" placeholder="Comments" />
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <form method="post" enctype="multipart/form-data" class="modalForm modalEditRecord">
                ...
                <div class="modal-footer">
                    <input type="button" class="btn dark btn-outline" data-dismiss="modal" value="Close" />
                    <button type="submit" class="btn btn-success ladda-button" name="btnUpdate_Supplier_Record" id="btnUpdate_Supplier_Record" data-style="zoom-out"><span class="ladda-label">Save Changes</span></button>
                </div>
            </form>
        </div>
    </div>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <form method="post" enctype="multipart/form-data" class="modalForm modalSave_SOP">
                ...
                <div class="modal-footer">
                    <input type="button" class="btn dark btn-outline" data-dismiss="modal" value="Close" />
                    <button type="submit" class="btn btn-success ladda-button" name="btnSave_Supplier_SOP" id="btnSave_Supplier_SOP" data-style="zoom-out"><span class="ladda-label">Save</span></button>
                </div>
            </form>
        </div>
    </div>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <form method="post" enctype="multipart/form-data" class="modalForm modalSave_SOP2">
                ...
                <div class="modal-footer">
                    <input type="button" class="btn dark btn-outline" data-dismiss="modal" value="Close" />
                    <button type="submit" class="btn btn-success ladda-button" name="btnSave_Supplier_SOP2" id="btnSave_Supplier_SOP2" data-style="zoom-out"><span class="ladda-label">Save</span></button>
                </div>
            </form>
        </div>
    </div>
...
<script type="text/javascript">
    ...
    function changedCategory(sel, modal) {
        ...
        if (sel.value == 41) {
            $('#supplier_category_other_' + modal).show();
        }
    }
    ...
    $(".modalViewReq").on('submit', (function(e) {
        ...
        if (inputInvalid('modalViewReq') > 0) {
            return false;
        }
    ...
    function btnNew_Requirement(modal, other) {
        ...
        if (requirement_other != "") {
            ...
            data += '<a href="#modalSOP2" class="btn btn-sm red-haze" data-toggle="modal" onclick="btnSOP2(' + x + ', 0, ' + modal + ')">Upload </a>';
            data += '</td>';
            ...
            data += '<td rowspan="2" class="text-center" href="#modalChecklist" data-toggle="modal" onclick="btnChecklist(' + modal + ', 1, ' + x + ', ' + x + ', 0)">0%</td>';
            data += '</tr>';
    ...
    function checked_RequirementOther(id, modal, other) {
        ...
        if (id.checked == true) {
            ...
            if (current_client == 0) {
                data += '<td rowspan="2" class="text-center col-sop">';
                data += '<input type="file" class="form-control hide" name="document_other_sop[]" />';
                data += '<a href="#modalSOP2" class="btn btn-sm red-haze" data-toggle="modal" onclick="btnSOP2(' + id + ', 0, ' + modal + ')">Upload </a>';
                data += '</td>';
                data += '<td rowspan="2" class="text-center">';
                data += '<input type="file" class="form-control hide" name="document_other_template[]" />';
            ...
            data += '<td rowspan="2" class="text-center" href="#modalChecklist" data-toggle="modal" onclick="btnChecklist(' + modal + ', 1, ' + wholeNumber + ', ' + wholeNumber + ', 0)">0%</td>';
            data += '</tr>';
            data += '<tr class="tr_other_' + x + '">';
            data += '<td colspan="3">';
            data += '<input type="text" class="form-control" name="document_other_comment[]" placeholder="Comment" />';
    ...
    function btnNew_Requirement_Material(modal, other) {
        ...
        if (requirement_other != "") {
            ...
            html += '<span></span>';
            html += '</label>';
            $('#tabDocuments_Material_' + modal + ' .mt-checkbox-list').append(html);
            ...
            // wholeNumber = parseInt(x.replace(/\D/g, ""), 10);
            data += '<td rowspan="2" class="text-center" href="#modalChecklist" data-toggle="modal" onclick="btnChecklist(' + modal + ', 1, ' + x + ', ' + x + ', 1)">0%</td>';
            data += '</tr>';
            data += '<tr class="tr_other_' + x + '">';
            data += '<td colspan="3">';
            data += '<input type="text" class="form-control" name="document_other_comment[]" placeholder="Comment" />';
    ...
    function checked_RequirementOther_Material(id, modal, other) {
        ...
        if (id.checked == true) {
            ...
            wholeNumber = parseInt(x.replace(/\D/g, ""), 10);
            data += '<td rowspan="2" class="text-center" href="#modalChecklist" data-toggle="modal" onclick="btnChecklist(' + modal + ', 1, ' + wholeNumber + ', ' + wholeNumber + ', 1)">0%</td>';
            data += '</tr>';
            data += '<tr class="tr_other_' + x + '">';
            data += '<td colspan="3">';
            data += '<input type="text" class="form-control" name="document_other_comment[]" placeholder="Comment" />';
            ...
            success: function(response) {
                if ($.trim(response)) {
                    ...
                    if (obj.contact_email != "") {
                        html += '<li><a href="mailto:' + obj.contact_email + '" target="_blank" title="Email"><i class="fa fa-envelope"></i></a></li>';
                    }
                    if (obj.contact_phone != "") {
                        html += '<li><a href="tel:' + obj.contact_phone + '" target="_blank" title="Phone"><i class="fa fa-phone-square"></i></a></li>';
                    }
                    if (obj.contact_cell != "") {
                        html += '<li><a href="tel:' + obj.contact_cell + '" target="_blank" title="Cell Number"><i class="fa fa-phone"></i></a></li>';
                    }
                    if (obj.contact_fax != "") {
                        html += '<li><a href="tel:' + obj.contact_fax + '" target="_blank" title="Fax"><i class="fa fa-print"></i></a></li>';
                    }
                    html += '</ul>';
                    html += '</td>';
                    html += '<td class="text-center">';
    ...
    //SOP Section
    function btnSOP(id, temp) {
        $.ajax({
            type: "GET",
            url: "function.php?modalNew_Supplier_SOP=" + id + "&temp=" + temp,
            dataType: "html",
            success: function(data) {
    ...
    function btnSOP_delete(id, temp) {
        swal({
            ...
            $.ajax({
                ...
                dataType: "html",
                success: function(response) {
                    $dataTemp = '<a href="#modalSOP" class="btn btn-xs btn-success" data-toggle="modal" onclick="btnSOP(' + id + ', ' + temp + ')"><i class="fa fa-cloud-upload"></i></a>';
        ...
        $.ajax({
            ...
            success: function(response) {
                if ($.trim(response)) {
                    msg = "Sucessfully Save!";
                    var obj = jQuery.parseJSON(response);
                    $('#tableData_3 tbody #tr_' + obj.ID + ' > td.col-sop').html(obj.view);
    ...
    function btnSOP2(id, temp, modal) {
        $.ajax({
            type: "GET",
            url: "function.php?modalNew_Supplier_SOP2=" + id + "&temp=" + temp + "&modal=" + modal,
            dataType: "html",
            success: function(data) {
        ...
        $.ajax({
            ...
            success: function(response) {
                if ($.trim(response)) {
                    msg = "Sucessfully Save!";
                    var obj = jQuery.parseJSON(response);
                    $('#tableData_Requirement_' + obj.modal + ' tbody .tr_' + obj.ID + ':first-child > td.col-sop').html(obj.view2);
    ...
    // Checklist Section
    function btnChecklist(modal, type, id, doc, p) {
        $.ajax({
            type: "GET",
            url: "function.php?modalView_Checklist=" + id + "&d=" + doc + "&t=" + type + "&m=" + modal + "&p=" + p,
            dataType: "html",
            success: function(data) {
