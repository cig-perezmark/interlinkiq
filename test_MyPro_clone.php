        ...
        <div class="portlet light ">
            <div class="portlet-title tabbable-line">
                ...
                <ul class="nav nav-tabs">
                    ...
                    <li>
                        <a href="#tab_Me" data-toggle="tab" class="hide">My Task</a>
                    </li>
                    <li>
                            ...
                            <tbody id="project_data">
                                <?php
                                    ...
                                    if(isset($_COOKIE['switchAccount'])){
                                         $query = "SELECT *  FROM tbl_MyProject_Services left join tbl_MyProject_Services_Assigned on MyPro_PK = MyPro_id where tbl_MyProject_Services.switch_id = $switch_user_id and Project_status != 2 AND tbl_MyProject_Services.is_deleted=0";
                                    }else{
                                         $query = "SELECT *  FROM tbl_MyProject_Services left join tbl_MyProject_Services_Assigned on MyPro_PK = MyPro_id where tbl_MyProject_Services.user_cookies = $current_userID and Project_status != 2 AND tbl_MyProject_Services.is_deleted=0";
                                    }
                                    ...
                                    <tr id="row_proj_<?= $row['MyPro_id']; ?>">
                                        ...
                                        <td><a  href="test_task_mypro.php?view_id=<?php echo $row['MyPro_id'];  ?>"><?php echo $row['Project_Name']; ?></a>
                                            <?php
                                                        
                                                        $counter = 1;
                                                        $mypro_id = $row['MyPro_id'];
                                                        $sql_MyTask = $conn->query("SELECT * FROM tbl_MyProject_Services_Childs_action_Items where Parent_MyPro_PK = $mypro_id ");
                                                        ...
                                                        $sql_compliance = $conn->query("SELECT COUNT(*) as compliance FROM tbl_MyProject_Services_Childs_action_Items where Parent_MyPro_PK = $mypro_id and CIA_progress = 2");
                                                        while ($data_compliance = $sql_compliance->fetch_array()) {
                                                            $comp = $data_compliance['compliance'];
                                                        }
                                                        $sql_none_compliance = $conn->query("SELECT COUNT(*) as non_comp FROM tbl_MyProject_Services_Childs_action_Items where Parent_MyPro_PK = $mypro_id and CIA_progress != 2");
                                                        ...
                                                        <br>
                                        <div class="progress">
                                          <div class="progress-bar" role="progressbar" style="width: <?php echo $ptc; ?>" aria-valuenow="<?php echo $ptc; ?>" aria-valuemin="0" aria-valuemax="100"><?php echo $ptc; ?></div>
                                        </div>
                                        </td>
                                        ...
                                        <td style="text-align:center;">
                                            <?php
                                              $mypro_id = $row['MyPro_id'];
                                              $sql_compliance_not_started = $conn->query("SELECT COUNT(*) as compliance FROM tbl_MyProject_Services_History where MyPro_PK = $mypro_id and tmsh_column_status = 0");
                                        ...
                                        <td style="text-align:center;">
                                                <?php
                                              $mypro_id = $row['MyPro_id'];
                                              $sql_compliance_in_progress = $conn->query("SELECT COUNT(*) as compliance FROM tbl_MyProject_Services_History where MyPro_PK = $mypro_id and tmsh_column_status = 1");
                                        ...
                                        <td style="text-align:center;">
                                                    <?php
                                              $mypro_id = $row['MyPro_id'];
                                              $sql_compliance_completed = $conn->query("SELECT COUNT(*) as compliance FROM tbl_MyProject_Services_History where MyPro_PK = $mypro_id and tmsh_column_status = 2");
