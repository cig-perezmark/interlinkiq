<?php 
	...
	include_once ('ForNewFunctions/resources/templates/_task_mypro_header.php'); 
...
?>
   ...
   <body class="page-sidebar-closed-hide-logo page-container-bg-solid">
		...
		<div class="modal fade" id="ViewHistoryForEdits" tabindex="-1" role="basic" aria-hidden="true">
			<div class="modal-dialog">
				<div class="modal-content">
					<form id="ViewHistoryForEdits" class="form-horizontalx">
						<div class="modal-header">
							<button type="button" class="close" data-dismiss="modal" aria-hidden="true"></button>
		...
		<div class="row">
			<div class="col-md-12">
				<ul class="nav nav-tabs">
					<li class="active">
						<a type="button" class="btn default" href="https://interlinkiq.com/test_MyPro.php" >Dashboard</a>
					</li>
					<li class="active">
															   ...
															   <!-- <div class="board-item">
															   	...
															   	<?php
																	...
																	while ($data1 = $sql->fetch_array()) {
																		...
																		// $sql__MyTask_docs = $conn->query("SELECT COUNT(*) as docscount FROM tbl_myproject_services_documents WHERE history_id = '$id_st'");
																		$sql__MyTask_docs = $conn->query("SELECT
                                                                            COUNT(*) AS docscount
                                                                            ...
                                                                            LEFT JOIN (
                                                                            	SELECT
                                                                                *
                                                                                FROM tbl_myproject_services_documents
                                                                            ) AS d
                                                                            ...
                                                                            LEFT JOIN (
                                                                                ...
                                                                                CAI_id,
                                                                                Services_History_PK
                                                                                FROM tbl_MyProject_Services_Childs_action_Items AS cc
                                                                                ...
                                                                                ON cc.CAI_id = dd.history_id
                                                                            ) AS c 
                                                                            ON h.History_id = c.Services_History_PK
                                                                            
                                                                            WHERE h.History_id = $id_st");
																		$data_MyTask_docs = $sql__MyTask_docs->fetch_array();
																		$counter_docs = $data_MyTask_docs['docscount'];
																		...
																		$priority_status = $data1['priority_status'];
																		if ($priority_status == 1) {
																			$priority_status = 'board-item-content-priority board-item-content-priority-medium ';
																		} else if ($priority_status == 2) {
																			$priority_status = 'board-item-content-priority board-item-content-priority-high ';
																		}
																		...
																		$response .= '<div id="cardData" data-task-id="' . $id_st . '" data-id="' . $id_st . '" class="board-item card">
																			<div class="board-item-content table '.$priority_status.'">
																				<div class="ftr">
																					<div class="author">
																						<a href="#">  
																					...
																					<div class="stats"> 
																						<span tooltip="Compliance" class="uppercase font-green">'.$ptc.'</span>
																					</div>
																				</div>
																				<h5 class="card-caption">
																					...
																					<div class="stats">
																						<i class="icon-doc" style="font-size: 20px; color: rgb(194, 183, 183);"></i> '.$counter_docs.' &nbsp; 
						...
						<div class="context" hidden>
						  <div class="context_item"> 
							<div class="inner_item">
							 <a style="text-decoration: none" class="edit-button" data-id="" href="#ViewHistoryForEdits" data-toggle="modal" id="ViewHistoryForEditx" onclick="btnViewHistoryForEdit(this)">Edit </a>
							</div> 
						  </div>
						  <div class="context_item"> 
							<div class="inner_item">
						   ...
						   <div class="tab-pane active page-quick-sidebar-chat" id="quick_sidebar_tab_1">
							    <div class="page-quick-sidebar-chat-users" data-rail-color="#ddd" data-wrapper-class="page-quick-sidebar-list">
								    <div style="overflow-y: scroll;padding: 0 24px 24px 24px;height: 800px;">
									    <div id="todo_task" style="padding-top: 75px;"></div>
								    </div>
									<form id="commentForm">
										<div class="chat-form">
			...
			<script src="ForNewFunctions/js/process.js"></script>
			<script src="ForNewFunctions/js/contextmenu.js"></script>
			<!-- BEGIN PAGE LEVEL PLUGINS -->
			...
			<script>
			    function btnViewHistoryForEdit(e) {
                    var history_id = e.getAttribute("data-id");
