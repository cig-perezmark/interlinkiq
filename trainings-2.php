...
?>
                                        ...
                                        <table class="table table-bordered table-hover" id="tableData">
                                            ...
                                            <tbody>
                                                <?php
                                                    ...
                                                    //                         <a href="#modalView" type="button" class="btn btn-outline dark btn-sm" data-toggle="modal" onclick="btnView('. $row["ID"].')">View</a>
        ...
        <script type="text/javascript">
            ...
            function btnView(id) {
                $.ajax({    
                    type: "GET",
                    url: "function.php?modalView_HR_Trainings="+id,
                    dataType: "html",
                    success: function(data){
                                ...
                                result += '<td class="text-center">';
                                    result += '<div class="mt-action-buttons">';
                                        result += '<div class="btn-group btn-group-circle">';
                                            result += '<a href="#modalView" type="button" class="btn btn-outline dark btn-sm" data-toggle="modal" onclick="btnView('+obj.ID+')">View</a>';
